...
public class CommonPageUIs {
    ...
    public static final String DYNAMIC_ICON_BACK = "//android.widget.TextView[@text='%s']/preceding-sibling::android.widget.ImageView";
	...
	public static final String DYNAMIC_TEXTVIEW_BY_LINEARLAYOUT_ID_NAF_TRUE = "//android.widget.LinearLayout[@index = '%s']//android.widget.ImageView[@clickable = 'true']";
}
