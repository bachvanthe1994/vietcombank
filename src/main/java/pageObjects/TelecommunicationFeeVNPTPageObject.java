...
public class TelecommunicationFeeVNPTPageObject extends AbstractPage {

	public TelecommunicationFeeVNPTPageObject(AppiumDriver<MobileElement> mappingDriver) {
