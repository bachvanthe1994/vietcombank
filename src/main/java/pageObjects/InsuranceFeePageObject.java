...
public class InsuranceFeePageObject extends AbstractPage {
	public static String codeInsurrance = "";
	public InsuranceFeePageObject(AppiumDriver<MobileElement> mappingDriver) {
