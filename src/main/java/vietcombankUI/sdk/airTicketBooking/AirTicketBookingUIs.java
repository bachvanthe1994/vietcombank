...
public class AirTicketBookingUIs {
	...
	public static final String DYNAMIC_FLIGHT_SHIFT_INFO_BY_FLIGHT_CODE = "//*[@resource-id=\"%s\"]//android.widget.TextView[@resource-id='com.VCB:id/tv_flightcode_internal' and contains(@text,'%s')]//preceding::android.widget.LinearLayout//android.widget.TextView[@resource-id=\"%s\"]";
