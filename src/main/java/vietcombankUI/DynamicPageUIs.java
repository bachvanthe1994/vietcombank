...
public class DynamicPageUIs {
	...
	public static final String DYNAMIC_ACCEPT_BUTTON_OR_BUTTON_CONTAIN_OR = "//android.widget.Button[@resource-id= '%s' or @resource-id= '%s']";
	...
	public static final String ICON_CONTACT = "//android.widget.EditText[@text='%s']//parent::android.widget.LinearLayout//following-sibling::android.widget.ImageView";
	...
	public static final String DYNAMIC_CONTACT_KEY_MENU_BY_EDIT_TEXT = "//android.widget.EditText[@text='%s']/parent::android.widget.LinearLayout//following-sibling::android.widget.ImageView";
...
//DATE PICKER
	...
	//RelativeLayout
	public static final String DYNAMIC_RELATIVELAYOUT   = "//android.widget.RelativeLayout[@resource-id='%s']";
