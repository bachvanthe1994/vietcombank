...
public class TransferMoneyOutSideVCBPageUIs {
	...
	public static final String PASSWORD_CONFIRM_INPUT = "//android.widget.Button[@text = 'Tiếp tục']/preceding-sibling::android.widget.FrameLayout//android.widget.EditText";
}
