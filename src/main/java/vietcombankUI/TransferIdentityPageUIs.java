...
public class TransferIdentityPageUIs {
    ...
    public static final String DYNAMIC_OTP_CONFIRM = "//android.widget.Button[@text='%s']//parent::android.widget.FrameLayout//preceding-sibling::android.widget.ScrollView//android.widget.LinearLayout//android.widget.TextView";
}
