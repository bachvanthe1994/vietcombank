...
public class TransferMoneyCharity extends Base {
	...
	TransferCharity info1 = new TransferCharity(TransferMoneyInVCB_Data.InputDataInVCB.EUR_ACCOUNT, "Test order", "10", "Do Minh Duc", "So 18 ngo 3 Thai Ha", "Ho ngheo", "Mật khẩu đăng nhập");
	TransferCharity info2 = new TransferCharity(TransferMoneyInVCB_Data.InputDataInVCB.ACCOUNT3, "Test order", "1000000", "Do Minh Duc", "So 18 ngo 3 Thai Ha", "Ho ngheo", "SMS OTP");
	TransferCharity info3 = new TransferCharity(TransferMoneyInVCB_Data.InputDataInVCB.EUR_ACCOUNT, "Test order", "10", "Do Minh Duc", "So 18 ngo 3 Thai Ha", "Ho ngheo", "SMS OTP");
