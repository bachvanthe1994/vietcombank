...
public class TransferMoneyCharity extends Base {
	...
	public void TC_01_ChuyenTienTuThienBangVNDThanhToanMatKhau() {
		...
		transferMoneyCharity.inputToDynamicPopupPasswordInput(driver, password, TransferMoneyCharity_Data.CONTINUE_BUTTON);
	...
	public void TC_11_ChuyenTienTuThienBangNgoaiTe_USD_ThanhToanOTP() {
		...
		transferMoneyCharity.inputToDynamicInputBox(driver, info5.money, TransferMoneyCharity_Data.MONEY_CHARITY);

		log.info("TC_11_5_Nhap ten nguoi ung ho");
		transferMoneyCharity.inputToDynamicInputBox(driver, info5.name, TransferMoneyCharity_Data.NAME_CHARITY);

		log.info("TC_11_6_Nhap dia chi ung ho");
		transferMoneyCharity.inputToDynamicInputBox(driver, info5.address, TransferMoneyCharity_Data.ADDRESS_CHARITY);

		log.info("TC_11_7_Hoan canh nguoi ung ho");
		transferMoneyCharity.inputToDynamicInputBox(driver, info5.status, TransferMoneyCharity_Data.STATUS_CHARITY);
		...
		verifyEquals(transferMoneyCharity.getDynamicTextInTransactionDetail(driver, TransferMoneyCharity_Data.NAME_CHARITY), info5.name);

		log.info("TC_11_9_6_Kiem tra dia chi nguoi chuyen");
		verifyEquals(transferMoneyCharity.getDynamicTextInTransactionDetail(driver, TransferMoneyCharity_Data.ADDRESS_CHARITY), info5.address);

		log.info("TC_11_9_7_Kiem tra hoan canh");
		verifyEquals(transferMoneyCharity.getDynamicTextInTransactionDetail(driver, TransferMoneyCharity_Data.STATUS_CHARITY), info5.status);
	...
	public void TC_12_ChuyenTienTuThienBangNgoaiTeThanhToanOTP_BaoCao() {
		...
		verifyEquals(transReport.getTextInDynamicTransactionInReport(driver, "1", "com.VCB:id/tvMoney"), ("- " + info5.money + " USD"));
