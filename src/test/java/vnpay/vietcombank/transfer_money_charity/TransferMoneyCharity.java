...
public class TransferMoneyCharity extends Base {
	...
	TransferCharity info2 = new TransferCharity(Account_Data.Valid_Account.DEFAULT_ACCOUNT2, TransferMoneyCharity_Data.ORGANIZATION, "1000000", "Do Minh Duc", "So 18 ngo 3 Thai Ha", "Ho ngheo", "SMS OTP");
	...
	public void TC_03_ChuyenTienTuThienBangNgoaiTeThanhToanMatKhau() {
		...
		transferFeeCurrentcy = transferMoneyCharity.convertAvailableBalanceCurrentcyToDouble(transferMoneyCharity.getDynamicTextInTransactionDetail(driver, "Số tiền phí"));
