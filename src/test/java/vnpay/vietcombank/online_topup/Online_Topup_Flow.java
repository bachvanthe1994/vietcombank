...
public class Online_Topup_Flow extends Base {
	...
	private String originAccount, originMoney, transactionID, customerID, feeValue, transactionDay;
	...
	public void TC_01_NapTienDienTuVaoViMOMO_ThanhToanOTP(String otp) {
		...
		onlineTopup.clickToDynamicButtonLinkOrLinkText(driver, "Ví AirPay");
		...
		verifyEquals(onlineTopup.getDynamicTextByLabel(driver, originAccount), (onlineTopup.getStringNumberAfterCaculate(originMoney, "50,000", feeValue) + " VND"));
