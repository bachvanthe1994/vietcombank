...
public class Online_Topup_Flow_SmartOTP extends Base {
	...
	@Test
	public void TC_01_NapTienDienTuVaoViEPAY_ThanhToanOTP() {
		...
		log.info("TC_01_Step_13: Chon phuong thuc xac thuc Smart OTP");
		onlineTopup.clickToTextID(driver, "com.VCB:id/tvptxt");
		onlineTopup.clickToDynamicButtonLinkOrLinkText(driver, Online_Topup_Text.SMART_OTP_TEXT);
		...
		onlineTopup.inputToDynamicSmartOTP(driver, LogIn_Data.Login_Account.Smart_OTP, "com.VCB:id/otp");
		onlineTopup.clickToDynamicAcceptButton(driver, "com.VCB:id/submit");
		onlineTopup.clickToDynamicAcceptButton(driver, "com.VCB:id/btContinue");
	...
	@Test
	public void TC_03_NapTienDienTuVaoVETC_ThanhToanOTP() {
		...
		log.info("TC_03_Step_10:Kiem tra hien thi Ten khach hang");
		customerID = onlineTopup.getDynamicTextByLabel(driver, Online_Topup_Text.CUSTOMER_NAME_TEXT);

		log.info("TC_03_Step_10:Kiem tra hien thi So tien nap");
		...
		log.info("TC_03_Step_11: Chon phuong thuc xac thuc OTP");
		onlineTopup.clickToTextID(driver, "com.VCB:id/tvptxt");
		onlineTopup.clickToDynamicButtonLinkOrLinkText(driver, Online_Topup_Text.SMART_OTP_TEXT);
		feeValue = onlineTopup.getDynamicTextByLabel(driver, Online_Topup_Text.FEE_AMOUNT_TEXT);
		...
		log.info("TC_03_Step_13: Nhap du ki tu vao o nhap OTP");
		onlineTopup.inputToDynamicSmartOTP(driver, LogIn_Data.Login_Account.Smart_OTP, "com.VCB:id/otp");
		onlineTopup.clickToDynamicAcceptButton(driver, "com.VCB:id/submit");
		onlineTopup.clickToDynamicAcceptButton(driver, "com.VCB:id/btContinue");

		log.info("TC_03_Step_14: Hien thi man hinh thong bao nap thanh cong");
		verifyEquals(onlineTopup.getDynamicTextDetailByIDOrPopup(driver, "com.VCB:id/tvTitle"), Online_Topup_Text.TRANSACTION_SUCCESS_MESSAGE);
		...
		log.info("TC_03_Step_16: Xac nhan so tien o tai khoan nguon bi tru dung");
		onlineTopup.clickToTextID(driver, "com.VCB:id/number_account");
		onlineTopup.clickToDynamicButtonLinkOrLinkText(driver, sourceAccont.account);
	...
	public void TC_04_KiemTraGiaoDichNapTienDienTuTrongBaoCaoGiaoDich() {
		...
		log.info("TC_04_Step_12: Xac nhan hien thi dung ma giao dich");
		verifyEquals(transactionReport.getDynamicTextByLabel(driver, ReportTitle.TRANSACTION_NUMBER), transactionID);

		log.info("TC_04_Step_13: Xac nhan hien thi so tai khoan giao dich");
		verifyEquals(transactionReport.getDynamicTextByLabel(driver, ReportTitle.ACCOUNT_CARD), sourceAccont.account);
		...
		log.info("TC_04_Step_16: Xac nhan hien thi so tien nap");
		...
		log.info("TC_04_Step_17: Xac nhan hien thi Loai giao dich");
		verifyEquals(transactionReport.getDynamicTextByLabel(driver, ReportTitle.TRANSACTION_TYPE), "Nạp tiền tài khoản VETC");

		log.info("TC_04_Step_18: An nut back ve man hinh bao cao giao dich");
		transactionReport.clickToDynamicBottomMenuOrIcon(driver, "com.VCB:id/ivTitleLeft");

		log.info("TC_04_Step_19: An nut back ve man hinh menu");
		transactionReport.clickToDynamicBottomMenuOrIcon(driver, "com.VCB:id/ivTitleLeft");

		log.info("TC_04_Step_20: Mo tab Home");
		home.clickToDynamicBottomMenuOrIcon(driver, "com.VCB:id/menu_1");
	}
