...
public class Transfer_Money_In_Future_And_Report extends Base {
	...
	public void TC_05_ChuyenTienNgayCoPhiGiaoDichNguoiChuyenTraUSDVaXacThucBangOTP() {
		...
		log.info("TC_01_Step_09: Nhap so tien chuyen");
		transferInVCB.inputToDynamicInputBox(driver, TransferMoneyInVCB_Data.InputDataInFuture.AMOUNT_OF_EUR_OR_USD_TRANSFER, "Số tiền");
		...
		log.info("TC_01_Step_15: Kiem tra so tien chuyen hien thi");
		verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver, "Số tiền"), (TransferMoneyInVCB_Data.InputDataInFuture.AMOUNT_OF_EUR_OR_USD_TRANSFER) + " USD");
		...
		log.info("TC_01_Step_16: Kiem tra so tien phi hien thi");
		verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver, "Số tiền phí"), (TransferMoneyInVCB_Data.InputDataInFuture.USD_SMS_OTP_FEE + " USD"));
		...
		log.info("TC_01_Step_26: Kiem tra so tien chuyen");
		verifyEquals(transferInVCB.getDynamicTransferTimeAndMoney(driver, TransferMoneyInVCB_Data.Output.SUCESSFULL_CREATED_ORDER, "3"), (TransferMoneyInVCB_Data.InputDataInFuture.AMOUNT_OF_EUR_OR_USD_TRANSFER) + " USD");
	...
	@Test
	public void TC_06_KiemTraChiTietGiaoDichChuyenTienTuongLaiCoPhiGiaoDichNguoiChuyenTraUSDVaXacThucBangOTP() {
		log.info("TC_02_Step_01 : Click  nut Back");
		transferInVCB.clickToDynamicBackIcon(driver, "Chuyển tiền trong Vietcombank");
		...
		log.info("TC06_Step 10: Kiem tra so tien giao dich");
		verifyEquals(transStatus.getTextInDynamicTransactionInTransferOrderStatus(driver, "1", "com.VCB:id/tvMoney"), TransferMoneyInVCB_Data.InputDataInFuture.AMOUNT_OF_EUR_OR_USD_TRANSFER + " USD");
		...
		log.info("TC06_Step 15: Kiem tra so tien thi");
		verifyEquals(transStatus.getDynamicTextInTransactionDetail(driver, "Số tiền"), TransferMoneyInVCB_Data.InputDataInFuture.AMOUNT_OF_EUR_OR_USD_TRANSFER + " USD");
	...
	public void TC_07_ChuyenTienNgayCoPhiGiaoDichNguoiNhanTraEURVaXacThucBangOTP() {
		...
		log.info("TC_01_Step_15: Kiem tra so tien chuyen hien thi");
		verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver, "Số tiền"), (TransferMoneyInVCB_Data.InputDataInFuture.AMOUNT_OF_EUR_OR_USD_TRANSFER) + " EUR");
		...
		log.info("TC_01_Step_16: Kiem tra so tien phi hien thi");
		verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver, "Số tiền phí"), (TransferMoneyInVCB_Data.InputDataInFuture.EUR_SMS_OTP_FEE + " EUR"));
	...
	@Test
	public void TC_08_KiemTraChiTietGiaoDichChuyenTienTuongLaiCoPhiGiaoDichNguoiNhanTraEURVaXacThucBangOTP() {
		log.info("TC_02_Step_01 : Click  nut Back");
		transferInVCB.clickToDynamicBackIcon(driver, "Chuyển tiền trong Vietcombank");
		...
		log.info("TC06_Step 10: Kiem tra so tien giao dich");
		verifyEquals(transStatus.getTextInDynamicTransactionInTransferOrderStatus(driver, "1", "com.VCB:id/tvMoney"), TransferMoneyInVCB_Data.InputDataInFuture.AMOUNT_OF_EUR_OR_USD_TRANSFER + " EUR");
		...
		log.info("TC06_Step 15: Kiem tra so tien thi");
		verifyEquals(transStatus.getDynamicTextInTransactionDetail(driver, "Số tiền"), TransferMoneyInVCB_Data.InputDataInFuture.AMOUNT_OF_EUR_OR_USD_TRANSFER + " EUR");
