...
public class Transfer_Money_In_Future_And_Report extends Base {
	...
	public void TC_02_KiemTraTrạngThaiLenhChuyenTienCuaGiaoDichTuongLaiXacThucOTP() {
		...
		verifyTrue(transStatus.getTextInDynamicTransactionInReport(driver, "0", "com.VCB:id/tvDate").contains(transferTime.split(" ")[0]));

		log.info("TC06_Step 10: Kiem tra thoi gian tao dao dich");
		verifyTrue(transStatus.getTextInDynamicTransactionInReport(driver, "0", "com.VCB:id/tvDate").split(" ")[0].equals(transferTime.split(" ")[3]));

		log.info("TC06_Step 10: Kiem tra tên người nhận");
		verifyEquals(transStatus.getTextInDynamicTransactionInReport(driver, "1", "com.VCB:id/tvContent"), TransferMoneyInVCB_Data.InputDataInVCB.RECEIVER_NAME);
		log.info("TC06_Step 10: Kiem tra tên người nhận");
		verifyEquals(transStatus.getTextInDynamicTransactionInReport(driver, "2", "com.VCB:id/tvStatus"), TransferMoneyInVCB_Data.InputDataInVCB.RECEIVER_NAME);
