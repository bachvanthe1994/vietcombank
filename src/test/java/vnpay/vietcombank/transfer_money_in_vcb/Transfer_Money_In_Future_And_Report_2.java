...
public class Transfer_Money_In_Future_And_Report_2 extends Base {
	...
	public void TC_02_KiemTraTrạngThaiLenhChuyenTienCuaGiaoDichTuongLaiCoPhiGiaoDichNguoiChuyenTraVNDVaXacThucOTP() {
		...
		verifyEquals(transferStatus.getTextInDynamicTransactionInTransferOrderStatus(driver, "0", "com.VCB:id/tvStatus"), Output.WAITING_STATUS);
		...
		verifyEquals(transferStatus.getDynamicTextInTransactionDetail(driver, Text.STATUS), Output.WAITING_STATUS);
	...
	public void TC_03_HuyLenhGiaoDichTuongLaiXacThucOTP() {
		...
		verifyEquals(transferStatus.getTextInDynamicTransactionInTransferOrderStatus(driver, "0", "com.VCB:id/tvStatus"), Output.CANCEL_STATUS);

		log.info("TC_03_Step_07: click vao giao dich");
		transferStatus.clickToDynamicTransactionInTransactionOrderStatus(driver, "0", "com.VCB:id/tvDate");

		log.info("TC_03_Step_08: Kiem tra trang thai  Da Huy hien thi");
		verifyEquals(transferStatus.getDynamicTextInTransactionDetail(driver, Text.STATUS), Output.CANCEL_STATUS);
	...
	public void TC_17_KiemTraChiTietGiaoDichChuyenTienTuongLaiCoPhiGiaoDichNguoiNhanTraEURVaXacThucBang_MatKhau() {
		...
		homePage = PageFactoryManager.getHomePageObject(driver);
		homePage.clickToDynamicIcon(driver, Home_Text_Elements.TRANS_STATUS);
