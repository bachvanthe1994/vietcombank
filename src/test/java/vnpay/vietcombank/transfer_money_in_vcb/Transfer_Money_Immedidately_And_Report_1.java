...
public class Transfer_Money_Immedidately_And_Report_1 extends Base {
	...
	/*
	 * @Test public void
	 * TC_01_ChuyenTienNgayCoPhiGiaoDichNguoiChuyenTraVNDVaXacThucBangOTP() {
	 * 
	 * log.info("TC_01_Step_01: Click Chuyen tien trong VCB");
	 * homePage.clickToDynamicIcon(driver, "Chuyển tiền trong VCB");
	 * 
	 * log.info("TC_01_Step_02:Click tai khoan nguon"); transferInVCB =
	 * PageFactoryManager.getTransferMoneyInVcbPageObject(driver);
	 * transferInVCB.clickToDynamicDropDown(driver, "Tài khoản nguồn");
	 * 
	 * log.info("TC_01_Step_03: Chon tai khoan dich");
	 * transferInVCB.clickToDynamicButtonLinkOrLinkText(driver,
	 * Account_Data.Valid_Account.ACCOUNT2); transferInVCB.sleep(driver, 1000);
	 * 
	 * log.info("TC_01_Step_04: Lay so du tai khoan dich"); String
	 * beforeBalanceOfAccount2 =
	 * transferInVCB.getDynamicTextInTransactionDetail(driver, "Số dư khả dụng");
	 * long beforeBalanceAmountOfAccount2 =
	 * convertMoneyToLong(beforeBalanceOfAccount2, "VND");
	 * 
	 ...
	 * transferInVCB.clickToDynamicButtonLinkOrLinkText(driver,
	 * Account_Data.Valid_Account.DEFAULT_ACCOUNT3); transferInVCB.sleep(driver,
	 * 1000);
	 * 
	 * log.info("TC_01_Step_07: Lay so du tai khoan chuyen"); String
	 * beforeBalanceOfAccount1 =
	 * transferInVCB.getDynamicTextInTransactionDetail(driver, "Số dư khả dụng");
	 * long beforeBalanceAmountOfAccount1 =
	 * convertMoneyToLong(beforeBalanceOfAccount1, "VND");
	 * 
	 * log.info("TC_01_Step_08: Nhap tai khoan nhan");
	 * transferInVCB.inputToDynamicInputBox(driver,
	 * Account_Data.Valid_Account.ACCOUNT2, "Nhập/ chọn tài khoản thụ hưởng");
	 * 
	 * log.info("TC_01_Step_09: Nhap so tien chuyen");
	 * transferInVCB.inputToDynamicInputBox(driver,
	 * TransferMoneyInVCB_Data.InputDataInVCB.VND_MONEY, "Số tiền");
	 * 
	 * log.info("TC_01_Step_10: Nhap noi dung");
	 * transferInVCB.inputToDynamicInputBoxByHeader(driver,
	 * TransferMoneyInVCB_Data.InputDataInVCB.NOTE, "Thông tin giao dịch", "3");
	 * 
	 ...
	 * verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver,
	 * "Hình thức chuyển tiền"),
	 * TransferMoneyInVCB_Data.InputDataInVCB.OPTION_TRANSFER[0]);
	 * 
	 * log.info("TC_01_Step_13: Kiem tra tai khoan nguon hien thi");
	 * verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver,
	 * "Tài khoản nguồn"), Account_Data.Valid_Account.DEFAULT_ACCOUNT3);
	 * 
	 * log.info("TC_01_Step_14: Kiem tra tai khoan dich hien thi");
	 * verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver,
	 * "Tài khoản đích/ VND"), Account_Data.Valid_Account.ACCOUNT2 + "/ ");
	 * verifyTrue(transferInVCB.isDynamicMessageAndLabelTextDisplayed(driver,
	 * TransferMoneyInVCB_Data.InputDataInVCB.RECEIVER_NAME_ACCOUNT_2));
	 * 
	 * log.info("TC_01_Step_15: Kiem tra so tien chuyen hien thi");
	 * verifyTrue(transferInVCB.getDynamicTextInTransactionDetail(driver,
	 * "Số tiền").contains(addCommasToLong(TransferMoneyInVCB_Data.InputDataInVCB.
	 * VND_MONEY)));
	 * 
	 * log.info("TC_01_Step_17: Kiem tra phuong thuc tra phi");
	 * verifyTrue(transferInVCB.isDynamicMessageAndLabelTextDisplayed(driver,
	 * TransferMoneyInVCB_Data.InputDataInVCB.COST[0]));
	 * 
	 * log.info("TC_01_Step_19: Kiem tra noi dung hien thi");
	 * verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver,
	 * "Nội dung"), TransferMoneyInVCB_Data.InputDataInVCB.NOTE);
	 * 
	 * log.info("TC_01_Step_20: Chon Phuong thuc nhap");
	 * transferInVCB.clickToDynamicDropDown(driver, "Chọn phương thức xác thực");
	 * 
	 * log.info("TC_01_Step_21: Chon SMS OTP"); String transferFee =
	 * transferInVCB.getDynamicTextByLabel(driver, "SMS OTP"); fee =
	 * convertAvailableBalanceCurrentcyOrFeeToLong(transferFee);
	 * transferInVCB.clickToDynamicButtonLinkOrLinkText(driver, "SMS OTP");
	 * 
	 * log.info("TC_01_Step_16: Kiem tra so tien phi hien thi");
	 * verifyTrue(transferInVCB.getDynamicTextInTransactionDetail(driver,
	 * "Số tiền phí").contains(addCommasToLong(fee + "") + " VND"));
	 * 
	 ...
	 * transferInVCB.clickToDynamicButton(driver, "Tiếp tục");
	 * 
	 * log.info("TC_01_Step_23: Nhap OTP"); transferInVCB.inputToDynamicOtp(driver,
	 * LogIn_Data.Login_Account.OTP, "Tiếp tục");
	 * 
	 ...
	 * verifyTrue(transferInVCB.isDynamicMessageAndLabelTextDisplayed(driver,
	 * TransferMoneyInVCB_Data.Output.TRANSFER_SUCESS_MESSAGE));
	 * 
	 * log.info("TC_01_Step_26: Lay thoi gian tao giao dich"); transferTime =
	 * transferInVCB.getDynamicTransferTimeAndMoney(driver,
	 * TransferMoneyInVCB_Data.Output.TRANSFER_SUCESS_MESSAGE, "4").split(" ")[3];
	 * 
	 * log.info("TC_01_Step_27: Lay ma giao dich"); transactionNumber =
	 * transferInVCB.getDynamicTextInTransactionDetail(driver, "Mã giao dịch");
	 * 
	 ...
	 * verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver,
	 * "Tài khoản thụ hưởng"), Account_Data.Valid_Account.ACCOUNT2);
	 * 
	 ...
	 * 1000);
	 * 
	 * log.info("TC_01_Step_34: Lay so du tai khoan chuyen"); String
	 * afterBalanceOfAccount1 =
	 * transferInVCB.getDynamicTextInTransactionDetail(driver, "Số dư khả dụng");
	 * long afterBalanceAmountOfAccount1 =
	 * convertMoneyToLong(afterBalanceOfAccount1, "VND");
	 * 
	 * log.
	 * info("TC_01_Step_35: Kiem tra so du tai khoan chuyen sau khi thuc hien giao dich"
	 * ); long transferMoney =
	 * convertMoneyToLong(TransferMoneyInVCB_Data.InputDataInVCB.VND_MONEY, "VND");
	 * verifyEquals(beforeBalanceAmountOfAccount1 - transferMoney - fee,
	 * afterBalanceAmountOfAccount1);
	 * 
	 ...
	 * 
	 * log.info("TC_01_Step_38: Lay so du kha dung tai khoan nhan"); String
	 * afterBalanceOfAccount2 =
	 * transferInVCB.getDynamicTextInTransactionDetail(driver, "Số dư khả dụng");
	 * 
	 * log.info("TC_01_Step_39: Kiem tra so du tai khoan nhan sau khi nhan tien");
	 * long afterBalanceAmountOfAccount2 =
	 * convertMoneyToLong(afterBalanceOfAccount2, "VND");
	 * verifyEquals(beforeBalanceAmountOfAccount2 + transferMoney,
	 * afterBalanceAmountOfAccount2);
	 * 
	 * }
	 * 
	 * @Test public void
	 * TC_02_KiemTraChiTietGiaoDichChuyenTienNgayCoPhiGiaoDichNguoiChuyenTraVNDVaXacThucBangOTP
	 * () { log.info("TC_02_Step_01 : Click  nut Back");
	 * transferInVCB.clickToDynamicBackIcon(driver,
	 * "Chuyển tiền trong Vietcombank");
	 * 
	 * log.info("TC_02_Step_02: Click vao More Icon"); homePage =
	 * PageFactoryManager.getHomePageObject(driver);
	 * homePage.clickToDynamicImageViewByID(driver, "com.VCB:id/menu_5");
	 * 
	 * log.info("TC_02_Step_03: Click Bao Cao Dao Dich"); transReport =
	 * PageFactoryManager.getTransactionReportPageObject(driver);
	 ...
	 * transReport.clickToDynamicButtonLinkOrLinkText(driver,
	 ...
	 * transReport.clickToDynamicButtonLinkOrLinkText(driver,
	 * Account_Data.Valid_Account.DEFAULT_ACCOUNT3);
	 * 
	 * log.info("TC_02_Step_08: CLick Tim Kiem");
	 * transReport.clickToDynamicButton(driver, "Tìm kiếm");
	 * 
	 * log.info("TC_02_Step_09: Lay ngay tao giao dich hien thi"); String
	 * transferTimeInReport =
	 * transReport.getTextInDynamicTransactionInReport(driver, "0",
	 * "com.VCB:id/tvDate");
	 * 
	 * log.info("TC_02_Step_10: Kiem tra ngay tao giao dich hien thi");
	 * verifyEquals(convertDateTimeIgnoreHHmmss(transferTimeInReport),
	 * transferTime);
	 * 
	 * log.info("TC_02_Step_11: Kiem tra noi dung hien thi");
	 * verifyTrue(transReport.getTextInDynamicTransactionInReport(driver, "0",
	 * "com.VCB:id/tvContent").equals(TransferMoneyInVCB_Data.InputDataInVCB.NOTE));
	 * 
	 * log.info("TC_02_Step_12: Kiem tra so tien chuyen hien thi");
	 * verifyEquals(transReport.getTextInDynamicTransactionInReport(driver, "1",
	 * "com.VCB:id/tvMoney"), ("- " +
	 * addCommasToLong(TransferMoneyInVCB_Data.InputDataInVCB.VND_MONEY) + " VND"));
	 * 
	 * log.info("TC_02_Step_13: Click vao giao dich");
	 * transReport.clickToDynamicTransactionInReport(driver, "0",
	 * "com.VCB:id/tvDate");
	 * 
	 * log.info("TC_02_13: Kiem tra thoi gian tao giao dich hien thi"); String
	 * reportTime1 = transReport.getDynamicTextInTransactionDetail(driver,
	 * "Thời gian giao dịch"); verifyEquals(reportTime1, transferTimeInReport);
	 * 
	 * log.info("TC_02_Step_16: Kiem tra thoi gian tao giao dich hien thi");
	 * verifyEquals(transReport.getDynamicTextInTransactionDetail(driver,
	 * "Số lệnh giao dịch"), transactionNumber);
	 * 
	 * log.info("TC_02_Step_17: Kiem tra so tai khoan trich no");
	 * verifyEquals(transReport.getDynamicTextInTransactionDetail(driver,
	 * "Tài khoản/thẻ trích nợ"), Account_Data.Valid_Account.DEFAULT_ACCOUNT3);
	 * 
	 * log.info("TC_02_Step_18: Kiem tra so tai khoan ghi co");
	 * verifyEquals(transReport.getDynamicTextInTransactionDetail(driver,
	 * "Tài khoản ghi có"), Account_Data.Valid_Account.ACCOUNT2);
	 * 
	 * log.info("TC_02_Step_19: Kiem tra so tien giao dich hien thi");
	 * verifyTrue(transReport.getDynamicTextInTransactionDetail(driver,
	 * "Số tiền giao dịch").contains(addCommasToLong(TransferMoneyInVCB_Data.
	 * InputDataInVCB.VND_MONEY) + " VND"));
	 * 
	 ...
	 * verifyEquals(transReport.getDynamicTextInTransactionDetail(driver,
	 * "Phí giao dịch"), TransferMoneyInVCB_Data.InputDataInVCB.COST[0]);
	 * 
	 * log.info("TC_02_Step_22: Kiem tra so tien phi hien thi"); if (fee > 0) {
	 * verifyEquals(transReport.getDynamicTextInTransactionDetail(driver,
	 * "Số tiền phí"), addCommasToLong(fee + "") + " VND"); }
	 * log.info("TC_02_Step_23: Kiem tra loai giao dich");
	 * verifyEquals(transReport.getDynamicTextInTransactionDetail(driver,
	 * "Loại giao dịch"), TransferMoneyInVCB_Data.InputDataInVCB.TRANSFER_TYPE);
	 * 
	 * log.info("TC_02_Step_24: Kiem Tra noi dung giao dich");
	 * verifyTrue(transReport.getDynamicTextInTransactionDetail(driver,
	 * "Nội dung giao dịch").contains(TransferMoneyInVCB_Data.InputDataInVCB.NOTE));
	 * 
	 * log.info("TC_02_Step_25: Click Back icon");
	 * transReport.clickToDynamicBackIcon(driver, "Chi tiết giao dịch");
	 * 
	 * log.info("TC_02_Step_26: Chon Tai Khoan"); transReport.clickToTextID(driver,
	 * "com.VCB:id/tvSelectAcc");
	 * 
	 ...
	 * 
	 * log.info("TC_02_Step_09: Lay ngay tao giao dich hien thi"); String
	 * transferTimeInReport2 =
	 * transReport.getTextInDynamicTransactionInReport(driver, "0",
	 * "com.VCB:id/tvDate");
	 * 
	 * log.info("TC_02_Step_10: Kiem tra ngay tao giao dich hien thi");
	 * verifyEquals(convertDateTimeIgnoreHHmmss(transferTimeInReport2),
	 * transferTime);
	 * 
	 ...
	 * "com.VCB:id/tvDate");
	 * 
	 * log.info("TC_02_Step_24: Lay time trong bao cao giao dich"); String
	 * reportTime2 = transReport.getDynamicTextInTransactionDetail(driver,
	 * "Thời gian giao dịch");
	 * 
	 ...
	 * 
	 * @Test public void
	 * TC_03_ChuyenTienNgayCoPhiGiaoDichNguoiNhanTraVNDVaXacThucBangOTP() {
	 * 
	 * log.info("TC_03_Step_01: Click Chuyen tien trong VCB");
	 * homePage.clickToDynamicIcon(driver, "Chuyển tiền trong VCB");
	 * 
	 * log.info("TC_03_Step_02:Click tai khoan nguon"); transferInVCB =
	 * PageFactoryManager.getTransferMoneyInVcbPageObject(driver);
	 * transferInVCB.clickToDynamicDropDown(driver, "Tài khoản nguồn");
	 * 
	 ...
	 * 1000);
	 * 
	 * log.info("TC_03_Step_04: Lay so du tai khoan dich"); String
	 * beforeBalanceOfAccount2 =
	 * transferInVCB.getDynamicTextInTransactionDetail(driver, "Số dư khả dụng");
	 * long beforeBalanceAmountOfAccount2 =
	 * convertMoneyToLong(beforeBalanceOfAccount2, "VND");
	 ...
	 * Account_Data.Valid_Account.ACCOUNT2); transferInVCB.sleep(driver, 1000);
	 * 
	 * log.info("TC_03_Step_07: Lay so du tai khoan chuyen"); String
	 * beforeBalanceOfAccount1 =
	 * transferInVCB.getDynamicTextInTransactionDetail(driver, "Số dư khả dụng");
	 * long beforeBalanceAmountOfAccount1 =
	 * convertMoneyToLong(beforeBalanceOfAccount1, "VND");
	 ...
	 * verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver,
	 * "Tài khoản nguồn"), Account_Data.Valid_Account.ACCOUNT2);
	 * 
	 * log.info("TC_03_Step_16: Kiem tra tai khoan dich hien thi");
	 * verifyTrue(transferInVCB.getDynamicTextInTransactionDetail(driver,
	 * "Tài khoản đích/ VND").contains(Account_Data.Valid_Account.DEFAULT_ACCOUNT3))
	 * ;
	 * 
	 ...
	 * verifyTrue(transferInVCB.isDynamicMessageAndLabelTextDisplayed(driver,
	 * TransferMoneyInVCB_Data.InputDataInVCB.COST[1]));
	 * 
	 ...
	 * transferInVCB.clickToDynamicDropDown(driver, "Chọn phương thức xác thực");
	 * 
	 * log.info("TC_03_Step_23: Chon SMS OTP"); String transferFee =
	 * transferInVCB.getDynamicTextByLabel(driver, "SMS OTP"); fee =
	 * convertAvailableBalanceCurrentcyOrFeeToLong(transferFee);
	 * transferInVCB.clickToDynamicButtonLinkOrLinkText(driver, "SMS OTP");
	 * 
	 ...
	 * transferInVCB.clickToDynamicButton(driver, "Tiếp tục");
	 * 
	 * log.info("TC_03_Step_25: Nhap OTP"); transferInVCB.inputToDynamicOtp(driver,
	 * LogIn_Data.Login_Account.OTP, "Tiếp tục");
	 * 
	 ...
	 * TransferMoneyInVCB_Data.Output.TRANSFER_SUCESS_MESSAGE));
	 * 
	 * log.info("TC_03_Step_28: Lay thoi gian tao giao dich"); transferTime =
	 * transferInVCB.getDynamicTransferTimeAndMoney(driver,
	 * TransferMoneyInVCB_Data.Output.TRANSFER_SUCESS_MESSAGE, "4").split(" ")[3];
	 * 
	 * log.info("TC_03_Step_29: Lay ma giao dich"); transactionNumber =
	 * transferInVCB.getDynamicTextInTransactionDetail(driver, "Mã giao dịch");
	 * 
	 ...
	 * verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver,
	 * "Tài khoản thụ hưởng"), Account_Data.Valid_Account.DEFAULT_ACCOUNT3);
	 * 
	 ...
	 * Account_Data.Valid_Account.ACCOUNT2); transferInVCB.sleep(driver, 1000);
	 * 
	 * log.info("TC_03_Step_27: Lay so du tai khoan chuyen"); String
	 * afterBalanceOfAccount1 =
	 * transferInVCB.getDynamicTextInTransactionDetail(driver, "Số dư khả dụng");
	 * long afterBalanceAmountOfAccount1 =
	 * convertMoneyToLong(afterBalanceOfAccount1, "VND");
	 * 
	 * log.
	 * info("TC_03_Step_28: Kiem tra so du tai khoan chuyen sau khi thuc hien giao dich"
	 * ); long transferMoney =
	 * convertMoneyToLong(TransferMoneyInVCB_Data.InputDataInVCB.VND_MONEY, "VND");
	 * verifyEquals(beforeBalanceAmountOfAccount1 - transferMoney,
	 * afterBalanceAmountOfAccount1);
	 * 
	 ...
	 * 1000);
	 * 
	 * log.info("TC_03_Step_31:Lay so du kha dung tai khoan nhan"); String
	 * afterBalanceOfAccount2 =
	 * transferInVCB.getDynamicTextInTransactionDetail(driver, "Số dư khả dụng");
	 * long afterBalanceAmountOfAccount2 =
	 * convertMoneyToLong(afterBalanceOfAccount2, "VND");
	 ...
	 * verifyEquals(beforeBalanceAmountOfAccount2 + transferMoney - fee,
	 * afterBalanceAmountOfAccount2);
	 * 
	 * }
	 * 
	 * @Test public void
	 * TC_04_KiemTraChiTietGiaoDichChuyenTienNgayCoPhiGiaoDichNguoiNhanTraVNDVaXacThucBangOTP
	 * () {
	 * 
	 ...
	 * "Chuyển tiền trong Vietcombank");
	 * 
	 * log.info("TC_04_Step_02:Click vao More Icon"); homePage =
	 * PageFactoryManager.getHomePageObject(driver);
	 * homePage.clickToDynamicImageViewByID(driver, "com.VCB:id/menu_5");
	 * 
	 * log.info("TC_04_Step_03:Click Bao Cao Dao Dich"); transReport =
	 * PageFactoryManager.getTransactionReportPageObject(driver);
	 * transReport.clickToDynamicButtonLinkOrLinkText(driver, "Báo cáo giao dịch");
	 * 
	 ...
	 * 
	 * log.info("TC_02_Step_09: Lay ngay tao giao dich hien thi"); String
	 * transferTimeIneport = transReport.getTextInDynamicTransactionInReport(driver,
	 * "0", "com.VCB:id/tvDate");
	 * 
	 * log.info("TC_02_Step_10: Kiem tra ngay tao giao dich hien thi");
	 ...
	 * "com.VCB:id/tvDate");
	 * 
	 * log.info("TC_04_Step_14: Kiem tra ngay giao dich hien thi"); String
	 * reportTime1 = transReport.getDynamicTextInTransactionDetail(driver,
	 * "Thời gian giao dịch"); verifyEquals(reportTime1, transferTimeIneport);
	 * 
	 ...
	 * verifyEquals(transReport.getDynamicTextInTransactionDetail(driver,
	 * "Tài khoản/thẻ trích nợ"), Account_Data.Valid_Account.ACCOUNT2);
	 * 
	 * log.info("TC_04_Step_18: Kiem tra so tai khoan ghi co");
	 * verifyEquals(transReport.getDynamicTextInTransactionDetail(driver,
	 * "Tài khoản ghi có"), Account_Data.Valid_Account.DEFAULT_ACCOUNT3);
	 * 
	 ...
	 * verifyEquals(transReport.getDynamicTextInTransactionDetail(driver,
	 * "Phí giao dịch"), TransferMoneyInVCB_Data.InputDataInVCB.COST[1]);
	 * 
	 * log.info("TC_04_Step_22: Kiem tra so tien phi hien thi"); if (fee > 0) {
	 * verifyEquals(transReport.getDynamicTextInTransactionDetail(driver,
	 * "Số tiền phí"), addCommasToLong(fee + "") + " VND"); }
	 ...
	 * transReport.clickToDynamicBackIcon(driver, "Chi tiết giao dịch");
	 * 
	 * log.info("TC_04_Step_26: Chon Tai Khoan"); transReport.clickToTextID(driver,
	 * "com.VCB:id/tvSelectAcc");
	 * 
	 ...
	 * transReport.clickToDynamicButton(driver, "Tìm kiếm");
	 * 
	 * log.info("TC_04_Step_29: Kiem tra ngay tao giao dich hien thi"); String
	 * transferTimeIneport2 =
	 * transReport.getTextInDynamicTransactionInReport(driver, "0",
	 * "com.VCB:id/tvDate");
	 * 
	 * log.info("TC_04_Step_30: Kiem tra ngay tao giao dich hien thi");
	 * verifyEquals(convertDateTimeIgnoreHHmmss(transferTimeIneport2),
	 * transferTime);
	 * 
	 ...
	 * "com.VCB:id/tvDate");
	 * 
	 * log.info("TC_04_Step_34: Kiem tra ngay tao giao dich hien thi"); String
	 * reportTime2 = transReport.getDynamicTextInTransactionDetail(driver,
	 * "Thời gian giao dịch"); verifyEquals(reportTime2, transferTimeIneport2);
	 * 
	 ...
	 * "Phí giao dịch"), TransferMoneyInVCB_Data.InputDataInVCB.COST[1]);
	 * 
	 * log.info("TC_04_Step_42: Kiem tra so tien phi hien thi"); if (fee > 0) {
	 * verifyEquals(transReport.getDynamicTextInTransactionDetail(driver,
	 * "Số tiền phí"), addCommasToLong(fee + "") + " VND"); }
	...
	public void TC_05_ChuyenTienNgayCoPhiGiaoDichNguoiChuyenTraUSDVaXacThucBangOTP() {
		...
		exchangeRate = convertAvailableBalanceCurrentcyToDouble(transferInVCB.getDynamicTextInTransactionDetail(driver, "Tỷ giá quy đổi tham khảo"));
		transferInVCB.clickToDynamicButton(driver, "Tiếp tục");
...
//		double usdTransferFee = convertVNeseMoneyToEUROOrUSD(fee + "", exchangeRate + "");
	...
	public void TC_06_KiemTraChiTietGiaoDichChuyenTienNgayCoPhiGiaoDichNguoiChuyenTraUSDVaXacThucBangOTP() {
		...
		String vietTransferMoney = convertEURO_USDToVNeseMoney(TransferMoneyInVCB_Data.InputDataInVCB.AMOUNT_OF_EUR_OR_USD_TRANSFER, exchangeRate + "");
		verifyTrue(transReport.getDynamicTextInTransactionDetail(driver, "Số tiền quy đổi").contains(vietTransferMoney));
	...
	public void TC_07_ChuyenTienNgayCoPhiGiaoDichNguoiNhanTraEURVaXacThucBangOTP() {
		...
		double exchangeRate = convertAvailableBalanceCurrentcyToDouble(transferInVCB.getDynamicTextInTransactionDetail(driver, "Tỷ giá quy đổi tham khảo"));
		transferInVCB.clickToDynamicButton(driver, "Tiếp tục");
...
//		verifyTrue(transferInVCB.getDynamicTextInTransactionDetail(driver, "Số tiền(EUR)").contains(addCommasToDouble(TransferMoneyInVCB_Data.InputDataInVCB.AMOUNT_OF_EUR_OR_USD_TRANSFER) + " EUR"));
		...
		double afterBalanceAmountOfAccount1 = convertMoneyToDouble(transferInVCB.getDynamicTextInTransactionDetail(driver, "Số dư khả dụng"), "EUR");
		...
		double afterBalanceAmountOfAccount2 = convertMoneyToDouble(transferInVCB.getDynamicTextInTransactionDetail(driver, "Số dư khả dụng"), "VND");

		log.info("TC_07_Step 43: Kiem tra so du tai khoan duoc chuyen den");
		verifyEquals(beforeBalanceAmountOfAccount2 + convertAvailableBalanceCurrentcyToDouble(vietTransferMoney) - convertMoneyToDouble(fee + "", "VND"), afterBalanceAmountOfAccount2);
