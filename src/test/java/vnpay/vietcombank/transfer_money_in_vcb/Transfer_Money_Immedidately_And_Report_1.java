...
public class Transfer_Money_Immedidately_And_Report_1 extends Base {
	...
	public void TC_01_ChuyenTienNgayCoPhiGiaoDichNguoiChuyenTraVNDVaXacThucBangOTP() {
		...
		String beforeBalanceOfAccount2 = sourceAccount.account;
		...
		verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.SOURCE_ACCOUNT), Account_Data.Valid_Account.DEFAULT_ACCOUNT3);

		log.info("TC_01_Step_14: Kiem tra tai khoan dich hien thi");
		verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.SOURCE_ACCOUNT_VND), Account_Data.Valid_Account.ACCOUNT2 + "/ ");
		...
		verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.NAME_BENEFICI), TransferMoneyInVCB_Data.InputDataInVCB.RECEIVER_NAME_ACCOUNT_2);

		log.info("TC_01_Step_29: Kiem tra tai khoan dich hien thi");
		verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.ACCOUNT_BENEFICI), Account_Data.Valid_Account.ACCOUNT2);
	...
	public void TC_02_KiemTraChiTietGiaoDichChuyenTienNgayCoPhiGiaoDichNguoiChuyenTraVNDVaXacThucBangOTP() {
		...
		transReport.clickToDynamicButtonLinkOrLinkText(driver, TittleData.REPORT_TRANSFER);

		log.info("TC_02_Step_04: Click Tat Ca Cac Loai Giao Dich");
		transReport.clickToDynamicButtonLinkOrLinkText(driver, TittleData.ALL_TYPE_TRANSFER);

		log.info("TC_02_Step_05: Chon Chuyen Tien Trong VCB");
		transReport.clickToDynamicButtonLinkOrLinkText(driver, InputDataInVCB.TRANSFER_TYPE);
		...
		transReport.clickToDynamicButton(driver, TittleData.SEARCH);
		...
		String reportTime1 = transReport.getDynamicTextInTransactionDetail(driver, TittleData.TIME_TRANSFER);
		verifyEquals(reportTime1, transferTimeInReport);

		log.info("TC_02_Step_16: Kiem tra thoi gian tao giao dich hien thi");
		verifyEquals(transReport.getDynamicTextInTransactionDetail(driver, TittleData.NUMBER_TRANSFER), transactionNumber);

		log.info("TC_02_Step_17: Kiem tra so tai khoan trich no");
		verifyEquals(transReport.getDynamicTextInTransactionDetail(driver, TittleData.ACCOUNT_SOURCE), Account_Data.Valid_Account.DEFAULT_ACCOUNT3);

		log.info("TC_02_Step_18: Kiem tra so tai khoan ghi co");
		verifyEquals(transReport.getDynamicTextInTransactionDetail(driver, TittleData.AMOUNT_SURPLUS), Account_Data.Valid_Account.ACCOUNT2);

		log.info("TC_02_Step_19: Kiem tra so tien giao dich hien thi");
		verifyTrue(transReport.getDynamicTextInTransactionDetail(driver, TittleData.AMOUNT_TRANSFER).contains(addCommasToLong(TransferMoneyInVCB_Data.InputDataInVCB.VND_MONEY) + " VND"));

		log.info("TC_02_Step_20: Kiem tra ten nguoi huong hien thi");
		verifyEquals(transReport.getDynamicTextInTransactionDetail(driver, TittleData.NAME_OF_BENEFICI), TransferMoneyInVCB_Data.InputDataInVCB.RECEIVER_NAME_ACCOUNT_2);

		log.info("TC_02_Step_21: Kiem tra phi giao dich hien thi");
		verifyEquals(transReport.getDynamicTextInTransactionDetail(driver, TittleData.FEE_TRANSFER), TransferMoneyInVCB_Data.InputDataInVCB.COST[0]);

		log.info("TC_02_Step_22: Kiem tra so tien phi hien thi");
		if (fee > 0) {
			verifyEquals(transReport.getDynamicTextInTransactionDetail(driver, TittleData.FEE_AMOUNT), addCommasToLong(fee + "") + " VND");
		}
		log.info("TC_02_Step_23: Kiem tra loai giao dich");
		verifyEquals(transReport.getDynamicTextInTransactionDetail(driver, TittleData.TYPE_TRANSACTION), TransferMoneyInVCB_Data.InputDataInVCB.TRANSFER_TYPE);

		log.info("TC_02_Step_24: Kiem Tra noi dung giao dich");
		verifyTrue(transReport.getDynamicTextInTransactionDetail(driver, TittleData.CONTENT_TRANSACTION).contains(TransferMoneyInVCB_Data.InputDataInVCB.NOTE));

		log.info("TC_02_Step_25: Click Back icon");
		transReport.clickToDynamicBackIcon(driver, TittleData.DETAIL_TRANSACTION);
		...
		String reportTime2 = transReport.getDynamicTextInTransactionDetail(driver, TittleData.TIME_TRANSFER);
		...
		transferInVCB.clickToDynamicBackIcon(driver, TittleData.DETAIL_TRANSACTION);

		log.info("TC_02_Step_36: Click quay lai");
		transferInVCB.clickToDynamicBackIcon(driver, TittleData.REPORT_TRANSFER);
	...
	public void TC_03_ChuyenTienNgayCoPhiGiaoDichNguoiNhanTraVNDVaXacThucBangOTP() {
		...
		transferInVCB.inputToDynamicInputBox(driver, Account_Data.Valid_Account.DEFAULT_ACCOUNT3, TittleData.INPUT_ACCOUNT_BENEFICI);
		...
		verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.SOURCE_ACCOUNT), Account_Data.Valid_Account.ACCOUNT2);

		log.info("TC_03_Step_16: Kiem tra tai khoan dich hien thi");
		verifyTrue(transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.SOURCE_ACCOUNT_VND).contains(Account_Data.Valid_Account.DEFAULT_ACCOUNT3));
		...
		verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.ACCOUNT_BENEFICI), Account_Data.Valid_Account.DEFAULT_ACCOUNT3);
	...
	public void TC_04_KiemTraChiTietGiaoDichChuyenTienNgayCoPhiGiaoDichNguoiNhanTraVNDVaXacThucBangOTP() {
		...
		verifyEquals(transReport.getDynamicTextInTransactionDetail(driver, TittleData.ACCOUNT_SOURCE), Account_Data.Valid_Account.ACCOUNT2);

		log.info("TC_04_Step_18: Kiem tra so tai khoan ghi co");
		verifyEquals(transReport.getDynamicTextInTransactionDetail(driver, TittleData.AMOUNT_SURPLUS), Account_Data.Valid_Account.DEFAULT_ACCOUNT3);
		...
		verifyEquals(transReport.getDynamicTextInTransactionDetail(driver, TittleData.FEE_TRANSFER), TransferMoneyInVCB_Data.InputDataInVCB.COST[1]);
	...
	public void TC_05_ChuyenTienNgayCoPhiGiaoDichNguoiChuyenTraUSDVaXacThucBangOTP() {
		...
		String beforeBalanceOfAccount2 = transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.SURPLUS);
		double beforeBalanceAmountOfAccount2 = convertMoneyToDouble(beforeBalanceOfAccount2, Constants.VND_CURRENCY);
		...
		verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.SOURCE_ACCOUNT), Account_Data.Valid_Account.USD_ACCOUNT);
		...
		verifyEquals(convertMoneyToDouble((beforeBalanceAmountOfAccount1 - transferMoney - usdTransferFee) + "", "USD"), afterBalanceAmountOfAccount1);
	...
	public void TC_06_KiemTraChiTietGiaoDichChuyenTienNgayCoPhiGiaoDichNguoiChuyenTraUSDVaXacThucBangOTP() {
		...
		verifyEquals(transReport.getDynamicTextInTransactionDetail(driver, TittleData.ACCOUNT_SOURCE), Account_Data.Valid_Account.USD_ACCOUNT);

		log.info("TC06_Step 18: Kiem tra so tai khoan ghi co");
		verifyEquals(transReport.getDynamicTextInTransactionDetail(driver, TittleData.AMOUNT_SURPLUS), Account_Data.Valid_Account.DEFAULT_ACCOUNT3);

		log.info("TC06_Step 19: Kiem tra so tien giao dich hien thi ");
		verifyTrue(transReport.getDynamicTextInTransactionDetail(driver, TittleData.AMOUNT_TRANSFER).equals(addCommasToDouble(TransferMoneyInVCB_Data.InputDataInVCB.AMOUNT_OF_EUR_OR_USD_TRANSFER) + " USD"));
		...
		verifyTrue(transReport.getDynamicTextInTransactionDetail(driver, TittleData.AMOUNT_CHANGE).contains(transferMoneyInVND));
		...
		verifyEquals(transReport.getTextInDynamicTransactionInReport(driver, "1", "com.VCB:id/tvMoney"), ("+ " + transferMoneyInVND));
		...
		verifyTrue(transReport.getDynamicTextInTransactionDetail(driver, TittleData.AMOUNT_TRANSFER).contains(addCommasToDouble(TransferMoneyInVCB_Data.InputDataInVCB.AMOUNT_OF_EUR_OR_USD_TRANSFER) + " USD"));
	...
	public void TC_07_ChuyenTienNgayCoPhiGiaoDichNguoiNhanTraEURVaXacThucBangOTP() {
		...
		double afterBalanceAmountOfAccount1 = convertMoneyToDouble(transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.SURPLUS), "EUR");
	...
	public void TC_08_KiemTraChiTietGiaoDichChuyenTienNgayCoPhiGiaoDichNguoiNhanTraEURVaXacThucBangOTP() {
		...
		verifyEquals(transReport.getDynamicTextInTransactionDetail(driver, TittleData.ACCOUNT_SOURCE), Account_Data.Valid_Account.EUR_ACCOUNT);

		log.info("TC_08_Step 18: Kiem tra so tai khoan ghi co");
		verifyEquals(transReport.getDynamicTextInTransactionDetail(driver, TittleData.AMOUNT_SURPLUS), Account_Data.Valid_Account.DEFAULT_ACCOUNT3);

		log.info("TC_08_Step 19: Kiem tra so tien giao dich hien thi ");
		verifyTrue(transReport.getDynamicTextInTransactionDetail(driver, TittleData.AMOUNT_TRANSFER).equals(addCommasToDouble(TransferMoneyInVCB_Data.InputDataInVCB.AMOUNT_OF_EUR_OR_USD_TRANSFER) + " EUR"));
		...
		verifyTrue(transReport.getDynamicTextInTransactionDetail(driver, TittleData.AMOUNT_CHANGE).contains(addCommasToLong(changedMoney) + " VND"));
		...
		verifyTrue(transReport.getDynamicTextInTransactionDetail(driver, TittleData.AMOUNT_TRANSFER).contains(addCommasToDouble(TransferMoneyInVCB_Data.InputDataInVCB.AMOUNT_OF_EUR_OR_USD_TRANSFER) + " EUR"));
	...
	public void TC_09_ChuyenTienNgayDenTaiKhoanKhacChuSoHuuCoPhiGiaoDichNguoiChuyenTraVNDVaXacThucBangOTP() {
		...
		transferInVCB.inputToDynamicInputBox(driver, Account_Data.Valid_Account.DIFFERENT_OWNER_ACCOUNT, TittleData.INPUT_ACCOUNT_BENEFICI);
		...
		verifyTrue(transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.SOURCE_ACCOUNT_VND).contains(Account_Data.Valid_Account.DIFFERENT_OWNER_ACCOUNT));
		...
		verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.NAME_BENEFICI), TransferMoneyInVCB_Data.InputDataInVCB.DIFFERENT_OWNER_NAME);

		log.info("TC_09_Step_26: Kiem tra tai khoan dich hien thi");
		verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.ACCOUNT_BENEFICI), Account_Data.Valid_Account.DIFFERENT_OWNER_ACCOUNT);
	...
	public void TC_10_KiemTraChiTietGiaoDichChuyenTienNgayDenTaiKhoanKhacChuSoHuuCoPhiGiaoDichNguoiChuyenTraVNDVaXacThucBangOTP() {
		...
		verifyEquals(transReport.getDynamicTextInTransactionDetail(driver, TittleData.AMOUNT_SURPLUS), Account_Data.Valid_Account.DIFFERENT_OWNER_ACCOUNT);

		log.info("TC_10_Step_19: Kiem tra so tien giao dich hien thi");
		verifyTrue(transReport.getDynamicTextInTransactionDetail(driver, TittleData.AMOUNT_TRANSFER).contains(addCommasToLong(TransferMoneyInVCB_Data.InputDataInVCB.VND_MONEY) + " VND"));

		log.info("TC_10_Step_20: Kiem tra ten nguoi huong hien thi");
		verifyEquals(transReport.getDynamicTextInTransactionDetail(driver, TittleData.NAME_OF_BENEFICI), TransferMoneyInVCB_Data.InputDataInVCB.DIFFERENT_OWNER_NAME);
		...
		transReport.clickToDynamicBackIcon(driver, TittleData.REPORT_TRANSFER);
