...
public class Transfer_Money_In_Immedidately_Limit extends Base {
	...
	public void TC_03_ChuyenTienTuongLaiVuotQuaHanMucTrongNgay(String otp) throws InterruptedException {
		...
		verifyTrue(transferInVCB.getDynamicTextView(driver, "com.VCB:id/tvContent").contains("Chuyển tiền không thành công. Số tiền giao dịch lớn hơn hạn mức 1,000,000 VND/1 ngày"));
		...
		loginWeb.resetAssignServicesLimit_Total_Day(driverWeb, "Chuyển khoản nội bộ cùng chủ tài khoản");
