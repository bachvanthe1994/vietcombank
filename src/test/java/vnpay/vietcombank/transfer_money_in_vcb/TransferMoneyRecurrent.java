...
public class TransferMoneyRecurrent extends Base {
	...
	private String transferTime, expectAvailableBalance, receivedAccount, receivedName;
	long transferFee = 0;
	...
	@Test
	public void TC_01_ChuyenTien_VND_DinhKy_1Thang_CoPhiGiaoDichNguoiChuyenTra_XacThucBangMatKhau() {
		...
		log.info("TC_01_03_Chon tai khoan nguon");
		...
		log.info("TC_01_07_Nhap noi dung");
		...
		log.info("TC_01_09_Kiem tra man hinh xac nhan thong tin");
		log.info("TC_01_09_1_Kiem tra hinh thuc chuyen tien");
		...
		log.info("TC_01_09_4_Kiem tra tan suat");
		...
		log.info("TC_01_9_5_Kiem tra noi dung");
		...
		log.info("TC_01_12_1_Nhap MK va click Tiep tuc");
		...
		log.info("TC_01_13_0_Lay thoi gian giao dich");
		...
		log.info("TC_01_13_4_Kiem tra nut Thuc hien giao dich moi");
	...
	@Test
	public void TC_02_ChuyenTien_VND_KiemTraSoDuSauGiaoDich_PhiGiaoDich_NguoiNhanTra() {
	...
	public void TC_03_TrangThaiGiaoDich_ChuyenTien_VND_DinhKy_1Thang_CoPhiGiaoDichNguoiChuyenTra_XacThucBangMatKhau() {
		...
		log.info("TC_03_09: Kiem tra nguoi nhan");
	...
	@Test
	public void TC_04_HuyGiaoDich_ChuyenTien_VND_DinhKy_1Thang_CoPhiGiaoDichNguoiChuyenTra_XacThucBangMatKhau() {
	...
	@Test
	public void TC_05_ChuyenTien_NgoaiTe_DinhKy_2Thang_CoPhiGiaoDichNguoiNhanTra_XacThucBangMatKhauDangNhap() {

		home.clickToDynamicButtonLinkOrLinkText(driver, Home_Text_Elements.HOME_TRANSFER_IN_VCB);

		log.info("TC_05_02_Chon phuong thuc chuyen tien");
		transferRecurrent.clickToDynamicButtonLinkOrLinkText(driver, InputDataInVCB.OPTION_TRANSFER[0]);
		transferRecurrent.clickToDynamicButtonLinkOrLinkText(driver, InputDataInVCB.OPTION_TRANSFER[1]);

		log.info("TC_05_03_Chon tai khoan nguon");
		transferRecurrent.clickToDynamicDropDown(driver, TittleData.SOURCE_ACCOUNT);
		sourceAccount = transferRecurrent.chooseSourceAccount(driver, Constants.MONEY_CHECK_EUR, Constants.EUR_CURRENCY);
		expectAvailableBalance = sourceAccount.balance;

		log.info("TC_05_03_1_Nhap tai khoan nhan");
		transferRecurrent.inputToDynamicInputBox(driver, receivedAccount, TittleData.INPUT_ACCOUNT_BENEFICI);

		log.info("TC_05_04_Chon tan suat");
		transferRecurrent.clickToDynamicButtonLinkOrLinkText(driver, InputData_MoneyRecurrent.DAY_TEXT);
		...
		log.info("TC_05_09_1_Kiem tra hinh thuc chuyen tien");
		transferRecurrent.scrollUpToText(driver, TittleData.FORM_TRANSFER);
		verifyEquals(transferRecurrent.getDynamicTextInTransactionDetail(driver, TittleData.FORM_TRANSFER), InputDataInVCB.OPTION_TRANSFER[1]);

		log.info("TC_05_09_2_Kiem tra tai khoan nguon");
		verifyEquals(transferRecurrent.getDynamicTextInTransactionDetail(driver, TittleData.SOURCE_ACCOUNT), sourceAccount.account);

		log.info("TC_05_09_3_Kiem tra tai khoan dich");
		verifyTrue(transferRecurrent.getDynamicTextInTransactionDetail(driver, TittleData.SOURCE_ACCOUNT_VND).contains(receivedAccount));

		log.info("TC_05_09_4_Kiem tra tan suat");
		...
		log.info("TC_05_09_5_Kiem tra noi dung");
		...
		log.info("TC_05_12_1_Nhap MK va click Tiep tuc");
		transferRecurrent.inputToDynamicPopupPasswordInput(driver, password, TittleData.CONTINUE_BTN);
		transferRecurrent.clickToDynamicButton(driver, TittleData.CONTINUE_BTN);
		...
		log.info("TC_05_123_2_Kiem tra tai khoan dich");
		verifyEquals(transferRecurrent.getDynamicTextInTransactionDetail(driver, TittleData.ACCOUNT_BENEFICI), receivedAccount);
	...
	@Test
	public void TC_06_ChuyenTien_EUR_KiemTraSoDuSauGiaoDich_PhiGiaoDich_NguoiNhanTra() {
	...
	@Test
	public void TC_07_TrangThaiGiaoDich_ChuyenTien_NgoaiTe_DinhKy_2Thang_CoPhiGiaoDichNguoiNhanTra_XacThucBangMatKhauDangNhap() {
		...
		log.info("TC_07_09: Kiem tra nguoi nhan");
		verifyEquals(transferStatus.getTextInDynamicTransactionInTransferOrderStatus(driver, "0", "com.VCB:id/tvContent"), receivedName);
		...
		log.info("TC_07_14: Kiem tra ten nguoi huong hien thi");
		verifyEquals(transferStatus.getDynamicTextInTransactionDetail(driver, TransferMoneyStatus_Data.Text.NAME_RECEIPTER), receivedName);

		log.info("TC_07_15: Kiem tra so tien thi");
		...
		log.info("TC_07_16: Kiem tra tan suat");
		...
		log.info("TC_07_17: Kiem ngay bat dau");
		verifyEquals(transferStatus.getDynamicTextInTransactionDetail(driver, TransferMoneyStatus_Data.Text.START_DATE_TEXT), startDate);

		log.info("TC_07_18: Kiem ngay ket thuc");
		verifyEquals(transferStatus.getDynamicTextInTransactionDetail(driver, TransferMoneyStatus_Data.Text.END_DATE_TEXT), endDate);

		log.info("TC_07_19: Click  nut Back");
		transferStatus.clickToDynamicBackIcon(driver, TransferMoneyStatus_Data.Text.DETAIL_TRANSFER);

	}

	@Test
	public void TC_08_HuyGiaoDich_ChuyenTien_NgoaiTe_DinhKy_2Thang_CoPhiGiaoDichNguoiNhanTra_XacThucBangMatKhauDangNhap() {
	...
	@Test
	public void TC_09_ChuyenTien_NgoaiTe_USD_DinhKy_2Ngay_CoPhiGiaoDichNguoiChuyenTra_XacThucBangOTP() {
		...
		log.info("TC_09_9_2_Kiem tra tai khoan dich");
		verifyTrue(transferRecurrent.getDynamicTextInTransactionDetail(driver, TittleData.SOURCE_ACCOUNT_VND).contains(receivedAccount));

		log.info("TC_09_9_3_Kiem tra tan suat");
		...
		log.info("TC_09_9_4_Kiem tra tan suat");
		verifyEquals(transferRecurrent.getDynamicTextInTransactionDetail(driver, InputText_MoneyRecurrent.TRANSACTION_TIMES_TEXT), "2");
		...
		log.info("TC_09_13_3_Kiem tra ten noi dung");
		verifyEquals(transferRecurrent.getDynamicTextInTransactionDetail(driver, TittleData.CONTENT), info4.note);
	...
	@Test
	public void TC_10_ChuyenTien_USD_KiemTraSoDuSauGiaoDich_PhiGiaoDich_NguoiChuyenTra() {
	...
	@Test
	public void TC_11_TrangThaiGiaoDich_ChuyenTien_NgoaiTe_DinhKy_2Ngay_CoPhiGiaoDichNguoiNhanTra_XacThucBangOTP() {
	...
	@Test
	public void TC_12_HuyGiaoDich_ChuyenTien_NgoaiTe_USD_DinhKy_2Ngay_CoPhiGiaoDichNguoiNhanTra_XacThucBangOTP() {
	...
	@Test
	public void TC_13_ChuyenTien_NgoaiTe_USD_DinhKy_2Ngay_CoPhiGiaoDichNguoiNhanTra_XacThucBangOTP() {
		...
		log.info("TC_13_09_1_Kiem tra tai khoan nguon");
		verifyEquals(transferRecurrent.getDynamicTextInTransactionDetail(driver, TittleData.SOURCE_ACCOUNT), sourceAccount.account);

		log.info("TC_13_09_2_Kiem tra tai khoan dich");
		verifyTrue(transferRecurrent.getDynamicTextInTransactionDetail(driver, TittleData.SOURCE_ACCOUNT_VND).contains(receivedAccount));

		log.info("TC_13_09_3_Kiem tra tan suat");
	...
	@Test
	public void TC_14_ChuyenTien_USD_KiemTraSoDuSauGiaoDich_PhiGiaoDich_NguoiNhanTra() {
	...
	@Test
	public void TC_15_TrangThaiGiaoDich_ChuyenTien_NgoaiTe_DinhKy_2Ngay_CoPhiGiaoDichNguoiNhanTra_XacThucBangOTP() {
	...
	@Test
	public void TC_16_HuyGiaoDich_ChuyenTien_NgoaiTe_USD_DinhKy_2Ngay_CoPhiGiaoDichNguoiNhanTra_XacThucBangOTP() {
	...
	@Test
	public void TC_17_ChuyenTien_VND_DinhKy_2Ngay_CoPhiGiaoDichNguoiNhanTra_XacThucBangOTP_LuuDanhBaThuHuong() {
		...
		log.info("TC_17_3_1_Nhan tai khoan nhan");
		transferRecurrent.inputToDynamicInputBox(driver, receivedAccount, TittleData.INPUT_ACCOUNT_BENEFICI);
		...
		if (transferRecurrent.getPageSource(driver).contains(InputText_MoneyRecurrent.SAVE_RECEIVED_ACCOUNT_TEXT)) {
			...
			log.info("TC_17_14_07_Click Dong");
			transferRecurrent.clickToDynamicButton(driver, TittleData.CLOSE);
		}

		log.info("TC_17_15_Click Thuc hien giao dich moi");
		transferRecurrent.clickToDynamicButton(driver, TittleData.NEW_TRANSFER);

	}

	@Test
	public void TC_18_ChuyenTien_VND_DinhKy_2Ngay_CoPhiGiaoDichNguoiNhanTra_XacThucBangOTP_LayDanhBaThuHuong() {

		log.info("TC_18_2_Chon phuong thuc chuyen tien");
		transferRecurrent.clickToDynamicButtonLinkOrLinkText(driver, InputDataInVCB.OPTION_TRANSFER[0]);
		transferRecurrent.clickToDynamicButtonLinkOrLinkText(driver, InputDataInVCB.OPTION_TRANSFER[1]);

		log.info("TC_18_3_Chon tai khoan nguon");
		transferRecurrent.clickToDynamicDropDown(driver, TittleData.SOURCE_ACCOUNT);
		sourceAccount = transferRecurrent.chooseSourceAccount(driver, Constants.MONEY_CHECK_VND, Constants.VND_CURRENCY);
		expectAvailableBalance = sourceAccount.balance;

		log.info("TC_18_3_1_Nhan tai khoan nhan");
		transferRecurrent.clickToDynamicIconByEdit(driver, TittleData.INPUT_ACCOUNT_BENEFICI);
		transferRecurrent.clickToDynamicTextContains(driver, receivedAccount);

		log.info("TC_18_4_Chon tan suat");
		transferRecurrent.clickToDynamicButtonLinkOrLinkText(driver, InputData_MoneyRecurrent.DAY_TEXT);
		transferRecurrent.clickToDynamicButtonLinkOrLinkText(driver, info1.frequencyCategory);
		transferRecurrent.inputFrequencyNumber(info1.frequencyNumber);

		log.info("TC_18_5_Nhap so tien");
		transferRecurrent.inputToDynamicInputBox(driver, info1.money, TittleData.AMOUNT);

		log.info("TC_18_6_Chon nguoi tra phi giao dich");
		transferRecurrent.clickToDynamicButtonLinkOrLinkText(driver, TittleData.FEE_TRANSFER_SOURCE_ACCOUNT_PAY);
		transferRecurrent.clickToDynamicButtonLinkOrLinkText(driver, info1.fee);

		log.info("TC_18_7_Nhap noi dung");
		transferRecurrent.inputToDynamicInputBoxByHeader(driver, info1.note, TittleData.TRANSFER_INFO, "3");

		log.info("TC_18_8_Click Tiep tuc");
		transferRecurrent.clickToDynamicButton(driver, TittleData.CONTINUE_BTN);

		log.info("TC_18_9_Kiem tra man hinh xac nhan thong tin");
		transferRecurrent.scrollUpToText(driver, TittleData.FORM_TRANSFER);
		verifyEquals(transferRecurrent.getDynamicTextInTransactionDetail(driver, TittleData.FORM_TRANSFER), InputDataInVCB.OPTION_TRANSFER[1]);

		log.info("TC_18_9_1_Kiem tra tai khoan nguon");
		verifyEquals(transferRecurrent.getDynamicTextInTransactionDetail(driver, TittleData.SOURCE_ACCOUNT), sourceAccount.account);

		log.info("TC_18_9_2_Kiem tra tai khoan dich");
		verifyTrue(transferRecurrent.getDynamicTextInTransactionDetail(driver, TittleData.SOURCE_ACCOUNT_VND).contains(receivedAccount));

		log.info("TC_18_9_3_Kiem tra tan suat");
		verifyEquals(transferRecurrent.getDynamicTextInTransactionDetail(driver, InputText_MoneyRecurrent.TRANSFER_FREQUENCY_TEXT), info1.frequencyNumber + " " + info1.frequencyCategory + InputText_MoneyRecurrent.TRANSFER_PER_TIMES_TEXT);

		log.info("TC_18_9_4_Kiem tra tan suat");
		verifyEquals(transferRecurrent.getDynamicTextInTransactionDetail(driver, InputText_MoneyRecurrent.TRANSACTION_TIMES_TEXT), "2");

		log.info("TC_18_9_5_Kiem tra noi dung");
		verifyEquals(transferRecurrent.getDynamicTextInTransactionDetail(driver, TittleData.CONTENT), info1.note);

		log.info("TC_18_10_Chon phuong thuc xac thuc");
		transferRecurrent.scrollDownToText(driver, TittleData.METHOD_VALIDATE);
		transferRecurrent.clickToDynamicButtonLinkOrLinkText(driver, InputDataInVCB.PAYMENT_OPTIONS[0]);
		transferRecurrent.clickToDynamicButtonLinkOrLinkText(driver, info1.authenticationMethod);

		log.info("TC_18_11_Kiem tra so tien phi");
		String fee = transferRecurrent.getDynamicTextInTransactionDetail(driver, InputText_MoneyRecurrent.FEE_PER_TIMES_TEXT);
		transferFee = convertAvailableBalanceCurrentcyOrFeeToLong(fee);

		log.info("TC_18_12_Click Tiep tuc");
		transferRecurrent.clickToDynamicButton(driver, TittleData.CONTINUE_BTN);

		log.info("TC_18_12_1_Nhap OTP va click Tiep tuc");
		transferRecurrent.inputToDynamicOtp(driver, LogIn_Data.Login_Account.OTP, TittleData.CONTINUE_BTN);
		transferRecurrent.clickToDynamicButton(driver, TittleData.CONTINUE_BTN);

		log.info("TC_18_13_Kiem tra man hinh Lap lenh thanh cong");
		verifyTrue(transferRecurrent.isDynamicMessageAndLabelTextDisplayed(driver, TransferMoneyQuick_Data.TransferQuick.SUCCESS_TRANSFER_MONEY_IN_VCB_RECURRENT));

		log.info("TC_18_13_0_Lay thoi gian giao dich");
		transferTime = transferRecurrent.getTransferMoneyRecurrentTimeSuccess(driver, TransferMoneyQuick_Data.TransferQuick.SUCCESS_TRANSFER_MONEY_IN_VCB_RECURRENT);

		log.info("TC_18_13_1_Kiem tra ten nguoi huong thu");
		verifyEquals(transferRecurrent.getDynamicTextInTransactionDetail(driver, TittleData.NAME_BENEFICI), receivedName);

		log.info("TC_18_13_2_Kiem tra tai khoan dich");
		verifyEquals(transferRecurrent.getDynamicTextInTransactionDetail(driver, TittleData.ACCOUNT_BENEFICI), receivedAccount);

		log.info("TC_18_13_3_Kiem tra ten noi dung");
		verifyEquals(transferRecurrent.getDynamicTextInTransactionDetail(driver, TittleData.CONTENT), info1.note);

		log.info("TC_18_13_4_Kiem tra nut thuc hien giao dich moi");
		verifyTrue(transferRecurrent.isDynamicButtonDisplayed(driver, TittleData.NEW_TRANSFER));

		log.info("TC_18_15_Click Thuc hien giao dich moi");
		transferRecurrent.clickToDynamicButton(driver, TittleData.NEW_TRANSFER);
