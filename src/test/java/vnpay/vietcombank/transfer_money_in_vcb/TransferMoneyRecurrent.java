...
public class TransferMoneyRecurrent extends Base {
	...
	verifyEquals(transferRecurrent.getDynamicTextInTextViewLine(driver, "Số tiền phí"), info.fee);
	...
	verifyEquals(transferRecurrent.getDynamicTextInTextViewLine(driver, "Số tiền phí"), info1.fee);
	...
	verifyEquals(transferRecurrent.getDynamicTextInTextViewLine(driver, "Số tiền phí"), info2.fee);
	...
	verifyEquals(transferRecurrent.getDynamicTextInTextViewLine(driver, "Số tiền phí"), info3.fee);
