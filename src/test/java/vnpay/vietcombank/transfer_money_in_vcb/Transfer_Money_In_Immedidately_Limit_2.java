...
// Hạn mức nội bộ khác chủ tài khoản
	...
	public void TC_03_ChuyenTienTuongLaiVuotQuaHanMucTrongNgay(String otp, String pass) throws InterruptedException {
		...
		loginWeb.setupAssignServicesLimit_Total_Day(driverWeb, TittleData.TRANSFER_IN_BANK_OTHER_OWNER, inputInfo, Constants.BE_CODE_PACKAGE);
		...
		loginWeb.resetAssignServicesLimit(driverWeb, TittleData.TRANSFER_IN_BANK_OTHER_OWNER, Constants.BE_CODE_PACKAGE);
	}
	...
	public void TC_04_ChuyenTienTuongLaiVuotQuaNhomDichVu() throws InterruptedException {
		...
		loginWeb.Setup_Assign_Services_Type_Limit(driverWeb, Constants.BE_CODE_PACKAGE, TittleData.TRANSFER_IN_BANK_OTHER_OWNER, Constants.AMOUNT_DEFAULT_MIN_PACKAGE);
		...
		loginWeb.Reset_Setup_Assign_Services_Type_Limit(driverWeb, Constants.BE_CODE_PACKAGE, TittleData.TRANSFER_IN_BANK_OTHER_OWNER);

	}

	@Test
	public void TC_05_ChuyenTienTuongLaiVuotQuaGoiDichVu() throws InterruptedException {
		loginWeb.Setup_Add_Method_Package_Total_Limit(driverWeb, Constants.BE_CODE_PACKAGE, TittleData.TITTLE_METHOD, Constants.AMOUNT_DEFAULT_MIN_PACKAGE);
