...
public class Transfer_Money_In_Future_And_Report_1 extends Base {
	...
	private String transferTime, transactionNumber, receiverName;
	...
	public void TC_01_ChuyenTienTuongLai_CoPhiGiaoDich_NguoiChuyenTra_USD_VaXacThucBang_OTP(String otp) {
		...
		receiverName = transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.NAME_BENEFICI);
		...
		verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.NAME_BENEFICI), receiverName);
	...
	public void TC_02_KiemTraChiTietGiaoDich_ChuyenTienTuongLai_CoPhiGiaoDich_NguoiChuyenTra_USD_VaXacThucBang_OTP() {
		...
		verifyEquals(transferStatus.getTextInDynamicTransactionInTransferOrderStatus(driver, "0", "com.VCB:id/tvContent"), receiverName);
		...
		verifyEquals(transferStatus.getTextInDynamicTransactionInTransferOrderStatus(driver, "1", "com.VCB:id/tvMoney"), TransferMoneyInVCB_Data.InputDataInFutureForOTP.AMOUNT_OF_EUR_OR_USD_TRANSFER + " USD");
		...
		verifyEquals(transferStatus.getDynamicTextInTransactionDetail(driver, Text.NAME_RECEIPTER), receiverName);

		log.info("TC_02_Step 18: Kiem tra so tien thi");
		verifyEquals(transferStatus.getDynamicTextInTransactionDetail(driver, Text.AMOUNT), TransferMoneyInVCB_Data.InputDataInFutureForOTP.AMOUNT_OF_EUR_OR_USD_TRANSFER + " USD");
	...
	public void TC_04_ChuyenTienTuongLai_CoPhiGiaoDich_NguoiNhanTra_EUR_VaXacThucBang_OTP(String otp) {
		...
		transactionNumber = transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.CODE_TRANSFER);
		log.info("TC_04_Step_34: Lay ma giao dich" + transactionNumber);

		log.info("TC_04_Step_35: Lay ten nguoi thu huong hien thi");
		receiverName = transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.NAME_BENEFICI);
		
		log.info("TC_04_Step_36: Kiem tra tai khoan dich hien thi");
		verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.ACCOUNT_BENEFICI), distanceAccount.account);

		log.info("TC_04_Step_37: Kiem tra noi dung hien thi");
		verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.CONTENT), TransferMoneyInVCB_Data.InputDataInVCB.NOTE);

		log.info("TC_04_Step_38: Click thuc hien giao dich moi");
		transferInVCB.clickToDynamicButton(driver, TittleData.NEW_TRANSFER);

		log.info("TC_04_Step_39: Click tai khoan nguon");
		transferInVCB.clickToDynamicDropDown(driver, TittleData.SOURCE_ACCOUNT);

		log.info("TC_04_Step_40: Chon tai ngoan chuyen");
		transferInVCB.clickToDynamicButtonLinkOrLinkText(driver, sourceAccount.account);
		transferInVCB.sleep(driver, 500);

		log.info("TC_04_Step_41: Lay so du tai khoan chuyen");
		String afterBalanceOfAccount1 = transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.SURPLUS);
		double afterBalanceAmountOfAccount1 = convertMoneyToDouble(afterBalanceOfAccount1, "EUR");

		log.info("TC_04_Step_42: Kiem tra so du tai khoan chuyen sau khi thuc hien giao dich");
		verifyEquals(beforeBalanceAmountOfAccount1, afterBalanceAmountOfAccount1);

		log.info("TC_04_Step_43: Click tai khoan nguon");
		transferInVCB.clickToDynamicDropDown(driver, TittleData.SOURCE_ACCOUNT);

		log.info("TC_04_Step_44: Chon tai khoan nguoi nhan");
		transferInVCB.clickToDynamicButtonLinkOrLinkText(driver, distanceAccount.account);
		transferInVCB.sleep(driver, 500);

		log.info("TC_04_Step_45: Lay so du kha dung tai khoan nhan");
		String afterBalanceOfAccount2 = transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.SURPLUS);

		log.info("TC_04_Step_46: Kiem tra so du tai khoan nhan sau khi nhan tien");
		long afterBalanceAmountOfAccount2 = convertMoneyToLong(afterBalanceOfAccount2, Constants.VND_CURRENCY);
		verifyEquals(beforeBalanceAmountOfAccount2, afterBalanceAmountOfAccount2);
	...
	public void TC_05_KiemTraChiTietGiaoDich_ChuyenTienTuongLai_CoPhiGiaoDich_NguoiNhanTra_EUR_VaXacThucBang_OTP() {
		...
		verifyEquals(transferStatus.getTextInDynamicTransactionInTransferOrderStatus(driver, "1", "com.VCB:id/tvMoney"), TransferMoneyInVCB_Data.InputDataInFutureForOTP.AMOUNT_OF_EUR_OR_USD_TRANSFER + " EUR");
		...
		verifyEquals(transferStatus.getDynamicTextInTransactionDetail(driver, Text.AMOUNT), TransferMoneyInVCB_Data.InputDataInFutureForOTP.AMOUNT_OF_EUR_OR_USD_TRANSFER + " EUR");
	...
	public void TC_06_HuyLenh_GiaoDichTuongLai_XacThucBang_OTP() {
		...
		verifyEquals(transferStatus.getDynamicTextDetailByIDOrPopup(driver, "com.VCB:id/tvContent"), TittleData.SUCCESS);
		...
		verifyEquals(transferStatus.getDynamicTextInTransactionDetail(driver, TittleData.STATUS), TransferMoneyStatus_Data.Output.CANCEL_STATUS);
	...
	@Parameters({ "otp" })
	@Test
	public void TC_07_ChuyenTienTuongLai_DenTaiKhoan_KhacChuSoHuu_CoPhiGiaoDich_NguoiChuyenTra_VND_VaXacThucBang_OTP(String otp) {
		...
		log.info("TC_07_Step_09: Nhap noi dung");
		transferInVCB.inputToDynamicInputBoxByHeader(driver, TransferMoneyInVCB_Data.InputDataInVCB.NOTE, TittleData.TRANSFER_INFO, "3");
		...
		log.info("TC_07_Step_15: Kiem tra phuong thuc thanh toan phi bang OTP");
		verifyTrue(transferInVCB.isDynamicMessageAndLabelTextDisplayed(driver, TransferMoneyInVCB_Data.InputDataInVCB.COST[0]));

		log.info("TC_07_Step_16: Kiem tra noi dung hien thi");
		verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.CONTENT), TransferMoneyInVCB_Data.InputDataInVCB.NOTE);

		log.info("TC_07_Step_17: Chon Phuong thuc nhap");
		transferInVCB.clickToDynamicDropDown(driver, TittleData.METHOD_VALIDATE);

		log.info("TC_07_Step_18: Chon SMS OTP");
		transferInVCB.clickToDynamicButtonLinkOrLinkText(driver, TransferMoneyInVCB_Data.InputDataInVCB.PAYMENT_OPTIONS[1]);

		log.info("TC_07_Step_20: Click Tiep tuc");
		transferInVCB.clickToDynamicButton(driver, TittleData.CONTINUE_BTN);

		log.info("TC_07_Step_21: Nhap OTP");
		transferInVCB.inputToDynamicOtp(driver, otp, TittleData.CONTINUE_BTN);

		log.info("TC_07_Step_22: Click tiep tuc");
		transferInVCB.clickToDynamicButton(driver, TittleData.CONTINUE_BTN);

		log.info("TC_07_Step_23: Kiem  tra giao dich thanh cong");
		verifyTrue(transferInVCB.isDynamicMessageAndLabelTextDisplayed(driver, TransferMoneyInVCB_Data.Output.SUCESSFULL_CREATED_ORDER));

		log.info("TC_07_Step_24: Lay thoi gian tao giao dich");
		transferTime = transferInVCB.getDynamicTransferTimeAndMoney(driver, TransferMoneyInVCB_Data.Output.SUCESSFULL_CREATED_ORDER, "4");
		verifyEquals(transferTime, TransferMoneyInVCB_Data.Output.ORDER_TIME + capitalizeString(transferInVCB.getDayInWeek(tommorrowDate)) + " " + tommorrowDate);

		log.info("TC_07_Step_25: Lay ma giao dich");
		transactionNumber = transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.CODE_TRANSFER);

		log.info("TC_07_Step_26: Kiem tra ten nguoi thu huong hien thi");
		verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.NAME_BENEFICI), name_other_owner);

		log.info("TC_07_Step_27: Kiem tra tai khoan dich hien thi");
		verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.ACCOUNT_BENEFICI), account_other_owner);

		log.info("TC_07_Step_28: Kiem tra noi dung hien thi");
		verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.CONTENT), TransferMoneyInVCB_Data.InputDataInVCB.NOTE);

		log.info("TC_07_Step_29: Click thuc hien giao dich moi");
		transferInVCB.clickToDynamicButton(driver, TittleData.NEW_TRANSFER);

		log.info("TC_07_Step_30: Click tai khoan nguon");
		transferInVCB.clickToDynamicDropDown(driver, TittleData.SOURCE_ACCOUNT);

		log.info("TC_07_Step_31: Chon tai ngoan chuyen");
		sourceAccount = transferInVCB.chooseSourceAccount(driver, Constants.AMOUNT_VND, Constants.VND_CURRENCY);

		log.info("TC_07_Step_32: Lay so du tai khoan chuyen");
		String afterBalanceOfAccount1 = transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.SURPLUS);
		long afterBalanceAmountOfAccount1 = convertMoneyToLong(afterBalanceOfAccount1, Constants.VND_CURRENCY);

		log.info("TC_07_Step_33: Kiem tra so du tai khoan chuyen sau khi thuc hien giao dich");
		verifyEquals(beforeBalanceAmountOfAccount1, afterBalanceAmountOfAccount1);
	...
	public void TC_08_KiemTraChiTietGiaoDich_ChuyenTienTuongLai_CoPhiGiaoDich_NguoiChuyenTra_EUR_VaXacThucBang_OTP() {
		...
		log.info("TC_08_Step_02: Click vao Trang Thai lenh chuyen Tien");
		homePage.clickToDynamicIcon(driver, TittleData.STATUS_TRANSACTION);
		...
		verifyEquals(transferStatus.getTextInDynamicTransactionInTransferOrderStatus(driver, "0", "com.VCB:id/tvContent"), name_other_owner);
		...
		verifyEquals(transferStatus.getDynamicTextInTransactionDetail(driver, Text.NAME_RECEIPTER), name_other_owner);
	...
	@Test
	public void TC_09_HuyLenh_GiaoDichTuongLai_XacThucBang_OTP() {
	...
	@Parameters({ "otp" })
	@Test
	public void TC_10_ChuyenTienTuongLai_DenTaiKhoanKhacChuSoHuu_CoPhiGiaoDich_NguoiNhanTra_VND_VaXacThucBang_OTP(String otp) {
		...
		log.info("TC_10_Step_03: Chon chuyen tien tuong lai");
		transferInVCB.clickToDynamicButtonLinkOrLinkText(driver, TransferMoneyInVCB_Data.InputDataInVCB.OPTION_TRANSFER[2]);

		log.info("TC_10_Step_04:Click tai khoan nguon");
		transferInVCB.clickToDynamicDropDown(driver, TittleData.SOURCE_ACCOUNT);

		log.info("TC_10_Step_05: Chon tai khoan chuyen");
		sourceAccount = transferInVCB.chooseSourceAccount(driver, Constants.AMOUNT_VND, Constants.VND_CURRENCY);

		log.info("TC_10_Step_06: Lay so du tai khoan chuyen");
		String beforeBalanceOfAccount1 = transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.SURPLUS);
		long beforeBalanceAmountOfAccount1 = convertMoneyToLong(beforeBalanceOfAccount1, Constants.VND_CURRENCY);

		log.info("TC_10_Step_07: Nhap tai khoan nhan");
		transferInVCB.inputToDynamicInputBox(driver, account_other_owner, TittleData.INPUT_ACCOUNT_BENEFICI);

		log.info("TC_10_Step_08: Nhap so tien chuyen");
		transferInVCB.inputToDynamicInputBox(driver, TransferMoneyInVCB_Data.InputDataInFutureForOTP.TRANSFER_AMOUNT, TittleData.AMOUNT);

		log.info("TC_10_Step_09: Nhap noi dung");
		transferInVCB.inputToDynamicInputBoxByHeader(driver, TransferMoneyInVCB_Data.InputDataInVCB.NOTE, TittleData.TRANSFER_INFO, "3");
		...
		log.info("TC_10_Step_10: Click tiep tuc");
		transferInVCB.clickToDynamicButton(driver, TittleData.CONTINUE_BTN);
		...
		log.info("TC_10_Step_13: Kiem tra tai khoan dich hien thi");
		...
		log.info("TC_10_Step_14: Kiem tra so tien chuyen hien thi");
		verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.AMOUNT), (addCommasToLong(TransferMoneyInVCB_Data.InputDataInFutureForOTP.TRANSFER_AMOUNT)) + " VND");

		log.info("TC_10_Step_15: Kiem tra nguoi thanh toan phi chuyen bang OTP");
		verifyTrue(transferInVCB.isDynamicMessageAndLabelTextDisplayed(driver, TransferMoneyInVCB_Data.InputDataInVCB.COST[1]));

		log.info("TC_10_Step_16: Kiem tra noi dung hien thi");
		verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.CONTENT), TransferMoneyInVCB_Data.InputDataInVCB.NOTE);

		log.info("TC_10_Step_17: Chon Phuong thuc nhap");
		transferInVCB.clickToDynamicDropDown(driver, TittleData.METHOD_VALIDATE);

		log.info("TC_10_Step_18: Chon SMS OTP");
		transferInVCB.clickToDynamicButtonLinkOrLinkText(driver, TransferMoneyInVCB_Data.InputDataInVCB.PAYMENT_OPTIONS[1]);

		log.info("TC_10_Step_20: Click Tiep tuc");
		transferInVCB.clickToDynamicButton(driver, TittleData.CONTINUE_BTN);

		log.info("TC_10_Step_21: Nhap OTP");
		transferInVCB.inputToDynamicOtp(driver, otp, TittleData.CONTINUE_BTN);

		log.info("TC_10_Step_22: Click tiep tuc");
		transferInVCB.clickToDynamicButton(driver, TittleData.CONTINUE_BTN);

		log.info("TC_10_Step_23: Kiem  tra giao dich thanh cong");
		verifyTrue(transferInVCB.isDynamicMessageAndLabelTextDisplayed(driver, TransferMoneyInVCB_Data.Output.SUCESSFULL_CREATED_ORDER));

		log.info("TC_10_Step_24: Lay thoi gian tao giao dich");
		transferTime = transferInVCB.getDynamicTransferTimeAndMoney(driver, TransferMoneyInVCB_Data.Output.SUCESSFULL_CREATED_ORDER, "4");
		verifyEquals(transferTime, TransferMoneyInVCB_Data.Output.ORDER_TIME + capitalizeString(transferInVCB.getDayInWeek(tommorrowDate)) + " " + tommorrowDate);

		log.info("TC_10_Step_25: Lay ma giao dich");
		transactionNumber = transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.CODE_TRANSFER);

		log.info("TC_10_Step_26: Kiem tra ten nguoi thu huong hien thi");
		verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.NAME_BENEFICI), name_other_owner);

		log.info("TC_10_Step_27: Kiem tra tai khoan dich hien thi");
		verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.ACCOUNT_BENEFICI), account_other_owner);

		log.info("TC_10_Step_28: Kiem tra noi dung hien thi");
		verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.CONTENT), TransferMoneyInVCB_Data.InputDataInVCB.NOTE);

		log.info("TC_10_Step_29: Click thuc hien giao dich moi");
		transferInVCB.clickToDynamicButton(driver, TittleData.NEW_TRANSFER);

		log.info("TC_10_Step_30: Click tai khoan nguon");
		transferInVCB.clickToDynamicDropDown(driver, TittleData.SOURCE_ACCOUNT);

		log.info("TC_10_Step_31: Chon tai ngoan chuyen");
		sourceAccount = transferInVCB.chooseSourceAccount(driver, Constants.AMOUNT_VND, Constants.VND_CURRENCY);

		log.info("TC_10_Step_32: Lay so du tai khoan chuyen");
		String afterBalanceOfAccount1 = transferInVCB.getDynamicTextInTransactionDetail(driver, TittleData.SURPLUS);
		long afterBalanceAmountOfAccount1 = convertMoneyToLong(afterBalanceOfAccount1, Constants.VND_CURRENCY);

		log.info("TC_10_Step_33: Kiem tra so du tai khoan chuyen sau khi thuc hien giao dich");
		verifyEquals(beforeBalanceAmountOfAccount1, afterBalanceAmountOfAccount1);
	...
	public void TC_11_KiemTraChiTietGiaoDich_ChuyenTienTuongLai_CoPhiGiaoDich_NguoiNhanTra_EUR_VaXacThucBang_OTP() {
		...
		log.info("TC_11_Step_02: Click vao Trang Thai lenh chuyen Tien");
		homePage.clickToDynamicIcon(driver, TittleData.STATUS_TRANSACTION);

		log.info("TC_11_Step_03: Click Tat Ca Cac Loai Giao Dich");
		transferStatus.clickToDynamicButtonLinkOrLinkText(driver, TransferMoneyInVCB_Data.InputDataInVCB.OPTION_TRANSFER[1]);

		log.info("TC_11_Step_04: Chon Chuyen Tien Trong VCB");
		transferStatus.clickToDynamicButtonLinkOrLinkText(driver, TransferMoneyInVCB_Data.InputDataInVCB.OPTION_TRANSFER[2]);
	...
	@Test
	public void TC_12_HuyLenh_GiaoDichTuongLai_XacThucBang_OTP() {

		log.info("TC_12_Step_01: Click Huy Lenh");
		transferStatus.clickToDynamicIconInOrderStatus(driver, "0", "com.VCB:id/tvHuyLenh");

		log.info("TC_12_Step_02: Click Dong Y");
		transferStatus.clickToDynamicButton(driver, TittleData.ACCEPT);

		log.info("TC_12_Step_04: Kiem Tra Success hiển thị");
		verifyEquals(transferStatus.getDynamicTextDetailByIDOrPopup(driver, "com.VCB:id/tvContent"), TittleData.SUCCESS);

		log.info("TC_12_Step_05: Click quay lai");
		transferStatus.clickToDynamicButton(driver, TittleData.CLOSE);
	...
	@Parameters({ "otp" })
	@Test
	public void TC_13_ChuyenTienTuongLai_CoPhiGiaoDich_NguoiChuyenTra_VND_VaXacThucBang_OTP_LuuDanhBa(String otp) {
		...
		transferInVCB.clickToDynamicDropDown(driver, TittleData.SOURCE_ACCOUNT);
		List<String> listAccount = transferInVCB.getListSourceAccount(driver, Constants.VND_CURRENCY);
		log.info("TC_13_Step_05: Chon tai khoan dich");
		sourceAccount = transferInVCB.chooseSourceAccount(driver, Constants.AMOUNT_VND, Constants.VND_CURRENCY);
		...
		log.info("TC_13_Step_07:Click tai khoan nguon");
		transferInVCB.clickToDynamicDropDown(driver, TittleData.SOURCE_ACCOUNT);

		log.info("TC_13_Step_08: Chon tai khoan chuyen");
		transferInVCB.clickToDynamicButtonLinkOrLinkText(driver, sourceAccount.account);

		log.info("TC_13_Step_10: Nhap tai khoan nhan");
		distanceAccount.account = transferInVCB.getDistanceAccount(driver, sourceAccount.account, listAccount);
		transferInVCB.inputToDynamicInputBox(driver, distanceAccount.account, TittleData.INPUT_ACCOUNT_BENEFICI);

		log.info("TC_13_Step_12: Nhap so tien chuyen");
		...
		log.info("TC_13_Step_13: Nhap noi dung");
		transferInVCB.inputToDynamicInputBoxByHeader(driver, TransferMoneyInVCB_Data.InputDataInVCB.NOTE, TittleData.TRANSFER_INFO, "3");

		log.info("TC_13_Step_14: Click tiep tuc");
		transferInVCB.clickToDynamicButton(driver, TittleData.CONTINUE_BTN);

		log.info("TC_13_Step_22: Chon Phuong thuc nhap");
		transferInVCB.clickToDynamicDropDown(driver, TittleData.METHOD_VALIDATE);

		log.info("TC_13_Step_23: Chon OTP");
		transferInVCB.clickToDynamicButtonLinkOrLinkText(driver, TransferMoneyInVCB_Data.InputDataInVCB.PAYMENT_OPTIONS[1]);

		log.info("TC_13_Step_25: Click Tiep tuc");
		transferInVCB.clickToDynamicButton(driver, TittleData.CONTINUE_BTN);

		log.info("TC_13_Step_26: Nhap OTP");
		transferInVCB.inputToDynamicOtp(driver, otp, TittleData.CONTINUE_BTN);

		log.info("TC_13_Step_27: Click tiep tuc");
		transferInVCB.clickToDynamicButton(driver, TittleData.CONTINUE_BTN);

		if (transferInVCB.getPageSource(driver).contains(InputText_MoneyRecurrent.SAVE_RECEIVED_ACCOUNT_TEXT)) {
			
			log.info("TC_13_Step_27: Click luu danh ba");
			transferInVCB.clickToTextID(driver, "com.VCB:id/tvSaveContact");

			log.info("TC_13_Step_27: Get thong tin tai khoan da luu");
			distanceAccount.account = transferInVCB.getTextInDynamicDropdownOrDateTimePicker(driver, "com.VCB:id/tvContent");
			
			log.info("TC_13_Step_27: Click btn hoan thanh");
			transferInVCB.clickToTextID(driver, "com.VCB:id/tvSaveContact");
		}
	...
	@Parameters({ "otp" })
	@Test
	public void TC_14_ChuyenTienTuongLai_CoPhiGiaoDich_NguoiChuyenTra_VND_VaXacThucBang_OTP_BangTKDaLuu(String otp) {

		log.info("TC_14_Step_01: Click Chuyen tien trong VCB");
		homePage.clickToDynamicIcon(driver, Home_Text_Elements.HOME_TRANSFER_IN_VCB);
		
		log.info("TC_14_Step_02: Chon chuyen tien ngay gia tri hien tai");
		transferInVCB.clickToDynamicButtonLinkOrLinkText(driver, TransferMoneyInVCB_Data.InputDataInVCB.OPTION_TRANSFER[0]);

		log.info("TC_14_Step_03: Chon chuyen tien ngay gia tri hien tai");
		transferInVCB.clickToDynamicButtonLinkOrLinkText(driver, TransferMoneyInVCB_Data.InputDataInVCB.OPTION_TRANSFER[2]);

		log.info("TC_14_Step_04:Click tai khoan nguon");
		transferInVCB.clickToDynamicDropDown(driver, TittleData.SOURCE_ACCOUNT);

		log.info("TC_14_Step_05: Chon tai khoan dich");
		sourceAccount = transferInVCB.chooseSourceAccount(driver, Constants.AMOUNT_VND, Constants.VND_CURRENCY);

		log.info("TC_14_Step_07:Click tai khoan nguon");
		transferInVCB.clickToDynamicDropDown(driver, TittleData.SOURCE_ACCOUNT);

		log.info("TC_14_Step_08: Chon tai khoan chuyen");
		transferInVCB.clickToDynamicButtonLinkOrLinkText(driver, sourceAccount.account);

		log.info("TC_14_Step_10: Nhap tai khoan nhan");
		transferInVCB.clickToDynamicIconContact(driver, TittleData.INPUT_ACCOUNT_BENEFICI);

		log.info("TC_14_Step_10: Nhap tai khoan nhan da luu");
		transferInVCB.clickToDynamicButtonLinkOrLinkText(driver, distanceAccount.account);

		log.info("TC_14_Step_12: Nhap so tien chuyen");
		transferInVCB.inputToDynamicInputBox(driver, TransferMoneyInVCB_Data.InputDataInFutureForPassword.TRANSFER_AMOUNT, TittleData.AMOUNT);

		log.info("TC_14_Step_13: Nhap noi dung");
		transferInVCB.inputToDynamicInputBoxByHeader(driver, TransferMoneyInVCB_Data.InputDataInVCB.NOTE, TittleData.TRANSFER_INFO, "3");

		log.info("TC_14_Step_14: Click tiep tuc");
		transferInVCB.clickToDynamicButton(driver, TittleData.CONTINUE_BTN);

		log.info("TC_14_Step_22: Chon Phuong thuc nhap");
		transferInVCB.clickToDynamicDropDown(driver, TittleData.METHOD_VALIDATE);

		log.info("TC_14_Step_23: Chon OTP");
		transferInVCB.clickToDynamicButtonLinkOrLinkText(driver, TransferMoneyInVCB_Data.InputDataInVCB.PAYMENT_OPTIONS[1]);

		log.info("TC_14_Step_25: Click Tiep tuc");
		transferInVCB.clickToDynamicButton(driver, TittleData.CONTINUE_BTN);

		log.info("TC_14_Step_26: Nhap OTP");
		transferInVCB.inputToDynamicOtp(driver, otp, TittleData.CONTINUE_BTN);
