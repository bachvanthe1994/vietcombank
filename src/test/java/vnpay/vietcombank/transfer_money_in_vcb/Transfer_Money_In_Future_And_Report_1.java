...
public class Transfer_Money_In_Future_And_Report_1 extends Base {
	...
	public void TC_01_ChuyenTienTuongLaiCoPhiGiaoDichNguoiChuyenTraVNDVaXacThucBangOTP() {
		...
		verifyEquals(transferInVCB.getDynamicTextInFilmTicketInfoDetail(driver, "Hình thức chuyển tiền"), TransferMoneyInVCB_Data.InputDataInVCB.OPTION_TRANSFER[2]);
		...
		verifyEquals(transferInVCB.getDynamicTextInFilmTicketInfoDetail(driver, "Số tiền"), addCommasToLong(TransferMoneyInVCB_Data.InputDataInFutureForOTP.TRANSFER_AMOUNT) + " VND");

		log.info("TC_01_Step_19: Kiem tra Ngay hieu luc hien thi");
		verifyEquals(transferInVCB.getDynamicTextInFilmTicketInfoDetail(driver, "Ngày hiệu lực"), tommorrowDate);
		...
		verifyEquals(transferInVCB.getDynamicTextInFilmTicketInfoDetail(driver, "Số tiền phí"), (TransferMoneyInVCB_Data.InputDataInFutureForOTP.OTP_FEE + " VND"));
	...
	public void TC_02_KiemTraTrạngThaiLenhChuyenTienCuaGiaoDichTuongLaiCoPhiGiaoDichNguoiChuyenTraVNDVaXacThucOTP() {
		...
		verifyTrue(transStatus.getDynamicTextInFilmTicketInfoDetail(driver, "Ngày lập lệnh").contains(transferTime.split(" ")[0]));

		log.info("TC_02_Step 16: Kiem tra thoi gian tao giao dich hien thi");
		verifyTrue(transStatus.getDynamicTextInFilmTicketInfoDetail(driver, "Ngày lập lệnh").split(" ")[0].equals(transferTime.split(" ")[3]));

		log.info("TC_02_Step 17: Kiem tra ten nguoi huong hien thi");
		verifyEquals(transStatus.getDynamicTextInFilmTicketInfoDetail(driver, "Người hưởng"), TransferMoneyInVCB_Data.InputDataInVCB.RECEIVER_NAME_ACCOUNT_2);

		log.info("TC_02_Step 18: Kiem tra so tien thi");
		verifyEquals(transStatus.getDynamicTextInFilmTicketInfoDetail(driver, "Số tiền"), addCommasToLong(TransferMoneyInVCB_Data.InputDataInFutureForOTP.TRANSFER_AMOUNT) + " VND");

		log.info("TC_02_Step 19: Kiem tra ngay hieu luc");
		verifyEquals(transStatus.getDynamicTextInFilmTicketInfoDetail(driver, "Ngày hiệu lực"), tommorrowDate);

		log.info("TC_02_Step 20: Kiem tra ghi chú");
		verifyEquals(transStatus.getDynamicTextInFilmTicketInfoDetail(driver, "Ghi chú"), "");

		log.info("TC_02_Step 21: Kiem tra trang thai hieu luc");
		verifyEquals(transStatus.getDynamicTextInFilmTicketInfoDetail(driver, "Trạng thái"), TransferMoneyStatus_Data.Output.WAITING_STATUS);
...
//	@Test
	public void TC_03_HuyLenhGiaoDichTuongLaiXacThucOTP() {
		...
		verifyEquals(transStatus.getDynamicTextInFilmTicketInfoDetail(driver, "Trạng thái"), TransferMoneyStatus_Data.Output.CANCEL_STATUS);
...
//	@Test
	...
	public void TC_07_ChuyenTienTuongLaiCoPhiGiaoDichNguoiChuyenTraUSDVaXacThucBangOTP() {
		...
		verifyEquals(transferInVCB.getDynamicTextInFilmTicketInfoDetail(driver, "Số tiền"), (TransferMoneyInVCB_Data.InputDataInFutureForOTP.AMOUNT_OF_EUR_OR_USD_TRANSFER) + " USD");
		...
		verifyEquals(transferInVCB.getDynamicTextInFilmTicketInfoDetail(driver, "Số tiền phí"), (TransferMoneyInVCB_Data.InputDataInFutureForOTP.USD_SMS_OTP_FEE + " USD"));
	...
	public void TC_08_KiemTraChiTietGiaoDichChuyenTienTuongLaiCoPhiGiaoDichNguoiChuyenTraUSDVaXacThucBangOTP() {
		...
		verifyEquals(transStatus.getDynamicTextInFilmTicketInfoDetail(driver, "Số tiền"), TransferMoneyInVCB_Data.InputDataInFutureForOTP.AMOUNT_OF_EUR_OR_USD_TRANSFER + " USD");
	...
	public void TC_10_ChuyenTienTuongLaiCoPhiGiaoDichNguoiNhanTraEURVaXacThucBangOTP() {
		...
		verifyEquals(transferInVCB.getDynamicTextInFilmTicketInfoDetail(driver, "Số tiền"), (TransferMoneyInVCB_Data.InputDataInFutureForOTP.AMOUNT_OF_EUR_OR_USD_TRANSFER) + " EUR");
		...
		verifyEquals(transferInVCB.getDynamicTextInFilmTicketInfoDetail(driver, "Số tiền phí"), (TransferMoneyInVCB_Data.InputDataInFutureForOTP.EUR_SMS_OTP_FEE + " EUR"));
	...
	public void TC_11_KiemTraChiTietGiaoDichChuyenTienTuongLaiCoPhiGiaoDichNguoiNhanTraEURVaXacThucBangOTP() {
		...
		verifyEquals(transStatus.getDynamicTextInFilmTicketInfoDetail(driver, "Số tiền"), TransferMoneyInVCB_Data.InputDataInFutureForOTP.AMOUNT_OF_EUR_OR_USD_TRANSFER + " EUR");
	...
	public void TC_13_ChuyenTienTuongLaiDenTaiKhoanKhacChuSoHuuCoPhiGiaoDichNguoiChuyenTraVNDVaXacThucBangOTP() {
		...
		verifyEquals(transferInVCB.getDynamicTextInFilmTicketInfoDetail(driver, "Số tiền phí"), TransferMoneyInVCB_Data.InputDataInVCB.TRANSFER_OTP_FEE_TO_OTHER_ACCOUNT_OWNER + " VND");
	...
	public void TC_14_KiemTraChiTietGiaoDichChuyenTienTuongLaiCoPhiGiaoDichNguoiChuyenTraEURVaXacThucBangOTP() {
		...
		verifyEquals(transStatus.getDynamicTextInFilmTicketInfoDetail(driver, "Người hưởng"), TransferMoneyInVCB_Data.InputDataInVCB.DIFFERENT_OWNER_NAME);
