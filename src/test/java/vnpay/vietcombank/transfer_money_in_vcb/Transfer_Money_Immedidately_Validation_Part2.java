...
public class Transfer_Money_Immedidately_Validation_Part2 extends Base {
	...
	public void TC_06_KiemTraBoTrongTaiKhoanDichVaDongPopup() {
		...
		log.info("TC_06_Step_06: Click Đong");
		transferInVCB.clickToDynamicButton(driver, "Đóng");

		log.info("TC_06_Step_07: Click Quay Lai");
		transferInVCB.clickToDynamicBackIcon(driver, "Chuyển tiền trong Vietcombank");
	}

	@Test
	public void TC_05_KiemTraBoTrongSoTienVaDongPopup() {

		log.info("TC_05_Step_01: Click Chuyen tien trong VCB");
		homePage.clickToDynamicIcon(driver, "Chuyển tiền trong VCB");

		log.info("TC_05_Step_02: Nhap so tien chuyen");
		transferInVCB = PageFactoryManager.getTransferMoneyInVcbPageObject(driver);
		transferInVCB.inputToDynamicInputBox(driver, Account_Data.Valid_Account.ACCOUNT1, "Nhập/chọn tài khoản nhận VND");

		log.info("TC_05_Step_03: Nhap noi dung");
		transferInVCB.inputToDynamicInputBox(driver, TransferMoneyInVCB_Data.InputDataInVCB.NOTE, "Nội dung");

		log.info("TC_05_Step_04: Click tiep tuc");
		transferInVCB.clickToDynamicButton(driver, "Tiếp tục");

		log.info("TC_05_Step_05: Kiem tra yeu cau nhap so tien");
		verifyTrue(transferInVCB.isDynamicMessageAndLabelTextDisplayed(driver, TransferMoneyInVCB_Data.Output.EMPTY_MONEY_MESSAGE));

		log.info("TC_05_Step_06: Click Đong");
		transferInVCB.clickToDynamicButton(driver, "Đóng");

		log.info("TC_05_Step_07: Click Quay Lai");
		transferInVCB.clickToDynamicBackIcon(driver, "Chuyển tiền trong Vietcombank");
	}

	@Test
	public void TC_06_KiemTraBoTrongNoiDungVaDongPopup() {
		...
		log.info("TC_06_Step_03: Nhap So Tien Chuyen");
		transferInVCB.inputToDynamicInputBox(driver, TransferMoneyInVCB_Data.InputDataInVCB.VND_MONEY, "Số tiền");

		log.info("TC_06_Step_04: Click tiep tuc");
		transferInVCB.clickToDynamicButton(driver, "Tiếp tục");

		log.info("TC_06_Step_05: Kiem tra yeu cau nhap noi dung");
	...
	@Test
	public void TC_07_KiemTraTaiKhoanNguonVaTaiKhoanDichTrungNhauVaDongPopup() {
		...
		log.info("TC_07_Step_04: Nhap Tai Khoan Nhan");
		...
		log.info("TC_07_Step_05: Nhap noi dung");
		transferInVCB.inputToDynamicInputBox(driver, TransferMoneyInVCB_Data.InputDataInVCB.NOTE, "Nội dung");
		...
		log.info("TC_07_Step_08: Kiem tra yeu cau nhap noi dung");
		...
		log.info("TC_07_Step_09: Click Đong");
		transferInVCB.clickToDynamicButton(driver, "Đóng");

		log.info("TC_07_Step_10: Click Quay Lai");
		transferInVCB.clickToDynamicBackIcon(driver, "Chuyển tiền trong Vietcombank");
	}

	@Test
	public void TC_08_KiemTraTaiKhoanNguonVaTaiKhoanDichDongChuTaiKhoanVaDongPopup() {
		...
		log.info("TC_08_Step_03: Chon tai khoan dich");
		transferInVCB.clickToDynamicButtonLinkOrLinkText(driver, Account_Data.Invalid_Account.SAME_OWNER_ACCOUNT_1);
		...
		log.info("TC_08_Step_05: Nhap noi dung");
		transferInVCB.inputToDynamicInputBox(driver, TransferMoneyInVCB_Data.InputDataInVCB.NOTE, "Nội dung");
		...
		log.info("TC_08_Step_08: Kiem tra yeu cau nhap noi dung");
		...
		log.info("TC_08_Step_09: Click Đong");
		transferInVCB.clickToDynamicButton(driver, "Đóng");

		log.info("TC_08_Step_10: Click Quay Lai");
		transferInVCB.clickToDynamicBackIcon(driver, "Chuyển tiền trong Vietcombank");
	}

	@Test
	public void TC_09_KiemTraTaiKhoanNhanKhongTonTaiTrenHeThongVaDongPopup() {
		...
		log.info("TC_09_Step_05: Nhap noi dung");
		transferInVCB.inputToDynamicInputBox(driver, TransferMoneyInVCB_Data.InputDataInVCB.NOTE, "Nội dung");
		...
		log.info("TC_09_Step_08: Kiem tra yeu cau nhap noi dung");
		...
		log.info("TC_09_Step_09: Click Đong");
		transferInVCB.clickToDynamicButton(driver, "Đóng");
	...
	@Test
	public void TC_10_KiemTraChuyenKhoanTuTaiKhoanVNDSangUSDVaDongPopup() {
	...
	@Test
	public void TC_11_KiemTraChuyenKhoanTuTaiKhoanVNDSangEURVaDongPopup() {
	...
	@Test
	public void TC_12_KiemTraChuyenKhoanTuTaiKhoanUSDSangEURVaDongPopup() {
	...
	@Test
	public void TC_13_KiemTraChuyenKhoanTuTaiKhoanEURSangUSDVaDongPopup() {
