...
import vietcombank_test_data.TransferMoneyInVCB_Data.Output;
...
public class Transfer_Money_In_Immedidately_Limit_1 extends Base {
	...
	ServiceLimitInfo inputInfo = new ServiceLimitInfo("1000", "10000", "1000000", "1000001");
	...
	public void beforeClass(String deviceType, String deviceName, String udid, String url, String appActivities, String appPackage, String appName, String phone, String pass, String opt, String username, String passWeb) throws IOException, InterruptedException {
		...
		loginWeb.setupAssignServicesLimit(driverWeb, TittleData.TRANSFER_IN_BANK_SAME_OWNER, inputInfo, Constants.BE_CODE_PACKAGE);
...
// Hạn mức nội bộ cùng chủ tài khoản
	...
	public void TC_01_ChuyenTienTuongLaiThapHonHanMucToiThieu() throws InterruptedException {
		...
		verifyEquals(transferInVCB.getDynamicTextView(driver, "com.VCB:id/tvContent"), Output.CONFIRM_MIN_TRANSFER_TOP + addCommasToLong(inputInfo.minTran) + Output.TRANSFER_LAST);
	...
	public void TC_02_ChuyenTienTuongLaiCaoHonHanMucToiDa() throws InterruptedException {
		...
		verifyEquals(transferInVCB.getDynamicTextView(driver, "com.VCB:id/tvContent"), Output.MAX_TRANSFER_TOP + addCommasToLong(inputInfo.maxTran) + Output.TRANSFER_LAST);
	...
	@Parameters({ "otp", "pass" })
	@Test
	public void TC_03_ChuyenTienTuongLaiVuotQuaHanMucTrongNgay(String otp, String pass) throws InterruptedException {

		loginWeb.setupAssignServicesLimit_Total_Day(driverWeb, TittleData.TRANSFER_IN_BANK_SAME_OWNER, inputInfo, Constants.BE_CODE_PACKAGE);
		...
		verifyEquals(transferInVCB.getDynamicTextView(driver, "com.VCB:id/tvContent"), Output.MAX_TRANSFER_TOP + addCommasToLong(inputInfo.totalLimit) + Output.DAY_MAX_TRANSFER_LAST);

		transferInVCB.clickToDynamicContinue(driver, "com.VCB:id/btOK");
		transferInVCB.clickToDynamicBackIcon(driver, TittleData.TRANSFER_IN_VCBANK);

		loginWeb.resetAssignServicesLimit(driverWeb, TittleData.TRANSFER_IN_BANK_SAME_OWNER, Constants.BE_CODE_PACKAGE);
	...
	public void TC_04_ChuyenTienTuongLaiVuotQuaNhomDichVu() throws InterruptedException {
		...
		loginWeb.Setup_Assign_Services_Type_Limit(driverWeb, Constants.BE_CODE_PACKAGE, TittleData.TRANSFER_SAME_OWNER, inputInfo.totalLimit);
		...
		loginWeb.Reset_Setup_Assign_Services_Type_Limit(driverWeb, Constants.BE_CODE_PACKAGE, TittleData.TRANSFER_SAME_OWNER);

	}

	@Test
	public void TC_05_ChuyenTienTuongLaiVuotQuaGoiDichVu() throws InterruptedException {
		loginWeb.Setup_Add_Method_Package_Total_Limit(driverWeb, Constants.BE_CODE_PACKAGE, TittleData.TITTLE_METHOD, inputInfo.totalLimit);
		...
		loginWeb.Reset_Package_Total_Limit(driverWeb, Constants.BE_CODE_PACKAGE, TittleData.TITTLE_METHOD);
