...
public class Validation_QuickMoneyTransferViaAccount extends Base {
	...
	public void TC_00_TaoDanhBaThuHuong() throws InterruptedException {
		...
		setupContact.deleteContact();

		log.info("TC_00_Step_: Add contact 1");
		setupContact.addContact(SetupContact_Data.UI.NAME_CARD1, SetupContact_Data.UI.ACCOUNT1);

		log.info("TC_00_Step_: Add contact 2");
		setupContact.addContact(SetupContact_Data.UI.NAME_CARD2, SetupContact_Data.UI.ACCOUNT2);
	...
	public void TC_01_ValidationChuyenNhanhQuaTaiKhoan() throws InterruptedException {
		...
		transferMoney.clickToDynamicButtonLinkOrLinkText(driver,
				ValidationTransferMoneyQuick_Data.TransferQuick.OPTION_TRANSFER[0]);

		log.info("TC_01_Step_Check value trong hinh thuc chuyen tien");
		transferMoney.isDynamicMessageAndLabelTextDisplayed(driver,
				ValidationTransferMoneyQuick_Data.TransferQuick.OPTION_TRANSFER[0]);
		transferMoney.isDynamicMessageAndLabelTextDisplayed(driver,
				ValidationTransferMoneyQuick_Data.TransferQuick.OPTION_TRANSFER[1]);
		...
		transferMoney.isDynamicMessageAndLabelTextDisplayed(driver,
				ValidationTransferMoneyQuick_Data.TransferQuick.INFO_FORM_LABEL);
	}
	...
	public void TC_02_ValidationTaiKhoanNguon() throws InterruptedException {
		...
		verifyTrue(transferMoney.isDynamicMessageAndLabelTextDisplayed(driver,
				ValidationTransferMoneyQuick_Data.TransferQuick.ACCOUNT_FORM_LIST[0]));
		...
		transferMoney.clickToDynamicButtonLinkOrLinkText(driver,
				ValidationTransferMoneyQuick_Data.TransferQuick.ACCOUNT_FORM_LIST[1]);
	...
	public void TC_03_ValidationThongTinNguoiHuong() throws InterruptedException {
		...
		transferMoney.isDynamicMessageAndLabelTextDisplayed(driver,
				ValidationTransferMoneyQuick_Data.TransferQuick.INFO_TO_LABEL);
		...
		transferMoney.isDynamicMessageAndLabelTextDisplayed(driver,
				ValidationTransferMoneyQuick_Data.MessageTransferMoney.ACCOUNT_BLANK);
		...
		transferMoney.inputToDynamicInputBox(driver,
				ValidationTransferMoneyQuick_Data.TransferQuick.INVALID_ACC_ACCEPT_OVER_MAX,
				"Nhập/chọn tài khoản nhận VND");

		log.info("TC_03_Step_Invalid nhap so tai khoan nguoi nhan co ky tu tieng viet co dau");
		transferMoney.inputToDynamicInputBox(driver,
				ValidationTransferMoneyQuick_Data.TransferQuick.INVALID_ACC_VIETNAM_KEY,
				"Nhập/chọn tài khoản nhận VND");
		...
		log.info("TC_03_Step_verify message khi tai khoan nguoi nhan khong ton tai ");
		transferMoney.isDynamicMessageAndLabelTextDisplayed(driver,
				ValidationTransferMoneyQuick_Data.MessageTransferMoney.ACCOUNT_NOT_EXIST);
		...
		transferMoney.inputToDynamicInputBox(driver, ValidationTransferMoneyQuick_Data.TransferQuick.NAME_INVALID,
				"Tìm kiếm");

		log.info("verify so tai khoan trong contact");
		transferMoney.isDynamicMessageAndLabelTextUndisplayed(driver,
				ValidationTransferMoneyQuick_Data.TransferQuick.NAME_INVALID);
 ...
 @Test
	public void TC_04_ValidationNganHang() throws InterruptedException {
		...
		transferMoney.inputToDynamicInputBox(driver, ValidationTransferMoneyQuick_Data.TransferQuick.ACCOUNT_TO,
				"Nhập/chọn tài khoản nhận VND");
		...
		transferMoney.clickToDynamicButtonLinkOrLinkText(driver,
				ValidationTransferMoneyQuick_Data.TransferQuick.COST[0]);
		transferMoney.clickToDynamicButtonLinkOrLinkText(driver,
				ValidationTransferMoneyQuick_Data.TransferQuick.COST_SUB[0]);
		...
		transferMoney.isDynamicMessageAndLabelTextDisplayed(driver,
				ValidationTransferMoneyQuick_Data.MessageTransferMoney.BANK_BLANK);
