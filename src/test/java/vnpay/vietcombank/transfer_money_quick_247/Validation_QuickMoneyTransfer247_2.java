...
public class Validation_QuickMoneyTransfer247_2 extends Base {
	...
	/*
	 * @Test public void TC_19_VerifyDefaultDanhBaThuHuong() {
	 ...
	 * transferMoney.clickToDynamicBottomMenuOrIcon(driver,
	 * "com.VCB:id/ivContent1");
	 * 
	 * log.info("TC_19_verify tieu de danh ba nguoi huong");
	 * verifyTrue(transferMoney.isDynamicMessageAndLabelTextDisplayed(driver,
	 * "Danh bạ người hưởng"));
	 * 
	 ...
	 * verifyTrue(transferMoney.isDynamicTextInInputBoxDisPlayed(driver,
	 * "Tìm kiếm"));
	 * 
	 * log.info("TC_19_Lay danh sach gia tri danh ba nguoi huong"); listActual =
	 * transferMoney.getListOfSuggestedMoneyOrListText(driver, "com.VCB:id/tvName");
	 * 
	 * log.info("TC_19_danh sach gia tri bank actual"); listExpect =
	 * Arrays.asList(SetupContact_Data.UI.NAME_CARD);
	 * 
	 * log.info("TC_19_Verify gia tri tim kiem");
	 * verifyTrue(transferMoney.checkListContain(listActual, listExpect)); }
	 * 
	 * @Test public void TC_20_TimKiemDanhBaTenThuHuong() {
	 * log.info("TC_20_Tim kiem theo so tai khoan thu huong");
	 * transferMoney.inputToDynamicInputBoxSearch(driver,
	 * SetupContact_Data.UI.NAME_CARD[0], "Danh bạ người hưởng");
	 * 
	 * log.info("TC_20_Lay danh sach gia tri danh ba nguoi huong"); listActual =
	 * transferMoney.getListOfSuggestedMoneyOrListText(driver, "com.VCB:id/tvName");
	 * 
	 * log.info("TC_20_danh sach gia tri bank actual"); listExpect =
	 * Arrays.asList(SetupContact_Data.UI.NAME_CARD[0]);
	 * 
	 * log.info("TC_20_Verify gia tri tim kiem"); verifyEquals(listActual,
	 * listExpect); }
	 * 
	 * @Test public void TC_21_TimKiemDanhBaSoTaiKhoanThuHuong() {
	 * log.info("TC_21_Tim kiem theo so tai khoan thu huong");
	 * transferMoney.inputToDynamicInputBoxSearch(driver,
	 * SetupContact_Data.UI.ACCOUNT[0], "Danh bạ người hưởng");
	 * 
	 * log.info("TC_21_Lay danh sach gia tri danh ba nguoi huong"); listActual =
	 * transferMoney.getListOfSuggestedMoneyOrListText(driver, "com.VCB:id/tvNo");
	 * 
	 * log.info("TC_21_danh sach gia tri bank actual"); listExpect =
	 * Arrays.asList(SetupContact_Data.UI.ACCOUNT[0]);
	 * 
	 * log.info("TC_21_Verify gia tri tim kiem"); verifyEquals(listActual,
	 * listExpect); }
	 * 
	 * @Test public void TC_22_TimKiemDanhBaThuHuongKhongTonTai() {
	 * log.info("TC_22_Tim kiem theo ten nguoi thu huong khong ton tai");
	 * transferMoney.inputToDynamicInputBoxSearch(driver,
	 * SetupContact_Data.UI.NAME_INVALID, "Danh bạ người hưởng");
	 * 
	 * log.info("TC_22_verify so tai khoan trong contact");
	 * verifyTrue(transferMoney.isDynamicMessageAndLabelTextUndisplayed(driver,
	 * TransferMoneyQuick_Data.TransferQuick.NAME_INVALID));
	 * 
	 * }
	 * 
	 * @Test public void TC_23_TimKiemChinhXacMotDanhBaThuHuong() {
	 ...
	 * transferMoney.clickToDynamicButtonLinkOrLinkText(driver,
	 * SetupContact_Data.UI.NAME_CARD[0]);
	 * 
	 ...
	 * verifyTrue(transferMoney.isDynamicMessageAndLabelTextDisplayed(driver,
	 * Account_Data.Valid_Account.BANK[0])); }
	 */
	...
	public void TC_25_ValidationManHinhTimKiemNganHang() {
		...
		verifyTrue(transferMoney.isDynamicMessageAndLabelTextDisplayed(driver, "Ngân hàng thụ hưởng"));
	...
	public void TC_26_ValidationTimKiemNganHang() {
		...
		transferMoney.inputToDynamicInputBoxSearchBank(driver, Account_Data.Valid_Account.BANK[2], "Ngân hàng thụ hưởng");
	...
	public void TC_27_NganHangHuongKhongTonTai() {
		...
		transferMoney.inputToDynamicInputBoxSearchBank(driver, TransferMoneyQuick_Data.TransferQuick.BANK_INVALID, "Ngân hàng thụ hưởng");
	...
	public void TC_28_ChonMotNganHangThuHuong() {
		...
		transferMoney.inputToDynamicInputBoxSearchBank(driver, Account_Data.Valid_Account.BANK[1], "Ngân hàng thụ hưởng");
	...
	public void TC_29_ChonMotNganHangThuHuongKhac() {
		...
		transferMoney.inputToDynamicInputBoxSearchBank(driver, Account_Data.Valid_Account.BANK[0], "Ngân hàng thụ hưởng");
