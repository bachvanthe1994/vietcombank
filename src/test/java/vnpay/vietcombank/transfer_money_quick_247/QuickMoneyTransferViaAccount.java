...
public class QuickMoneyTransferViaAccount extends Base {
	...
	public void TC_01_ChuyenTienCoPhiGiaoDichChonNguoiChuyenOTP() throws InterruptedException {
		...
		transferTime = transferMoney.getDynamicTransferTimeAndMoney(driver,
				TransferMoney_Data.TransferQuick.MESSAGE_SUCCESS, "4");
		...
		verifyEquals(transferMoney.getDynamicTextInTextViewLine2(driver, "Nội dung"),
				TransferMoney_Data.TransferQuick.NOTE);
	...
	public void TC_04_BaoCaoGiaoDichChuyenTienNhanh() {
		...
		log.info("TC_Step_: Check so tien chuyen");
		verifyEquals(transReport.getTextInDynamicTransactionInReport(driver, "1", "com.VCB:id/tvMoney"),
				("- " + addCommasToLong(TransferMoney_Data.TransferQuick.MONEY) + ".00 USD"));
		...
		log.info("TC_Step_: Check so tien giao dich");
		verifyTrue(transReport.getDynamicTextInTextViewLine2(driver, "Số tiền giao dịch")
				.contains(addCommasToLong(TransferMoney_Data.TransferQuick.MONEY) + ".00 USD"));
	...
	public void TC_08_BaoCaoGiaoDichChuyenTienNhanh() {
		...
		log.info("TC_Step_: Check so tien chuyen");
		verifyEquals(transReport.getTextInDynamicTransactionInReport(driver, "1", "com.VCB:id/tvMoney"),
				("- " + addCommasToLong(TransferMoney_Data.TransferQuick.MONEY) + ".00 EUR"));
		...
		log.info("TC_Step_: Check so tien giao dich");
		verifyTrue(transReport.getDynamicTextInTextViewLine2(driver, "Số tiền giao dịch")
				.contains(addCommasToLong(TransferMoney_Data.TransferQuick.MONEY) + ".00 EUR"));
