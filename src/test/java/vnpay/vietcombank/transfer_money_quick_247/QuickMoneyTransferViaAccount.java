...
public class QuickMoneyTransferViaAccount extends Base {
	...
	public void TC_01_ChuyenTienCoPhiGiaoDichChonNguoiChuyenOTP() throws InterruptedException {
		...
		verifyEquals(transferMoney.getDynamicTextInTextViewLine2(driver, "Tên người thụ hưởng"),TransferMoney_Data.TransferQuick.RECEIVER_NAME);

		log.info("TC_01_Step_: Tai khoan dich");
		verifyEquals(transferMoney.getDynamicTextInTextViewLine2(driver, "Tài khoản đích"),TransferMoney_Data.TransferQuick.ACCOUNT_TO);

		log.info("TC_01_Step_: Noi dung");
		verifyEquals(transferMoney.getDynamicTextInTextViewLine2(driver, "Nội dung"), TransferMoney_Data.TransferQuick.NOTE);
	...
	public void TC_03_BaoCaoGiaoDichChuyenTienNhanh() {
		...
		/*
		 * log.info("TC_Step_:");
		 * verifyTrue(transReport.getDynamicTextInTextViewLine2(driver,
	...
	@Test
	public void TC_10_ChuyenTienQuaTaiKhoanNguoiChuyenTraPhiEURXacThucMatKhau() {
		log.info("TC_01_Step_Click Chuyen tien nhanh");
	...
	@Test
	public void TC_12_BaoCaoGiaoDichChuyenTienNhanh() {
		log.info("TC_Step_:");
		homePage = PageFactoryManager.getHomePageObject(driver);
		homePage.clickToDynamicBottomMenu(driver, "com.VCB:id/menu_5");
