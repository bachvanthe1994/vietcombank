...
public class Limit_PayQRCode_Part_2 extends Base {
	...
	@Parameters({ "deviceType", "deviceName", "deviceUDID", "hubURL", "appActivities", "appPackage", "appName", "phone", "pass", "otp", "username", "passWeb" })
	@Test
	public void TC_01_ThanhToanHoaDon_Type2_QRCode_NhoHon_HanMucToiThieu_TrenMotGiaoDich(String deviceType, String deviceName, String udid, String url, String appActivities, String appPackage, String appName, String phone, String pass, String otp, String username, String passWeb) throws MalformedURLException {
		...
		payQRCode.chooseQRCodeType2(numberOfImage);

		log.info("TC_01_6_Lay so tien");
		...
		log.info("Setup assign services limit");
		money = convertAvailableBalanceCurrentcyOrFeeToLong(PayQRCode_Data.MONEY_PAYMENT);
		setupBE.Setup_Assign_Services_Limit(driverWeb, Constants.BE_CODE_PACKAGE, PayQRCode_Data.PAY_QR_PAY_PRODUCT, money + 1 + "", "100000000", "1000000000");
		...
		log.info("TC_01_5_Chon anh va chon tai khoan, nhap dia chi");
		payQRCode.clickToImageByIndex(QRCodePageObject.numberImage);
	...
	@Parameters({ "deviceType", "deviceName", "deviceUDID", "hubURL", "appActivities", "appPackage", "appName", "phone", "pass", "otp", "username", "passWeb" })
	@Test
	public void TC_02_ThanhToanHoaDon_Type2_QRCode_LonHon_HanMucToiDa_TrenMotGiaoDich(String deviceType, String deviceName, String udid, String url, String appActivities, String appPackage, String appName, String phone, String pass, String otp, String username, String passWeb) throws MalformedURLException{
		...
		log.info("TC_02_4_Lay so luong anh");
		int numberOfImage = payQRCode.getNumberOfImageInLibrary();

		log.info("TC_02_5_Chon anh");
		payQRCode.chooseQRCodeType2(numberOfImage);

		log.info("TC_02_6_Lay so tien");
		money = convertAvailableBalanceCurrentcyOrFeeToLong(payQRCode.getDynamicTextInTransactionDetail(driver, PayQRCode_Data.AMOUNT_PAYMENT));
		...
		log.info("TC_02_5_Chon anh va chon tai khoan, nhap dia chi");
		payQRCode.clickToImageByIndex(QRCodePageObject.numberImage);
	...
	@Parameters({ "deviceType", "deviceName", "deviceUDID", "hubURL", "appActivities", "appPackage", "appName", "phone", "pass", "otp", "username", "passWeb" })
	@Test
	public void TC_03_ThanhToanHoaDon_Type2_QRCode_LonHon_HanMucToiDa_NhomDichVu(String deviceType, String deviceName, String udid, String url, String appActivities, String appPackage, String appName, String phone, String pass, String otp, String username, String passWeb) throws MalformedURLException{
		...
		log.info("TC_03_5_Chon anh va chon tai khoan, nhap dia chi");
		payQRCode.clickToImageByIndex(QRCodePageObject.numberImage);
	...
	@Parameters({ "deviceType", "deviceName", "deviceUDID", "hubURL", "appActivities", "appPackage", "appName", "phone", "pass", "otp", "username", "passWeb" })
	@Test
	public void TC_04_ThanhToanHoaDon_Type2_QRCode_LonHon_HanMucToiDa_NhomDichVu(String deviceType, String deviceName, String udid, String url, String appActivities, String appPackage, String appName, String phone, String pass, String otp, String username, String passWeb) throws MalformedURLException{
		...
		log.info("TC_04_5_Chon anh va chon tai khoan, nhap dia chi");
		payQRCode.clickToImageByIndex(QRCodePageObject.numberImage);
	...
	public void afterClass() {
		...
		setupBE.Reset_Setup_Assign_Services_Limit(driverWeb, Constants.BE_CODE_PACKAGE, PayQRCode_Data.PAY_QR_PAY_PRODUCT);
		driverWeb.quit();
		service.stop();
	}
