...
public class Flow_RegisterOnline_LoginUser2 extends Base {
...
//@Test
public void TC_04_DangKyDichVuNganHangDienTu_ChonHangChuanTheGhiNoVCBconnectNopTienMat() throws InterruptedException {
...
@Test
public void TC_05_DangKyDichVuNganHangDienTu_ChonHangChuanTheVCBCashBankPlusAmericalTrichNoTuDongTuTK() throws InterruptedException {
	log.info("TC_Step_: Click menu header");
	registerOnline.clickToDynamicImageViewByID(driver, "com.VCB:id/menu_5");
...
//@Test
public void TC_06_DangKyDichVuNganHangDienTu_ChonHangChuanVCBMasterCardNopTienMat() throws InterruptedException {
	log.info("TC_Step_: Nhap thong tin man hinh dang ky");
	registerOnline.DangKyPhatHanhTheGhiNo(Register_Online_data.Valid_Account.TYPE_IDENTIFICATION[1], Register_Online_data.Valid_Account.NO_IDENTIFICATION, getBackWardYear(2), Register_Online_data.Valid_Account.LOCATION[1], Register_Online_data.Valid_Account.EMAIL);
...
//@Test
public void TC_07_DangKyDichVuNganHangDienTu_ChonHangChuanVCBConnect24VISATrichNoTuDongTuTK() throws InterruptedException {
	log.info("TC_Step_: Nhap thong tin man hinh dang ky");
	registerOnline.DangKyPhatHanhTheGhiNo(Register_Online_data.Valid_Account.TYPE_IDENTIFICATION[1], Register_Online_data.Valid_Account.NO_IDENTIFICATION, getBackWardYear(2), Register_Online_data.Valid_Account.LOCATION[1], Register_Online_data.Valid_Account.EMAIL);
...
@Test
public void TC_08_DangKyDichVuNganHangDienTu_ChonHangChuanUnionPAYNopTienMat() throws InterruptedException {
	log.info("TC_Step_: Nhap thong tin man hinh dang ky");
	registerOnline.DangKyPhatHanhTheGhiNo(Register_Online_data.Valid_Account.TYPE_IDENTIFICATION[1], Register_Online_data.Valid_Account.NO_IDENTIFICATION, getBackWardYear(2), Register_Online_data.Valid_Account.LOCATION[1], Register_Online_data.Valid_Account.EMAIL);
