...
public class SavingOnline_Folow_Part_6 extends Base {
	...
	SavingOnlineInfo info = new SavingOnlineInfo(Account_Data.Valid_Account.USD_ACCOUNT, "1 tháng", "100", "Lãi trả vào tài khoản tiền gửi khi đến hạn trả lãi");
	SavingOnlineInfo info1 = new SavingOnlineInfo(Account_Data.Valid_Account.USD_ACCOUNT, "3 tháng", "100", "Lãi trả vào tài khoản tiền gửi khi đến hạn trả lãi");
	...
	@Test
	public void TC_01_MoTaiKhoanTietKiem_USD_1Thang_LaiTraVaoTaiKhoanTienGuiKhiDenHanTraLai() {
	...
	@Test
	public void TC_02_MoTaiKhoanTietKiem_USD_1Thang_LaiTraVaoTaiKhoanTienGuiKhiDenHanTraLai_BaoCao() {
	...
	@Test
	public void TC_03_TatToanTaiKhoanTietKiem_USD_1Thang_LaiTraVaoTaiKhoanTienGuiKhiDenHanTraLai() {
...
//		verifyEquals(transReport.getDynamicTextInTransactionDetail(driver, "Lãi suất"), "");
		...
		verifyEquals(transReport.getDynamicTextInTransactionDetail(driver, "Số tiền gửi gốc"), addCommasToDouble(info.money) + " USD");

		log.info("TC_03_06_8: Kiem tra so tien thuc huong");
		verifyEquals(transReport.getDynamicTextInTransactionDetail(driver, "Số tiền thực hưởng"), addCommasToDouble(info.money) + " USD");
	...
	@Test
	public void TC_04_TatToanTaiKhoanTietKiem_USD_1Thang_LaiTraVaoTaiKhoanTienGuiKhiDenHanTraLai_BaoCao() {
	...
	@Test
	public void TC_05_MoTaiKhoanTietKiem_USD_3Thang_LaiTraVaoTaiKhoanTienGuiKhiDenHanTraLai() {
	...
	@Test
	public void TC_06_MoTaiKhoanTietKiem_USD_3Thang_LaiTraVaoTaiKhoanTienGuiKhiDenHanTraLai_BaoCao() {
	...
	@Test
	public void TC_07_TatToanTaiKhoanTietKiem_USD_3Thang_LaiTraVaoTaiKhoanTienGuiKhiDenHanTraLai() {
		String savingDate = getForwardDate(0);
...
//		verifyEquals(transReport.getDynamicTextInTransactionDetail(driver, "Lãi suất"), "");
		...
		verifyEquals(transReport.getDynamicTextInTransactionDetail(driver, "Số tiền gửi gốc"), addCommasToDouble(info1.money) + " USD");

		log.info("TC_07_06_8: Kiem tra so tien thuc huong");
		verifyEquals(transReport.getDynamicTextInTransactionDetail(driver, "Số tiền thực hưởng"), addCommasToDouble(info1.money) + " USD");
	...
	@Test
	public void TC_08_TatToanTaiKhoanTietKiem_USD_3Thang_LaiTraVaoTaiKhoanTienGuiKhiDenHanTraLai_BaoCao() {
