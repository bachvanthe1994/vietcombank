...
//		verifyTrue(transferInVCB.getDynamicTextInTransactionDetail(driver, "Số tiền(EUR)").contains(addCommasToDouble(TransferMoneyInVCB_Data.InputDataInVCB.AMOUNT_OF_EUR_OR_USD_TRANSFER) + " EUR"));
	...
	@Test
	 public void TC_04_ChuyenTienTuongLaiCoPhiGiaoDichNguoiChuyenTraUSDVaXacThucBangSmartOTP() throws InterruptedException {
		...
		log.info("TC_04_Step 02: Click chon tai khoan nguon");
		transferInVCB.clickToDynamicDropDown(driver, "Tài khoản nguồn");
	...
	@Test
	 public void TC_05_ChuyenTien_NgoaiTe_DinhKy_2Ngay_CoPhiGiaoDichNguoiNhanTra_XacThucBangSmartOTP() throws InterruptedException {
			...
			transferFee = convertAvailableBalanceCurrentcyOrFeeToLong(transferRecurrent.getDynamicTextInTransactionDetail(driver, "Số tiền phí"));
	...
	// Chuyển tiền từ thiện --Da chuyen
@Test
public void TC_06_ChuyenTienTuThienBangNgoaiTeSmartOTP() throws InterruptedException {
	...
	fee = convertAvailableBalanceCurrentcyOrFeeToLong(transferMoneyCharity.getDynamicTextInTransactionDetail(driver, "Số tiền phí"));
...
@Parameters({ "pass" })
	...
	//Lỗi app không cập nhật số dưtài khoản sau khi chuyển
	   public void TC_07_ChuyenTienUSDChoNguoNhanTaiQuayBangCMTXacThucSmartOTPNguoiNhanTraPhi(String pass) throws InterruptedException {
	...
	log.info("TC_07_Step 23: So tien phi chuyen doi ra USD");
	double USDTransferFee = convertMoneyToDouble(Fee, "VND") / convertMoneyToDouble(exchangeRate, "VND");
