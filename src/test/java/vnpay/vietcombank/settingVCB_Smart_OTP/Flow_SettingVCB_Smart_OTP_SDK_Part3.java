...
public class Flow_SettingVCB_Smart_OTP_SDK_Part3 extends Base {
	...
	public void TC_02_DatVeMotChieuSoLuongNguoiNhoNhatVaXacThucBangSmartOTP() throws InterruptedException {
		...
		log.info("TC_02_Step_Click dat ve tau");
		trainTicket.clickToDynamicButtonLinkOrLinkText("Đặt vé tàu");

		log.info("TC_02_Step_Click close message");
		...
		log.info("TC_02_Chon ngay ve la ngay tuong lai");
		...
		log.info("TC_02_verify chuyen sang man chon cho chieu di");
		...
		log.info("TC_02Verify so ghe da chon");
		...
		log.info("TC_02_Click tiep tuc chon chieu ve");
		trainTicket.clickToDynamicButton("TIẾP TỤC CHỌN CHIỀU VỀ");

		log.info("TC_02_verify chuyen sang man chon cho chieu ve");
		...
		log.info("TC_02_Verify so ghe da chon");
		listExpect = Arrays.asList(trainTicket.getTextInDynamicPopup("com.VCB:id/tvSeat"));
		verifyEquals(listActual, listExpect);
		...
		log.info("TC_02_Get so tien chieu ve");
		...
		log.info("TC_02_Verify tong so tien thanh toan");
		...
		log.info("TC_02_Verify ten user login");
		...
		log.info("TC_02_Verify tong tien thanh toan");
		tongTienThanhToan = trainTicket.getDynamicTextOld(driver, "Tổng tiền thanh toán");

		log.info("TC_02_click button tiep tuc");
		trainTicket.clickToDynamicButtonContains("Tiếp tục");

		log.info("TC_02_Verify hien thi man hinh xac nhan thong tin");
		...
		log.info("TC_02_Verify rong so tien thanh toan");
		...
		log.info("TC_02_Step_09: An tiep button Hien thi thong bao thanh toan thanh cong");
		verifyTrue(trainTicket.isDynamicMessageAndLabelTextDisplayed("THANH TOÁN THÀNH CÔNG"));

		log.info("TC_02_Step_09: Click thong quay lai man hinh home");
	...
	public void TC_03_DatVeMayBayNoiDiaMotChieuThanhCong_1Nguoi_ThanhToanSmartOTP(String otp) throws InterruptedException {
		...
		log.info("TC_03_Step_22: Chon phuong thuc xac thuc SMS OTP");
	...
	public void TC_04_DatVeXemPhim_Rap_MegaGS_BHDCineplex_SmartOTP() throws InterruptedException {
		...
		log.info("TC_04_06_Click chon cum rap Mega GS");
		...
		log.info("TC_04_Step_26: Clich nut Home");
	...
	public void TC_05_DatPhongKhachSan_ThanhToanSmartOTP() throws InterruptedException {
		log.info("TC_05_01_Click Dat phong khach san");
		hotelBooking.clickToDynamicTextOrButtonLink("Đặt phòng khách sạn");

		log.info("TC_05_02_Click nut Dong y");
		hotelBooking.clickToDynamicButton("Đồng ý");

		log.info("TC_05_03_Tim kiem dia diem");
		...
		log.info("TC_05_11_Kiem tra thong tin hoa don");
		...
		log.info("TC_05_24: Kiem tra man hinh thanh toan thanh cong");
		...
		log.info("TC_05_25_Kiem tra nut Thuc hien giao dich moi");
		verifyTrue(hotelBooking.isDynamicButtonDisplayed("Thực hiện giao dịch mới"));

		log.info("TC_05_26_Click Thuc hien giao dich moi");
...
// Vé xe
	//Không hiển thị phương thức xác thực smart OTP
	@Test
	public void TC_06_MuaVeXeBangSmartOTP() throws InterruptedException {
		...
		log.info("==========TC_06_Step_02: Chon va nhap diem di");
		...
		log.info("========TC_06_Step_03: Chon va nhap diem den");
		...
		log.info("TC_06_Step_10 : Dat chuyen di: ");
		vehicalTicket.clickToDynamicText(VehicalData.DATA_ORDER_TICKET.BOOK_SEAT);

		log.info("TC_06_Step_11: Chon ben diem di: ");
		...
		log.info("-TC_06_Step_37 Verify ho va ten khach hang");
		...
		log.info("-TC_06_Step_38 Verify ho va ten khach hang");
		...
		log.info("-TC_06_Step_39 Verify Email");
		...
		log.info("-TC_06_Step_40 Verify diem di ");
		...
		log.info("-TC_06_Step_41 Verify diem den ");
		...
		log.info("-TC_06_Step_42 Verify hang xe");
		...
		log.info("-TC_06_Step_43 Verify So ghe");
		...
		log.info("-TC_06_Step_44 Verify So luong ve---");
		...
		log.info("TC_06_Step_45 Verify tong tien");
		...
		log.info("-TC_06_Step_46 Click button tiep tuc");
		vehicalTicket.clickToDynamicButton(VehicalData.DATA_ORDER_TICKET.BUTTON_TIEPTUC);

		log.info("TC_06_Step_47 Xac nhan hien thi man hinh xac nhan thong tin");
		verifyTrue(vehicalTicket.isDynamicMessageAndLabelTextDisplayed(VehicalData.DATA_ORDER_TICKET.TITILE_CONFIRM));

		log.info("-TC_06_Step_48 Verrify tai khoan nguon-");
		...
		log.info("TC_06_Step_49 Click chon phuong thuc xac thuc");
		vehicalTicket.clickToDynamicTomorrow("com.VCB:id/llptxt");

		log.info("TC_06_Step_50- Verify hien thi man hinh cac phuong thuc xac minh");
		verifyTrue(vehicalTicket.isDynamicMessageAndLabelTextDisplayed(VehicalData.DATA_ORDER_TICKET.TITILE_SELECT));

		log.info("TC_06_Step_51- Chon hinh thuc xac thuc là mat khau");
		...
		log.info("TC_06_Step_52 Click button Tiep tuc");
		vehicalTicket.clickToDynamicButton(VehicalData.DATA_ORDER_TICKET.BUTTON_TIEPTUC);
		...
		log.info("---TC_06_Step_55 Verify hien thi man hinh giao dich thanh cong");
		...
		log.info("TC_06_Step_26: Clich nut Home");
...
//LỗiPTXT SmartOTP, lỗi server
	...
	public void TC_07_ChonMuaMotSanPhamThanhToanSmartOTPKhongChonKhuyenMai(String otp) throws InterruptedException {
		...
		log.info("TC_07_STEP_2: Them vao gio hang---");
		...
		for (int i = 0; i < listProduct.size(); i++) {
			...
			if (shopping.isTextDisplayedInPageSource(driver, "Tạm hết hàng")) {
				log.info("TC_07_STEP_5: click Back");
		...
		log.info("TC_07_STEP_4: click dat hang");
		shopping.clickToDynamicButton("Thêm vào giỏ hàng");

		log.info("TC_07_STEP_4: click Vao gio hang");
		shopping.clickToDynamicDateInDateTimePicker("1");

		log.info("TC_07_STEP_3: lay tong tien can thanh toan");
		...
		log.info("TC_07_STEP_5: click dat hang");
		...
		log.info("TC_07_STEP_9: verify fee Ship");
		verifyEquals(feeShippingD, fee);

		log.info("TC_07_STEP_10: giam gia");
		...
		log.info("TC_07_STEP_11: tong tien");
		...
		log.info("TC_07_STEP_12: Chon thanh toan");
		shopping.clickToDynamicButton("Thanh toán");

		log.info("TC_07_STEP_12: Xac minh hien thi man hinh xac nhan thong tin");
		...
		log.info("TC_07_STEP_13: Kiem tra tai khoan nguon");
		String account = shopping.getMoneyByAccount("Tài khoản nguồn");
		verifyEquals(account, vietcombank_test_data.Account_Data.Valid_Account.ACCOUNT2);

		log.info("TC_07_STEP_14: Kiem tra so tien thanh toan");
		...
		log.info("TC_07_STEP_16: Chon phuong thuc thanh toan");
		log.info("TC_07_STEP_16: Chon phuong thuc thanh toan");
		...
		log.info("TC_07_STEP_17: Chon tiep tuc");
		shopping.clickToDynamicButton("Tiếp tục");

		log.info("TC_07_STEP_18: dien otp");
		...
		log.info("TC_07_STEP_19: Xac nhan thong tin ");
		...
		log.info("TC_07_STEP_20: thuc hien giao dich moi");
		shopping.clickToDynamicButton("Thực hiện giao dịch mới");

		
		log.info("TC_07_Step_26: Clich nut Home");
