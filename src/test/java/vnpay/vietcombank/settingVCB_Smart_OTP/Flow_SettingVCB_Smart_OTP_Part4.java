...
public class Flow_SettingVCB_Smart_OTP_Part4 extends Base {
	...
	private String[] transferDate, getName;
	String nameCustomer, transferFee = "";
	private Date date;
	...
	TransferInVCBRecurrent info = new TransferInVCBRecurrent(Account_Data.Valid_Account.USD_ACCOUNT, Account_Data.Valid_Account.DEFAULT_ACCOUNT3, "1", "Ngày", "", "", "10", "Người chuyển trả", "test", "VCB - Smart OTP");
 ...
 @Test
	public void TC_02_ChuyenTienNhanhQuaTaiKhoanChonUSDNguoiChuyenTraPhiOTP() throws InterruptedException {
...
//		verifyTrue(transferMoney.getDynamicTextInTransactionDetail(driver, "Số tiền(USD)").contains(addCommasToDouble(TransferMoneyQuick_Data.TransferQuick.MONEY_USD) + " USD"));
		...
		log.info("TC_02_Step 23: So tien phi chuyen doi ra USD");
		...
		double transferMoney1 = convertMoneyToDouble(TransferMoneyQuick_Data.TransferQuick.MONEY_USD, " USD");

		log.info("TC_02: Kiem tra so du tai khoan USD sau khi chuyen tien");
		double amountAtual = Math.round((amountStart1 - transferMoney1 - usdTransferFee) * 100) / 100;
...
//			verifyEquals(transferInVCB.getDynamicTextInTransactionDetail(driver, "Nội dung"), TransferMoneyInVCB_Data.InputDataInVCB.NOTE);
		...
		transferFee = transferInVCB.getDynamicTextInTransactionDetail(driver, "Số tiền phí").replaceAll("\\D+", "");
	...
	public void TC_04_ChuyenTienTuongLaiCoPhiGiaoDichNguoiChuyenTraUSDVaXacThucBangSmartOTP() throws InterruptedException {
		...
		log.info("TC_04_Step_23: Chon SMS OTP");
 ...
 @Test
	...
	public void TC_05_ChuyenTien_NgoaiTe_DinhKy_2Ngay_CoPhiGiaoDichNguoiNhanTra_XacThucBangOTP() throws InterruptedException {
		...
		transferFee = transferRecurrent.getDynamicTextInTransactionDetail(driver, "Số tiền phí");
	...
	@Test
	public void TC_06_ChuyenTienTuThienBangNgoaiTeThanhToanMatKhau() throws InterruptedException {
		TransferCharity info1 = new TransferCharity(Account_Data.Valid_Account.USD_ACCOUNT, TransferMoneyCharity_Data.ORGANIZATION, "10", nameCustomer, "So 18 ngo 3 Thai Ha", "Ho ngheo", "VCB - Smart OTP");
	...
	// Lỗi app không cập nhật số dưtài khoản sau khi chuyển
	 @Test
	 @Parameters({ "pass" })
	public void TC_07_ChuyenTienUSDChoNguoNhanTaiQuayBangCMTXacThucBangMKNguoiNhanTraPhi(String pass) throws InterruptedException {
		...
		log.info("TC_07_15: lấy ra phí giao dịch");
		...
		log.info("TC_07_17: kiểm tra số dư");
		trasferPage.scrollUpToText(driver, "Tài khoản nguồn");
	...
	@Test
	public void TC_08_ChuyenTienLienNganHangNgoaite_EUR_CoPhiGiaoDichNguoiChuyenTraXacThucBangOTP() throws InterruptedException {
		TransferOutSideVCB_Info info2 = new TransferOutSideVCB_Info(Account_Data.Valid_Account.USD_ACCOUNT, "01825909301", nameCustomer, "NHTMCP Tien Phong", "10", "Phí giao dịch người chuyển trả", "test", "VCB - Smart OTP");
		...
		transferFee = transferMoneyOutSide.getDynamicTextInTransactionDetail(driver, "Số tiền phí");
	...
	public void TC_09_HuyKichHoatVCBSmartOPT() {
		...
		log.info("TC_09_Step_02: Click thanh Cai dat VCB-Smart OTP");
		smartOTP.clickToDynamicButtonLinkOrLinkText(driver, "Cài đặt");

		log.info("TC_09_Step_03: Click Cai dat VCB Smart OTP");
		smartOTP.waitForElementVisible(driver, DynamicPageUIs.DYNAMIC_BUTTON_LINK_LABEL_TEXT, "Cài đặt VCB-Smart OTP");
		smartOTP.clickToDynamicButtonLinkOrLinkText(driver, "Cài đặt VCB-Smart OTP");

		log.info("TC_09_Step_04: Click btn Huy Cai dat");
		smartOTP.clickToDynamicButtonLinkOrLinkText(driver, "Hủy");

		log.info("TC_09_Step_05: Verify hien thi popup xac nhan huy cai dat OTP");
		smartOTP.isDynamicMessageAndLabelTextDisplayed(driver, SettingVCBSmartOTP_Data.MESSEGE_CONFIRM_CANCEL);

		log.info("TC_09_Step_06: Verify hien thi popup xac nhan huy cai dat OTP");
