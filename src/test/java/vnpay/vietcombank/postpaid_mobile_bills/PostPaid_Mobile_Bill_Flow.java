...
public class PostPaid_Mobile_Bill_Flow extends Base {
	...
	public void TC_01_CuocDiDongTraSau_Viettel(String otp) {
		...
		verifyEquals(postpaidMobile.getDynamicTextDetailByIDOrPopup(driver, "com.VCB:id/title"), Postpaid_Mobile_Bill_Data.VALIDATE.POSTPAID_MOBILE_TITLE + " - " + Postpaid_Mobile_Bill_Data.DATA.VIETTEL_SUPPLIER);
		verifyEquals(postpaidMobile.getDynamicTextDetailByIDOrPopup(driver, "com.VCB:id/descript"), mobilePhone + "/" + mobilePhone);
	...
	public void TC_03_CuocDiDongTraSau_Vinaphone(String otp) {
		...
		verifyEquals(postpaidMobile.getDynamicTextDetailByIDOrPopup(driver, "com.VCB:id/title"), Postpaid_Mobile_Bill_Data.VALIDATE.POSTPAID_MOBILE_TITLE + " - " + Postpaid_Mobile_Bill_Data.DATA.VINAPHONE_SUPPLIER);
		verifyEquals(postpaidMobile.getDynamicTextDetailByIDOrPopup(driver, "com.VCB:id/descript"), mobilePhone + "/" + mobilePhone);
	...
	public void TC_05_CuocDiDongTraSau_Mobifone(String otp) {
		...
		verifyEquals(postpaidMobile.getDynamicTextDetailByIDOrPopup(driver, "com.VCB:id/title"), Postpaid_Mobile_Bill_Data.VALIDATE.POSTPAID_MOBILE_TITLE + " - " + Postpaid_Mobile_Bill_Data.DATA.MOBIFONE_SUPPLIER);
		verifyEquals(postpaidMobile.getDynamicTextDetailByIDOrPopup(driver, "com.VCB:id/descript"), mobilePhone + "/" + mobilePhone);
