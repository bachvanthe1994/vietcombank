...
public class LuckyGift extends Base {
	...
	luckyGift.clickToDynamicDropdownAndDateTimePicker(driver, "com.VCB:id/tvHinhThucNhan");
	...
	transReport.clickToDynamicButtonLinkOrLinkText(driver, LuckyGift_Data.LuckyGift.ACCOUNT_FORM);
	...
	log.info("TC_07_Step_4: chọn tiếp tục");
	luckyGift.clickToDynamicAcceptButton(driver, "com.VCB:id/btOK");
	...
	luckyGift.clickToDynamicDropdownAndDateTimePicker(driver, "com.VCB:id/tvptxt");
