...
public class DomesticAirTicketBooking_MainFlow01 extends Base {
	...
	@Parameters({ "pass" })
	@Test
	public void TC_01_DatVeMayBayNoiDiaMotChieuThanhCong_1Nguoi_ThanhToanMK(String password) {
		...
		log.info("TC_01_Step_22: Chon phuong thuc xac thuc Mat khau");
	...
	@Parameters({ "otp" })
	@Test
	public void TC_03_DatVeMayBayQuocTeMotChieuThanhCong_1Nguoi_ThanhToanOTP(String otp) {

		log.info("TC_03_Step_01: Click dat ve may bay ");
		homePage.clickToDynamicIcon(driver, Air_Text.AIR_TICKET_TEXT);

		log.info("TC_03_Step_02: Click dat ve may bay quoc te ");
		...
		log.info("TC_03_Step 15: Click checkbox dung lam thong tin hanh khach bay");
		...
		log.info("TC_03_Step 18_3: Kiem tra thong tin hanh trinh");
		verifyEquals(airTicket.getDynamicDepartureArrivalData("com.VCB:id/ThongTinMayBayChieuDi", "com.VCB:id/tvTextLeft1"), Air_Text.JOURNEY_TEXT);

		log.info("TC_03_Step 18_4: Kiem tra thong tin ma may bay");
		verifyEquals(airTicket.getDynamicDepartureArrivalData("com.VCB:id/ThongTinMayBayChieuDi", "com.VCB:id/tvFlightId"), flightCode);

		log.info("TC_03_Step 18_5: Kiem tra thong tin ngay di");
		verifyEquals(airTicket.getDynamicDepartureArrivalData("com.VCB:id/ThongTinMayBayChieuDi", "com.VCB:id/tvTextLeft2"), time);

		verifyEquals(airTicket.getDynamicDepartureArrivalData("com.VCB:id/ThongTinMayBayChieuDi", "com.VCB:id/tvTextRight1"), time);

		log.info("TC_03_Step 18_6: Kiem tra thong tin gio di ");
		verifyEquals(airTicket.getDynamicDepartureArrivalData("com.VCB:id/ThongTinMayBayChieuDi", "com.VCB:id/tvTextLeft3"), source + " " + departureTime);

		log.info("TC_03_Step 18_7: Kiem tra thong tin gio den");
		verifyEquals(airTicket.getDynamicDepartureArrivalData("com.VCB:id/ThongTinMayBayChieuDi", "com.VCB:id/tvTextRight2"), dest + " " + arrivalTime);

		log.info("TC_03_Step 18_8: Kiem trathông tin thoi gian bay");
		verifyEquals(airTicket.getDynamicDepartureArrivalData("com.VCB:id/ThongTinMayBayChieuDi", "com.VCB:id/tvDuration"), duration);

		log.info("TC_03_Step 18_9: Kiem tra tong so tien hien thi dung");
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.TOTAL_MONEY_TEXT, "com.VCB:id/tvText2"), ticketPrice);

		log.info("TC_03_Step_19: Click checkbox dong y dieu khoan dat ve");
		airTicket.clickToDynamicCheckBoxByID("com.VCB:id/checkBoxCondition");

		log.info("TC_03_Step_20: Click Thanh toan");
		airTicket.clickToDynamicButton(Air_Text.BUTTON_PAY_TEXT);
		...
		log.info("TC_03_Step_22_1: Xac nhan chieu di ");
		verifyEquals(airTicket.getDynamicConfirmInfoByIndex("4", Air_Text.FLIGHT_WAY_TEXT), sourceDetail + " → " + destDetail);

		log.info("TC_03_Step_22_2: Xac nhan so hieu chuyen bay chieu di");
		verifyEquals(airTicket.getDynamicConfirmInfoByIndex("5", Air_Text.FLIGHT_CODE_TEXT).replace("-", ""), flightCode);

		log.info("TC_03_Step_22_3: Xac nhan thoi gian bay chieu di");
		verifyEquals(airTicket.getDynamicConfirmInfoByIndex("6", Air_Text.FLIGHT_TIME_TEXT), departureTime + " - " + arrivalTime);

		log.info("TC_03_Step_22_4: Xac nhan tong tien ve may bay");
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.TOTAL_PAY_TEXT, "com.VCB:id/tvContent"), ticketPrice);
	...
	@Test
	public void TC_04_DatVeMayBayQuocTeMotChieuThanhCong_1Nguoi_BaoCaoGiaoDich() {
	...
	@Parameters({ "pass" })
	@Test
	public void TC_05_DatVeMayBayQuocTeMotChieuThanhCong_1Nguoi_ThanhToanMK(String password) {
		...
		log.info("TC_05_Step_25: Chon phuong thuc xac thuc Mat khau");
		airTicket.clickToDynamicTextByID("com.VCB:id/tvptxt");
		airTicket.clickToDynamicTextOrButtonLink(Air_Text.PASSWORD_TEXT);
		fee = airTicket.getAirTicketPriceInfo1Way(Air_Text.FEE_VALUE_TEXT, "com.VCB:id/tvPhiGiaoDich");
		...
		log.info("TC_05_Step_27: Nhap MK roi click Tiep tuc");
		airTicket.inputToDynamicPopupPasswordInput(driver, password, Air_Text.BUTTON_CONTINUE_TEXT);
		airTicket.clickToDynamicButton(Air_Text.BUTTON_CONTINUE_TEXT);
	...
	@Parameters({ "pass" })
	@Test
	public void TC_07_DatVeMayBayNoiDiaMotChieu_ThanhToanSau_1Nguoi_ThanhToanMK(String password) {
		...
		airTicket.clickToDynamicFlight(0, Air_Text.SUGGEST_FLIGHT_CODE_VN);
		ticketPrice = airTicket.getDynamicTextByID("com.VCB:id/tv_amount_flight_selected");
		airTicket.clickToDynamicTextByID("com.VCB:id/btn_book");
		...
		log.info("TC_1_Step 18_2: Kiem tra dia diem den");
		verifyEquals(airTicket.getDynamicDepartureArrivalData("com.VCB:id/DiaDiem", "com.VCB:id/tvTextttdiadiem3"), destDetail);
		verifyEquals(airTicket.getDynamicDepartureArrivalData("com.VCB:id/DiaDiem", "com.VCB:id/tvTextttdiadiem4"), dest);
		...
		log.info("TC_07_Step_27_01: Xac nhan ma thanh toan ");
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.PAY_ID_TEXT, "com.VCB:id/tvContent"), payID);
		...
		log.info("TC_07_Step_28_01: An tiep tuc");
		airTicket.clickToDynamicButton(Air_Text.BUTTON_CONTINUE_TEXT);
		
		log.info("TC_07_Step_28_02: Xac nhan giao dich");
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.SURPLUS_TEXT, "com.VCB:id/tvTu_tai_khoan"), sourceAccount.account);
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.PAY_ID_TEXT, "com.VCB:id/tvBooking_number"), payID);
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.MONEY_AMOUNT_TEXT, "com.VCB:id/tvAmount"), ticketPrice);

		log.info("TC_07_Step_29: Chon phuong thuc xac thuc MK");
		airTicket.clickToDynamicTextByID("com.VCB:id/tvptxt");
		airTicket.clickToDynamicTextOrButtonLink(Air_Text.PASSWORD_TEXT);
		fee = airTicket.getAirTicketPriceInfo1Way(Air_Text.FEE_VALUE_TEXT, "com.VCB:id/tvPhiGiaoDich");
		...
		log.info("TC_07_Step_31: Nhap Mat khau roi click Tiep tuc");
		airTicket.inputToDynamicPopupPasswordInput(driver, password, Air_Text.BUTTON_CONTINUE_TEXT);
		airTicket.clickToDynamicButton(Air_Text.BUTTON_CONTINUE_TEXT);
	...
	@Test
	public void TC_08_DatVeMayBayNoiDiaMotChieu_ThanhToanSau_1Nguoi_BaoCaoGiaoDich() {
	...
	@Parameters({ "otp" })
	@Test
	public void TC_09_DatVeMayBayQuocTeMotChieu_ThanhToanSau_1Nguoi_ThanhToanOTP(String otp) {

		log.info("TC_09_Step_01: Click dat ve may bay ");
		homePage.clickToDynamicIcon(driver, Air_Text.AIR_TICKET_TEXT);

		log.info("TC_09_Step_02: Click dat ve may bay quoc te ");
		airTicket.clickToDynamicTextOrButtonLink(Air_Text.INTERNATIONAL_AIR_TICKET_TEXT);
		...
		log.info("TC_09_Step 15: Click checkbox dung lam thong tin hanh khach bay");
		airTicket.clickToDynamicCheckBoxByID("com.VCB:id/iv_check_active");
		...
		log.info("TC_09_Step_27_01: Chọn tai khoan nguon");
		airTicket.scrollUpToTextView(Air_Text.SURPLUS_TEXT);
		airTicket.clickToDynamicTextByID("com.VCB:id/number_account");
		sourceAccount = airTicket.chooseSourceAccount(driver, Constants.MONEY_CHECK_VND, Constants.VND_CURRENCY);

		log.info("TC_09_Step_27_02: Xac nhan ma thanh toan ");
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.PAY_ID_TEXT, "com.VCB:id/tvContent"),payID);

		log.info("TC_09_Step_27_03: Xac nhan chieu di ");
		verifyEquals(airTicket.getDynamicConfirmInfoByIndex("4", Air_Text.FLIGHT_WAY_TEXT), source + " → " + dest);

		log.info("TC_09_Step_27_04: Xac nhan tong tien ve may bay");
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.TOTAL_PAY_TEXT, "com.VCB:id/tvContent"), ticketPrice);
	
		log.info("TC_09_Step_28_01: An tiep tuc");
		airTicket.clickToDynamicButton(Air_Text.BUTTON_CONTINUE_TEXT);

		log.info("TC_09_Step_28_02: Xac nhan giao dich");
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.SURPLUS_TEXT, "com.VCB:id/tvTu_tai_khoan"), sourceAccount.account);
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.PAY_ID_TEXT, "com.VCB:id/tvBooking_number"), payID);
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.MONEY_AMOUNT_TEXT, "com.VCB:id/tvAmount"), ticketPrice);
	...
	@Test
	public void TC_10_DatVeMayBayQuocTeMotChieu_ThanhToanSau_1Nguoi_BaoCaoGiaoDich() {
	...
	@Parameters({ "pass" })
	@Test
	public void TC_11_DatVeMayBayQuocTeMotChieu_ThanhToanSau_1Nguoi_ThanhToanMK(String password) {

		log.info("TC_11_Step_01: Click dat ve may bay ");
		homePage.clickToDynamicIcon(driver, Air_Text.AIR_TICKET_TEXT);

		log.info("TC_11_Step_02: Click dat ve may bay quoc te ");
		airTicket.clickToDynamicTextOrButtonLink(Air_Text.INTERNATIONAL_AIR_TICKET_TEXT);
		...
		log.info("TC_11_Step 15: Click checkbox dung lam thong tin hanh khach bay");
		airTicket.clickToDynamicCheckBoxByID("com.VCB:id/iv_check_active");
		...
		log.info("TC_11_Step_27_01: Chọn tai khoan nguon");
		airTicket.scrollUpToTextView(Air_Text.SURPLUS_TEXT);
		airTicket.clickToDynamicTextByID("com.VCB:id/number_account");
		sourceAccount = airTicket.chooseSourceAccount(driver, Constants.MONEY_CHECK_VND, Constants.VND_CURRENCY);

		log.info("TC_11_Step_27_02: Xac nhan ma thanh toan ");
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.PAY_ID_TEXT, "com.VCB:id/tvContent"),payID);

		log.info("TC_11_Step_27_03: Xac nhan chieu di ");
		verifyEquals(airTicket.getDynamicConfirmInfoByIndex("4", Air_Text.FLIGHT_WAY_TEXT), source + " → " + dest);

		log.info("TC_11_Step_27_04: Xac nhan tong tien ve may bay");
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.TOTAL_PAY_TEXT, "com.VCB:id/tvContent"), ticketPrice);
		
		log.info("TC_11_Step_28_01: An tiep tuc");
		airTicket.clickToDynamicButton(Air_Text.BUTTON_CONTINUE_TEXT);
		
		log.info("TC_11_Step_28_02: Xac nhan giao dich");
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.SURPLUS_TEXT, "com.VCB:id/tvTu_tai_khoan"), sourceAccount.account);
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.PAY_ID_TEXT, "com.VCB:id/tvBooking_number"), payID);
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.MONEY_AMOUNT_TEXT, "com.VCB:id/tvAmount"), ticketPrice);
	...
	@Test
	public void TC_12_DatVeMayBayQuocTeMotChieu_ThanhToanSau_1Nguoi_BaoCaoGiaoDich() {
