...
public class DomesticAirTicketBooking_MainFlow03 extends Base {
	...
	public void TC_01_DatVeMayBayNoiDiaMotChieuThanhCong_1Nguoi_ThanhToanOTP(String otp) {
		...
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.SURPLUS_TEXT, "com.VCB:id/tvTu_tai_khoan"), sourceAccount.account);
	...
	@Parameters({ "otp" })
	@Test
	public void TC_03_DatVeMayBayNoiDiaMotChieu_ThanhToanSau_1Nguoi_ThanhToanOTP(String otp) {

		log.info("TC_03_Step_01: Click vao phan Dat ve may bay");
		homePage.clickToDynamicIcon(driver, Air_Text.AIR_TICKET_TEXT);
		...
		log.info("TC_03_Step_10: Dien Ten Nguoi lon ");
		airTicket.inputToDynamicInputBoxByLabel(DomesticAirTicketBooking_Data.validInput.ADULT_NAME, Air_Text.CONTACT_INFO_TEXT, "com.VCB:id/edt_hoten");

		log.info("TC_03_Step_11: Chon gioi tinh nu");
		airTicket.checkToDynamicTextOrDropDownByLabel(Air_Text.CONTACT_INFO_TEXT, "com.VCB:id/tv_NuContact");

		log.info("TC_03_Step_12: Dien Email  ");
		airTicket.inputToDynamicInputBoxByLabel(DomesticAirTicketBooking_Data.validInput.ADULT_EMAIL, Air_Text.CONTACT_INFO_TEXT, "com.VCB:id/edt_email");

		log.info("TC_03_Step_13: Dien Phone ");
		airTicket.inputToDynamicInputBoxByLabel(DomesticAirTicketBooking_Data.validInput.ADULT_PHONE, Air_Text.CONTACT_INFO_TEXT, "com.VCB:id/edt_phonenumber");

		log.info("TC_03_Step_14: Dien Noi dung");
		airTicket.inputToDynamicInputBoxByLabel(DomesticAirTicketBooking_Data.validInput.CONTENT, Air_Text.CONTACT_INFO_TEXT, "com.VCB:id/edt_content");

		log.info("TC_03_Step_15: Dien ten nguoi lon 1 ");
		airTicket.inputToDynamicInputBoxByLabelAndIndex(DomesticAirTicketBooking_Data.validInput.ADULT_NAME, "com.VCB:id/recy_info_book", "0", "com.VCB:id/edt_hoten");

		log.info("TC_03_Step_16: Chon gioi tinh nu");
		airTicket.clickToDynamicTextOrDropDownByLabelAndIndex("com.VCB:id/recy_info_book", "0", "com.VCB:id/ll_NuNoiDia", "com.VCB:id/tv_NuNoiDia");

		log.info("TC_03_Step_17: Click Tiep Tuc");
		airTicket.clickToDynamicButton(Air_Text.BUTTON_CONTINUE_TEXT);

		log.info("TC_03_Step_18: Kiem tra man hinh xac nhan chuyen bay hien thi");
		verifyEquals(airTicket.getDynamicTextByID("com.VCB:id/tvTitle1"), Air_Text.FLIGHT_CONFIRM_TEXT);
		...
		log.info("TC_03_Step_19: Kiem tra tong so tien hien thi dung");
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.TOTAL_MONEY_TEXT, "com.VCB:id/tvText2"), ticketPrice);

		log.info("TC_03_Step_20: Click checkbox dong y dieu khoan dat ve");
		airTicket.clickToDynamicCheckBoxByID("com.VCB:id/checkBoxCondition");

		log.info("TC_03_Step_21: Click Thanh toan sau");
		airTicket.clickToDynamicButton(Air_Text.BUTTON_PAY_LATER_TEXT);

		log.info("TC_03_Step_22: Hien thi man hinh Ket qua");
		payID = airTicket.getDynamicTextByID("com.VCB:id/tvBookCode");

		log.info("TC_03_Step_23: Ve man hinh ve may bay");
		airTicket.clickToDynamicButton(Air_Text.BUTTON_FINISH_TEXT);

		log.info("TC_03_Step_24: Chon Thanh toan ve may bay");
		airTicket.clickToDynamicTextOrButtonLink(Air_Text.AIR_TICKET_PAY_TEXT);

		log.info("TC_03_Step_25: Nhap ma thanh toan");
		airTicket.inputToDynamicInputBoxById(payID, "com.VCB:id/edtBookCode");

		log.info("TC_03_Step_26: An tiep tuc");
		airTicket.clickToDynamicButton(Air_Text.BUTTON_CONTINUE_TEXT);

		log.info("TC_03_Step_27: Chọn tai khoan nguon");
		airTicket.scrollUpToTextView(Air_Text.SURPLUS_TEXT);
		airTicket.clickToDynamicTextByID("com.VCB:id/number_account");
		sourceAccount = airTicket.chooseSourceAccount(driver, Constants.MONEY_CHECK_VND, Constants.VND_CURRENCY);

		log.info("TC_03_Step_27_01: Xac nhan ma thanh toan ");
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.PAY_ID_TEXT, "com.VCB:id/tvContent"), payID);

		log.info("TC_03_Step_27_02: Xac nhan chieu di ");
		verifyEquals(airTicket.getDynamicConfirmInfoByIndex("4", Air_Text.FLIGHT_WAY_TEXT), source + " → " + dest);

		log.info("TC_03_Step_27_03: Xac nhan so tien thanh toan");
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.TOTAL_PAY_TEXT, "com.VCB:id/tvContent"), ticketPrice);

		log.info("TC_03_Step_28_01: An tiep tuc");
		airTicket.clickToDynamicButton(Air_Text.BUTTON_CONTINUE_TEXT);

		log.info("TC_03_Step_28_02: Xac nhan giao dich");
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.SURPLUS_TEXT, "com.VCB:id/tvTu_tai_khoan"), sourceAccount.account);
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.PAY_ID_TEXT, "com.VCB:id/tvBooking_number"), payID);
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.MONEY_AMOUNT_TEXT, "com.VCB:id/tvAmount"), ticketPrice);
		
		log.info("TC_03_Step_29: Chon phuong thuc xac thuc SMS OTP");
		airTicket.clickToDynamicTextByID("com.VCB:id/tvptxt");
		airTicket.clickToDynamicTextOrButtonLink(Air_Text.SMS_OTP_TEXT);
		fee = airTicket.getAirTicketPriceInfo1Way(Air_Text.FEE_VALUE_TEXT, "com.VCB:id/tvPhiGiaoDich");

		log.info("TC_03_Step_30: Click Tiep Tuc");
		airTicket.clickToDynamicButton(Air_Text.BUTTON_CONTINUE_TEXT);

		log.info("TC_03_Step_31: Nhap Ma OTP roi click Tiep tuc");
		airTicket.inputToDynamicOtp(driver, otp, Air_Text.BUTTON_CONTINUE_TEXT);
		airTicket.clickToDynamicButton(Air_Text.BUTTON_CONTINUE_TEXT);

		log.info("TC_03_Step_32: Xac nhan hien thi man hinh thanh toan thanh cong");
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.PAY_ID_TEXT, "com.VCB:id/tvContent"), payID);
		transactionID = airTicket.getAirTicketPriceInfo1Way(Air_Text.TRANSACTION_ID_TEXT, "com.VCB:id/tvContent");

		log.info("TC_03_Step_33: Clich nut Home");
		airTicket.clickToDynamicIcon("com.VCB:id/ivHome");

	}

	@Test
	public void TC_04_DatVeMayBayNoiDiaMotChieu_ThanhToanSau_1Nguoi_BaoCaoGiaoDich() {
	...
	@Test
	public void TC_05_DatVeMayBayNoiDiaMotChieuThanhCong_1Nguoi_ThanhToanSmartOTP() {
		...
		log.info("TC_05_Step 14: Kiem tra man hinh xac nhan chuyen bay hien thi");
		verifyEquals(airTicket.getDynamicTextByID("com.VCB:id/tvTitle1"), Air_Text.FLIGHT_CONFIRM_TEXT);

		log.info("TC_05_Step 14_1: Kiem tra dia diem khoi hanh");
		verifyEquals(airTicket.getDynamicDepartureArrivalData("com.VCB:id/DiaDiem", "com.VCB:id/tvTextttdiadiem1"), sourceDetail);
		verifyEquals(airTicket.getDynamicDepartureArrivalData("com.VCB:id/DiaDiem", "com.VCB:id/tvTextttdiadiem2"), source);

		log.info("TC_05_Step 14_2: Kiem tra dia diem den");
		verifyEquals(airTicket.getDynamicDepartureArrivalData("com.VCB:id/DiaDiem", "com.VCB:id/tvTextttdiadiem3"), destDetail);
		verifyEquals(airTicket.getDynamicDepartureArrivalData("com.VCB:id/DiaDiem", "com.VCB:id/tvTextttdiadiem4"), dest);

		log.info("TC_05_Step 14_3: Kiem tra thong tin hanh trinh");
		verifyEquals(airTicket.getDynamicDepartureArrivalData("com.VCB:id/ThongTinMayBayChieuDi", "com.VCB:id/tvTextLeft1"), Air_Text.JOURNEY_TEXT);

		log.info("TC_05_Step 14_4: Kiem tra thong tin ma may bay");
		verifyEquals(airTicket.getDynamicDepartureArrivalData("com.VCB:id/ThongTinMayBayChieuDi", "com.VCB:id/tvFlightId"), flightCode01);

		log.info("TC_05_Step 14_5: Kiem tra thong tin ngay di");
		verifyEquals(airTicket.getDynamicDepartureArrivalData("com.VCB:id/ThongTinMayBayChieuDi", "com.VCB:id/tvTextLeft2"), time);

		verifyEquals(airTicket.getDynamicDepartureArrivalData("com.VCB:id/ThongTinMayBayChieuDi", "com.VCB:id/tvTextRight1"), time);

		log.info("TC_05_Step 14_6: Kiem tra thong tin gio di ");
		verifyEquals(airTicket.getDynamicDepartureArrivalData("com.VCB:id/ThongTinMayBayChieuDi", "com.VCB:id/tvTextLeft3"), source + " " + departureTime01);

		log.info("TC_05_Step 14_7: Kiem tra thong tin gio den");
		verifyEquals(airTicket.getDynamicDepartureArrivalData("com.VCB:id/ThongTinMayBayChieuDi", "com.VCB:id/tvTextRight2"), dest + " " + arrivalTime01);

		log.info("TC_05_Step 14_8: Kiem trathông tin thoi gian bay");
		verifyEquals(airTicket.getDynamicDepartureArrivalData("com.VCB:id/ThongTinMayBayChieuDi", "com.VCB:id/tvDuration"), duration01);

		log.info("TC_05_Step 15: Kiem tra tong so tien hien thi dung");
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.TOTAL_MONEY_TEXT, "com.VCB:id/tvText2"), ticketPrice);
		...
		log.info("TC_05_Step_18_1: Chọn tai khoan nguon");
		airTicket.scrollUpToTextView(Air_Text.SURPLUS_TEXT);
		airTicket.clickToDynamicTextByID("com.VCB:id/number_account");
		sourceAccount = airTicket.chooseSourceAccount(driver, Constants.MONEY_CHECK_VND, Constants.VND_CURRENCY);
		payID = airTicket.getAirTicketPriceInfo1Way(Air_Text.PAY_ID_TEXT, "com.VCB:id/tvContent");

		log.info("TC_05_Step_18_2: Xac nhan chieu di ");
		verifyEquals(airTicket.getDynamicConfirmInfoByIndex("4", Air_Text.FLIGHT_WAY_TEXT), sourceDetail + " → " + destDetail);

		log.info("TC_05_Step_18_3: Xac nhan so hieu chuyen bay chieu di");
		verifyEquals(airTicket.getDynamicConfirmInfoByIndex("5", Air_Text.FLIGHT_CODE_TEXT).replace("-", ""), flightCode01);

		log.info("TC_05_Step_18_4: Xac nhan thoi gian bay chieu di");
		verifyEquals(airTicket.getDynamicConfirmInfoByIndex("6", Air_Text.FLIGHT_TIME_TEXT), departureTime01 + " - " + arrivalTime01);

		log.info("TC_05_Step_19: Click Tiep tuc");
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.TOTAL_PAY_TEXT, "com.VCB:id/tvContent"), ticketPrice);

		log.info("TC_05_Step 20: Click Tiep Tuc");
		airTicket.clickToDynamicButton(Air_Text.BUTTON_CONTINUE_TEXT);

		log.info("TC_05_Step_21: Xac nhan giao dich");
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.SURPLUS_TEXT, "com.VCB:id/tvTu_tai_khoan"), sourceAccount.account);
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.PAY_ID_TEXT, "com.VCB:id/tvBooking_number"), payID);
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.MONEY_AMOUNT_TEXT, "com.VCB:id/tvAmount"), ticketPrice);

		log.info("TC_05_Step_22: Chon phuong thuc xac thuc Smart OTP");
		airTicket.clickToDynamicTextByID("com.VCB:id/tvptxt");
		...
		log.info("TC_05_Step_24: Nhap Ma Smart OTP roi click Tiep tuc");
		...
		log.info("TC_05_Step_25: Xac nhan hien thi man hinh thanh toan thanh cong");
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.PAY_ID_TEXT, "com.VCB:id/tvContent"), payID);
		transactionID = airTicket.getAirTicketPriceInfo1Way(Air_Text.TRANSACTION_ID_TEXT, "com.VCB:id/tvContent");

		log.info("TC_05_Step_26: Clich nut Home");
		airTicket.clickToDynamicIcon("com.VCB:id/ivHome");

	}

	@Test
	public void TC_06_XacNhanDatVeMayBayNoiDiaMotChieuThanhCong_1Nguoi_TrongBaoCaoGiaoDich() {
	...
	@Test
	public void TC_07_KiemTra_HienThiThongBao_DaDangNhap() {
		
		log.info("TC_07_Step_01: Click vao Inbox");
		homePage.clickToDynamicImageViewByID(driver, "com.VCB:id/menu_3");
		
		log.info("TC_07_Step_02: Click vao tab Tat ca");
		homePage.clickToTextID(driver, "com.VCB:id/radioAll");
		
		log.info("TC_07_Step_03: Lay du lieu hien thi");
		String inboxContent = homePage.getDynamicTextByContentID(driver, "com.VCB:id/recycleview","com.VCB:id/content",payID);
		
		log.info("TC_07_Step_04: So sanh thong tin thanh toan");
		...
		log.info("TC_07_Step_05: Click vao tab Khac");
		homePage.clickToTextID(driver, "com.VCB:id/radioOther");
		
		log.info("TC_07_Step_06: Lay du lieu hien thi");
		inboxContent = homePage.getDynamicTextByContentID(driver, "com.VCB:id/recycleview","com.VCB:id/content",payID);
		
		log.info("TC_07_Step_07: So sanh thong tin thanh toan");
		verifyTrue(inboxContent.contains(payID));
		verifyTrue(inboxContent.contains(addCommasToLong(convertAvailableBalanceCurrentcyOrFeeToLong(ticketPrice)+"")));
		verifyTrue(inboxContent.contains(sourceDetail+"-"+destDetail));
		verifyTrue(inboxContent.contains(flightCode01));
		
		log.info("TC_07_Step_08: Mo tab Home");
		homePage.clickToDynamicImageViewByID(driver, "com.VCB:id/menu_1");
	}

	@Test
	public void TC_08_DatVeMayBayNoiDiaKhuHoi_ThanhCong_1Nguoi_ThanhToanSmartOTP() {

		log.info("TC_08_Step_01: Click Dat ve may bay");
		homePage.clickToDynamicIcon(driver, Air_Text.AIR_TICKET_TEXT);
		...
		log.info("TC_08_Step_04: Chon khu hoi ");
		...
		log.info("TC_08_Step_07: Chon ngay di / ngay ve");
		airTicket.clickToDynamicTextOrButtonLink(Air_Text.DEPARTURE_DATE_TEXT);
		...
		log.info("TC_08_Step_09_1: Chon chuyen bay chieu di");
		...
		log.info("TC_08_Step_09_2: Chon chuyen bay chieu ve");
		...
		log.info("TC_08_Step_09_3: Click dat ve");
		ticketPrice = airTicket.getDynamicTextByID("com.VCB:id/tv_Sum_amount_flight_selected");
		airTicket.clickToDynamicTextByID("com.VCB:id/btn_book");

		log.info("TC_08_Step 10: Dien Ten Nguoi lon ");
		airTicket.inputToDynamicInputBoxByLabel(DomesticAirTicketBooking_Data.validInput.ADULT_NAME, Air_Text.CONTACT_INFO_TEXT, "com.VCB:id/edt_hoten");

		log.info("TC_08_Step 11: Chon gioi tinh nu");
		airTicket.checkToDynamicTextOrDropDownByLabel(Air_Text.CONTACT_INFO_TEXT, "com.VCB:id/tv_NuContact");

		log.info("TC_08_Step 12: Dien Email  ");
		airTicket.inputToDynamicInputBoxByLabel(DomesticAirTicketBooking_Data.validInput.ADULT_EMAIL, Air_Text.CONTACT_INFO_TEXT, "com.VCB:id/edt_email");

		log.info("TC_08_Step 13: Dien Phone ");
		airTicket.inputToDynamicInputBoxByLabel(DomesticAirTicketBooking_Data.validInput.ADULT_PHONE, Air_Text.CONTACT_INFO_TEXT, "com.VCB:id/edt_phonenumber");

		log.info("TC_08_Step 14: Dien Noi dung");
		airTicket.inputToDynamicInputBoxByLabel(DomesticAirTicketBooking_Data.validInput.CONTENT, Air_Text.CONTACT_INFO_TEXT, "com.VCB:id/edt_content");

		log.info("TC_08_Step 15: Click vao check box Dung lam thong tin hanh khach bay");
		airTicket.clickToDynamicCheckBoxByID("com.VCB:id/iv_check_active");

		log.info("TC_08_Step 16: Click Tiep Tuc");
		airTicket.clickToDynamicButton(Air_Text.BUTTON_CONTINUE_TEXT);

		log.info("TC_08_Step 17: Kiem tra man hinh xac nhan chuyen bay hien thi");
		verifyEquals(airTicket.getDynamicTextByID("com.VCB:id/tvTitle1"), Air_Text.FLIGHT_CONFIRM_TEXT);

		log.info("TC_08_Step 17_1: Kiem tra dia diem khoi hanh");
		verifyEquals(airTicket.getDynamicDepartureArrivalData("com.VCB:id/DiaDiem", "com.VCB:id/tvTextttdiadiem1"), sourceDetail);
		verifyEquals(airTicket.getDynamicDepartureArrivalData("com.VCB:id/DiaDiem", "com.VCB:id/tvTextttdiadiem2"), source);

		log.info("TC_08_Step 17_2: Kiem tra dia diem den");
		verifyEquals(airTicket.getDynamicDepartureArrivalData("com.VCB:id/DiaDiem", "com.VCB:id/tvTextttdiadiem3"), destDetail);
		verifyEquals(airTicket.getDynamicDepartureArrivalData("com.VCB:id/DiaDiem", "com.VCB:id/tvTextttdiadiem4"), dest);

		log.info("TC_08_Step 17_3: Kiem tra thong tin chieu di");
		...
		log.info("TC_08_Step 17_4: Kiem tra thong tin ma chieu di");
		verifyEquals(airTicket.getDynamicDepartureArrivalData("com.VCB:id/ThongTinMayBayChieuDi", "com.VCB:id/tvFlightId"), flightCode01);

		log.info("TC_08_Step 17_5: Kiem tra thong tin chieu di : ngay di");
		...
		log.info("TC_08_Step 17_6: Kiem tra thong tin chieu di : gio di ");
		verifyEquals(airTicket.getDynamicDepartureArrivalData("com.VCB:id/ThongTinMayBayChieuDi", "com.VCB:id/tvTextLeft3"), source + " " + departureTime01);

		log.info("TC_08_Step 17_7: Kiem tra thong tin chieu di : gio den");
		verifyEquals(airTicket.getDynamicDepartureArrivalData("com.VCB:id/ThongTinMayBayChieuDi", "com.VCB:id/tvTextRight2"), dest + " " + arrivalTime01);

		log.info("TC_08_Step 17_9: Kiem tra thong tin chieu ve");
		...
		log.info("TC_08_Step 17_10: Kiem tra thong tin ma chieu ve");
		...
		log.info("TC_08_Step 17_11: Kiem tra thong tin chieu ve : ngay di");
		...
		log.info("TC_08_Step 17_12: Kiem tra thong tin chieu ve : gio di ");
		...
		log.info("TC_08_Step 17_13: Kiem tra thong tin chieu ve : gio den");
		...
		log.info("TC_08_Step 18: Kiem tra tong so tien hien thi dung");
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.TOTAL_MONEY_TEXT, "com.VCB:id/tvText2"), ticketPrice);

		log.info("TC_08_Step_19: Click checkbox dong y dieu khoan dat ve");
		airTicket.clickToDynamicCheckBoxByID("com.VCB:id/checkBoxCondition");

		log.info("TC_08_Step_20: Click Thanh toan");
		airTicket.clickToDynamicButton(Air_Text.BUTTON_PAY_TEXT);

		log.info("TC_08_Step_27_1: Chọn tai khoan nguon");
		airTicket.scrollUpToTextView(Air_Text.SURPLUS_TEXT);
		airTicket.clickToDynamicTextByID("com.VCB:id/number_account");
		sourceAccount = airTicket.chooseSourceAccount(driver, Constants.MONEY_CHECK_VND, Constants.VND_CURRENCY);

		log.info("TC_08_Step_27_2: Xac nhan ma thanh toan");
		payID = airTicket.getAirTicketPriceInfo1Way(Air_Text.PAY_ID_TEXT, "com.VCB:id/tvContent");

		log.info("TC_08_Step_27_3: Xac nhan chieu di bay ");
		verifyEquals(airTicket.getDynamicConfirmInfoByIndex("4", Air_Text.FLIGHT_WAY_TEXT), sourceDetail + " → " + destDetail);

		log.info("TC_08_Step_27_4: Xac nhan so hieu chuyen bay chieu di");
		verifyEquals(airTicket.getDynamicConfirmInfoByIndex("5", Air_Text.FLIGHT_CODE_TEXT).replace("-", ""), flightCode01);

		log.info("TC_08_Step_27_5: Xac nhan thoi gian bay chieu di");
		verifyEquals(airTicket.getDynamicConfirmInfoByIndex("6", Air_Text.FLIGHT_TIME_TEXT), departureTime01 + " - " + arrivalTime01);

		log.info("TC_08_Step_27_6: Xac nhan chieu ve bay ");
		verifyEquals(airTicket.getDynamicConfirmInfoByIndex("9", Air_Text.FLIGHT_WAY_TEXT), destDetail + " → " + sourceDetail);

		log.info("TC_08_Step_27_7: Xac nhan so hieu chuyen bay chieu ve");
		verifyEquals(airTicket.getDynamicConfirmInfoByIndex("10", Air_Text.FLIGHT_CODE_TEXT).replace("-", ""), flightCode02);

		log.info("TC_08_Step_27_8: Xac nhan thoi gian bay chieu ve");
		verifyEquals(airTicket.getDynamicConfirmInfoByIndex("11", Air_Text.FLIGHT_TIME_TEXT), departureTime02 + " - " + arrivalTime02);

		log.info("TC_08_Step_27_9: Xac nhan Tong tien thanh toan");
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.TOTAL_PAY_TEXT, "com.VCB:id/tvContent"), ticketPrice);

		log.info("TC_08_Step_28: An tiep tuc");
		airTicket.clickToDynamicButton(Air_Text.BUTTON_CONTINUE_TEXT);

		log.info("TC_08_Step_29_1: Xac nhan giao dich");
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.SURPLUS_TEXT, "com.VCB:id/tvTu_tai_khoan"), sourceAccount.account);
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.PAY_ID_TEXT, "com.VCB:id/tvBooking_number"), payID);
		verifyEquals(airTicket.getAirTicketPriceInfo1Way(Air_Text.MONEY_AMOUNT_TEXT, "com.VCB:id/tvAmount"), ticketPrice);

		log.info("TC_08_Step_29_2: Chon phuong thuc xac thuc Smart OTP");
		airTicket.clickToDynamicTextByID("com.VCB:id/tvptxt");
		airTicket.clickToDynamicTextOrButtonLink(Air_Text.SMART_OTP_TEXT);
		fee = airTicket.getAirTicketPriceInfo1Way(Air_Text.FEE_VALUE_TEXT, "com.VCB:id/tvPhiGiaoDich");
		...
		log.info("TC_08_Step_31: Nhap Ma Smart OTP roi click Tiep tuc");
		airTicket.inputToDynamicSmartOTP(driver, smartOtpPass, "com.VCB:id/otp");
		airTicket.clickToDynamicAcceptButton("com.VCB:id/submit");
		airTicket.clickToDynamicAcceptButton("com.VCB:id/btContinue");
	...
	@Test
	public void TC_09_DatVeMayBayNoiDiaKhuHoi_ThanhCong_1Nguoi_BaoCaoGiaoDich() {
		...
		log.info("TC_09_Step_04: Chon 'Thanh toan ve may bay'");
		transactionReport.clickToDynamicButtonLinkOrLinkText(driver, ReportTitle.AIR_TICKET);
		...
		log.info("TC_09_Step_10: Xac nhan hien thi dung ma giao dich");
		verifyEquals(transactionReport.getDynamicTextByLabel(driver, ReportTitle.TRANSACTION_NUMBER), transactionID);

		log.info("TC_09_Step_11: Xac nhan hien thi so tai khoan giao dich");
		verifyEquals(transactionReport.getDynamicTextByLabel(driver, ReportTitle.ACCOUNT_CARD), sourceAccount.account);

		log.info("TC_09_Step_12: Xac nhan hien thi Ma Thanh toan");
		verifyEquals(transactionReport.getDynamicTextByLabel(driver, ReportTitle.CODE_TRANSFER), payID);

		log.info("TC_09_Step_13: Xac nhan hien thi So tien phi");
		verifyEquals(transactionReport.getDynamicTextByLabel(driver, ReportTitle.TRANSACTION_FEE), fee);

		log.info("TC_09_Step_15: An nut back ve man hinh bao cao giao dich");
		transactionReport.clickToDynamicImageViewByID(driver, "com.VCB:id/ivTitleLeft");

		log.info("TC_09_Step_16: An nut back ve man hinh menu");
		transactionReport.clickToDynamicImageViewByID(driver, "com.VCB:id/ivTitleLeft");

		log.info("TC_09_Step_17: Mo tab Home");
		homePage.clickToDynamicImageViewByID(driver, "com.VCB:id/menu_1");
	}
	
	@Parameters ({"pass"})
	@Test
	public void TC_10_KiemTra_HienThiThongBao_ChuaDangNhap(String password) {
		
		log.info("TC_10_Step_01: Click vao Menu");
		homePage.clickToDynamicImageViewByID(driver, "com.VCB:id/menu_5");
		
		log.info("TC_10_Step_02: Click vao Thoat Ung Dung");
		...
		log.info("TC_10_Step_03: Click vao Dong y");
		homePage.clickToDynamicAcceptButton(driver, "com.VCB:id/btOK");
		
		log.info("TC_10_Step_04: Click vao Inbox");
		homePage.clickToDynamicImageView(driver, "com.VCB:id/ivOTT");
		
		log.info("TC_10_Step_05: Click vao tab Tat ca");
		homePage.clickToTextID(driver, "com.VCB:id/radioAll");
		
		log.info("TC_10_Step_06: Lay du lieu hien thi");
		String inboxContent = homePage.getDynamicTextByContentID(driver, "com.VCB:id/recycleview","com.VCB:id/content",payID);
		
		log.info("TC_10_Step_07: So sanh thong tin thanh toan");
		verifyTrue(inboxContent.contains(payID));
		verifyTrue(inboxContent.contains(addCommasToLong(convertAvailableBalanceCurrentcyOrFeeToLong(ticketPrice)+"")));
		verifyTrue(inboxContent.contains(sourceDetail+"-"+destDetail));
		...
		log.info("TC_10_Step_08: Click vao tab Khac");
		homePage.clickToTextID(driver, "com.VCB:id/radioOther");
		
		log.info("TC_10_Step_09: Lay du lieu hien thi");
		inboxContent = homePage.getDynamicTextByContentID(driver, "com.VCB:id/recycleview","com.VCB:id/content",payID);

		log.info("TC_10_Step_10: So sanh thong tin thanh toan");
		verifyTrue(inboxContent.contains(payID));
		verifyTrue(inboxContent.contains(addCommasToLong(convertAvailableBalanceCurrentcyOrFeeToLong(ticketPrice)+"")));
		verifyTrue(inboxContent.contains(sourceDetail+"-"+destDetail));
		verifyTrue(inboxContent.contains(destDetail+"-"+sourceDetail));
		...
		log.info("TC_10_Step_11: Back ve man Log In");
		homePage.clickToDynamicImageView(driver, "com.VCB:id/back");
		
		log.info("TC_10_Step_12: Nhap mat khau va dang nhap");
