...
public class VehicalTicket_Validate_Part2 extends Base {
	...
	@Test
	public void TC_01_KiemTraLoaiKiTuDuocPhepNhap() {
		...
		log.info("TC_01_Step_2: nhập kí tự hợp lệ");
		...
		log.info("TC_01_Step_3: kiểm tra hiển thị các kí tự vừa nhập");
		...
		log.info("TC_01_Step_4: chọn đóng");
		vehicalTicket.clickToDynamicButtonIconBack("com.VCB:id/ivClose");

		log.info("TC_01_Step_5: Chọn và nhập điểm đi");
		vehicalTicket.clickToDynamicText(VehicalData.DATA_ORDER_TICKET.FROMT);
		vehicalTicket.inputToDynamicInputBox(VehicalData.DATA_ORDER_TICKET.DEPARTURE, VehicalData.DATA_ORDER_TICKET.FROMT_INPUT);

		log.info("TC_01_Step_6: nhập kí tự không hợp lệ");
		...
		log.info("TC_01_Step_7: kiểm tra hiển thị các kí tự vừa nhập");
		...
		log.info("TC_01_Step_8: chọn đóng");
		vehicalTicket.clickToDynamicButtonIconBack("com.VCB:id/ivClose");
	}

	@Test
	public void TC_02_KiemTraNhapDiemDenHopLe() {
		log.info("TC_02_Step_1: Chọn và nhập điểm đi");
		vehicalTicket.clickToDynamicText(VehicalData.DATA_ORDER_TICKET.FROMT);
		vehicalTicket.inputToDynamicInputBox(VehicalData.DATA_ORDER_TICKET.DEPARTURE, VehicalData.DATA_ORDER_TICKET.FROMT_INPUT);

		log.info("TC_02_Step_2: nhập kí tự hợp lệ");
		vehicalTicket.inputToDynamicInputBox(VehicalData.DATA_ORDER_TICKET.DESTINATION, VehicalData.DATA_ORDER_TICKET.TO_INPUT);

		log.info("TC_02_Step_3: kiểm tra hiển thị các kí tự vừa nhập");
	...
	public void TC_03_KiemTraDiemDenTuongDoi() {
		...
		log.info("TC_03_Step_4: chọn đóng");
		vehicalTicket.clickToDynamicButtonIconBack("com.VCB:id/ivClose");
	}

	@Test
	public void TC_04_KiemTraGiaTriNhapVaoDiemDen() {
		log.info("TC_04_Step_1: Chọn và nhập điểm đi");
		vehicalTicket.clickToDynamicText(VehicalData.DATA_ORDER_TICKET.FROMT);
		vehicalTicket.inputToDynamicInputBox(VehicalData.DATA_ORDER_TICKET.DEPARTURE, VehicalData.DATA_ORDER_TICKET.FROMT_INPUT);

		log.info("TC_04_Step_2: Chọn và nhập điểm đến");
		vehicalTicket.clickToDynamicButtonLinkOrLinkText(VehicalData.DATA_ORDER_TICKET.TO_INPUT);
		vehicalTicket.inputToDynamicInputBox(VehicalData.DATA_ORDER_TICKET.DESTINATION, VehicalData.DATA_ORDER_TICKET.TO_INPUT);

		log.info("TC_04_Step_3: Kiểm tra tìm kiếm tương đối");
	...
	@Test
	public void TC_06_TimKiemDiemDenKhongTonTai() {
		log.info("TC_06_Step_1: nhập điểm đến không tồn tại");
		vehicalTicket.inputToDynamicInputBoxIDandIndex(VehicalData.DATA_ORDER_TICKET.DESTINATION_INVALID, "com.VCB:id/linArival");

		log.info("TC_06_Step_2: kiểm tra thông báo");
		...
		log.info("TC_06_Step_3: chọn đóng");
		vehicalTicket.clickToDynamicButtonIconBack("com.VCB:id/ivClose");
	}

	@Test
	public void TC_07_KiemTraChonDiemDenTruocKhiChonDiemDi() {
		log.info("TC_07_Step_1: Chọn và nhập điểm đi");
		vehicalTicket.clickToDynamicText(VehicalData.DATA_ORDER_TICKET.TO);

		log.info("TC_07_Step_2: kiểm tra thông báo");
	...
	@Test
	public void TC_08_KiemTraChonDiemDenGiongDiemDi() {
		log.info("TC_08_Step_1: Chọn và nhập điểm đi");
		vehicalTicket.inputToDynamicInputBox(VehicalData.DATA_ORDER_TICKET.DEPARTURE, VehicalData.DATA_ORDER_TICKET.FROMT_INPUT);
		vehicalTicket.clickToDynamicText(VehicalData.DATA_ORDER_TICKET.DEPARTURE);

		log.info("TC_08_Step_2: Chọn và nhập điểm đi");
		vehicalTicket.inputToDynamicInputBoxIDandIndex(VehicalData.DATA_ORDER_TICKET.DEPARTURE, "com.VCB:id/linArival");

		log.info("TC_08_Step_3: kiểm tra hiển thị");
		String sugget_to = vehicalTicket.getDynamicDayStart("com.VCB:id/tvTen");
		verifyEquals(sugget_to, VehicalData.DATA_ORDER_TICKET.DEPARTURE);
	}

	@Test
	public void TC_09_KiemTraChonLaiDiemDiSauKhiChonDiemDen() {
		log.info("TC_09_Step_1: Chọn và nhập điểm đi");
		vehicalTicket.inputToDynamicInputBoxIDandIndex(VehicalData.DATA_ORDER_TICKET.DEPARTURE, "com.VCB:id/linPickUp");
		vehicalTicket.clickToDynamicText(VehicalData.DATA_ORDER_TICKET.DEPARTURE);

		log.info("TC_09_Step_2: Chọn và nhập điểm đến");
		vehicalTicket.clickToDynamicButtonLinkOrLinkText(VehicalData.DATA_ORDER_TICKET.TO_INPUT);
		vehicalTicket.inputToDynamicInputBox(VehicalData.DATA_ORDER_TICKET.DESTINATION, VehicalData.DATA_ORDER_TICKET.TO_INPUT);

		log.info("TC_09_Step_3: chỉnh sửa lại điểm đi");
		...
		log.info("TC_09_Step_4: kiểm tra hiển thị");
	...
	@Test
	public void TC_10_KiemTraNhanDoiDiemDiDiemDen() {
		log.info("TC_10_Step_1: Chọn và nhập điểm đến");
		vehicalTicket.clickToDynamicButtonLinkOrLinkText(VehicalData.DATA_ORDER_TICKET.TO_INPUT);
		vehicalTicket.inputToDynamicInputBox(VehicalData.DATA_ORDER_TICKET.DESTINATION, VehicalData.DATA_ORDER_TICKET.TO_INPUT);
		vehicalTicket.clickToDynamicText(VehicalData.DATA_ORDER_TICKET.DESTINATION);

		log.info("TC_10_Step_2: click icon");
	...
	@Test
	public void TC_13_KiemTraChonNgayHomNay() {
		log.info("TC_13_Step_1: Chọn ngày hôm nay");
		vehicalTicket.clickToDynamicTomorrow("com.VCB:id/lnToday");

		log.info("TC_13_Step_2: kiểm tra ngày thay đổi đi");
		String DayStart = vehicalTicket.getDynamicDayStart("com.VCB:id/tvMonth");
		verifyEquals(DayStart, today);

		log.info("TC_13_Step_3: kiểm tra button được focus");
		verifyTrue(vehicalTicket.isDynamicForcus("com.VCB:id/lnToday"));
	}

	@Test
	public void TC_14_KiemTraNhanChonThoiGian() {
		log.info("TC_14_Step_1: Chọn ngày");
		vehicalTicket.clickToDynamicButtonChoiseDate("com.VCB:id/tvMonth");

		log.info("TC_14_Step_2: kiểm tra ngày được focus là ngày hiện tại");
		verifyTrue(vehicalTicket.isControlForcus(driver, "//android.widget.TextView[@text='" + getCurrentDay() + "']"));

		log.info("TC_14_Step_3: kiểm tra ngày được focus là ngày hiện tại");
		vehicalTicket.clickToDynamicButtonBack("Chọn ngày đi");
	}

	@Test
	public void TC_15_KiemTraNhanChonNgayQuaKhu() {
		log.info("TC_15_Step_1: Chọn ngày");
		vehicalTicket.clickToDynamicButtonChoiseDate("com.VCB:id/tvMonth");

		log.info("TC_15_Step_2: kiểm tra ngày được focus là ngày hiện tại");
		...
		log.info("TC_15_Step_3: kiểm tra không chọn được");
