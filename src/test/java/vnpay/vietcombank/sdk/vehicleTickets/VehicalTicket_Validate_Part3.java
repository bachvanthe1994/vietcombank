...
public class VehicalTicket_Validate_Part3 extends Base {
	...
	@Test
	public void TC_01_KiemTraChonNgayHienTai() {
		...
		log.info("TC_01_Step_3: Chọn ngày");
		vehicalTicket.clickToDynamicButtonChoiseDate("com.VCB:id/tvMonth");

		log.info("TC_01_Step_4: Chọn ngày hiện tai");
		vehicalTicket.clickToDynamicText(getCurrentDay());

		log.info("TC_01_Step_5: kiểm tra ngày thay đổi đi");
	...
	@Test
	public void TC_02_KiemTraChonNgayMai() {
		log.info("TC_02_Step_1: Chọn ngày");
		vehicalTicket.clickToDynamicButtonChoiseDate("com.VCB:id/tvMonth");

		int tomorrow = Integer.parseInt(getCurrentDay()) + 1;
		String tomorrow_string = Integer.toString(tomorrow);

		log.info("TC_02_Step_2: Chọn ngày hiện tai");
		vehicalTicket.clickToDynamicText(tomorrow_string);

		log.info("TC_02_Step_3: kiểm tra ngày thay đổi đi");
		String DayStart = vehicalTicket.getDynamicDayStart("com.VCB:id/tvMonth");
	...
	@Test
	public void TC_03_KiemTraChonNgayLonHonNgayMai() {
		log.info("TC_03_Step_1: Chọn ngày");
		vehicalTicket.clickToDynamicButtonChoiseDate("com.VCB:id/tvMonth");

		int tomorrow = Integer.parseInt(getCurrentDay()) + 2;
		String tomorrow_string = Integer.toString(tomorrow);

		log.info("TC_03_Step_2: chọn ngày lớn hon ngày mai");
		vehicalTicket.clickToDynamicText(tomorrow_string);

		log.info("TC_03_Step_3: kiểm tra ngày thay đổi đi");
		String DayStart = vehicalTicket.getDynamicDayStart("com.VCB:id/tvMonth");
		verifyEquals(DayStart, tomorrow_week);

		log.info("TC_03_Step_4: kiểm tra không focus vào ngày button nào");
	...
	@Test
	public void TC_04_KiemTraThayDoiThoiGianDi() {
		log.info("TC_04_Step_1: Chọn ngày");
		vehicalTicket.clickToDynamicButtonChoiseDate("com.VCB:id/tvMonth");

		int tomorrow = Integer.parseInt(getCurrentDay()) + 1;
		String tomorrow_string = Integer.toString(tomorrow);

		log.info("TC_04_Step_2: Chọn ngày mai");
		vehicalTicket.clickToDynamicText(tomorrow_string);

		log.info("TC_04_Step_3: Tim kiếm chuyến đi");
		vehicalTicket.clickToDynamicButton("Tìm kiếm chuyến đi");

		log.info("TC_04_Step_4: click back");
		vehicalTicket.clickToDynamicButtonBack("Danh sách chuyến xe");

		log.info("TC_04_Step_5: chon lại ngày đi");
		vehicalTicket.clickToDynamicButtonChoiseDate("com.VCB:id/tvMonth");

		int date = Integer.parseInt(getCurrentDay()) + 2;
		String date_string = Integer.toString(date);

		log.info("TC_04_Step_6: chọn ngày lớn hon ngày mai");
		vehicalTicket.clickToDynamicText(date_string);

		log.info("TC_04_Step_7: kiểm tra ngày thay đổi đi");
		String DayStart = vehicalTicket.getDynamicDayStart("com.VCB:id/tvMonth");
		verifyEquals(DayStart, tomorrow_week);
	}

	@Test
	public void TC_05_KiemTraLichTaiLich() {
		log.info("TC_05_Step_1: Chọn ngày");
		vehicalTicket.clickToDynamicButtonChoiseDate("com.VCB:id/tvMonth");

		log.info("TC_05_Step_2: lấy ra tháng/năm hiện tại");
		String today = "THÁNG" + getCurrenMonth2() + "/" + getCurrentYear();

		log.info("TC_05_Step_3: lấy ra tháng/năm của 3 tháng sau");
		String MonthAndYear = getCurentMonthAndYearPlusMonth(3);
		verifyTrue(vehicalTicket.isDynamicDisplayed(MonthAndYear));

		log.info("TC_05_Step_4: lấy ra tháng/năm của 4 tháng sau");
	...
	@Test
	public void TC_06_KiemTraButtonTimKiemChuyenDi() {
		log.info("TC_06_Step_1: click button tìm kiếm chuyến đi");
		vehicalTicket.clickToDynamicButton("Tìm kiếm chuyến đi");

		log.info("TC_06_Step_2: kiểm tra hiển thị");
		String text = vehicalTicket.getDynamicDayStart("com.VCB:id/tv_title");
		verifyEquals(text, VehicalData.NOTIFICATION.LIST_TRIP);

		log.info("TC_06_Step_3: click back");
		vehicalTicket.clickToDynamicIconChangePlacek("com.VCB:id/ivTitleLeft");
	}

	@Test
	public void TC_07_KiemTraNhomThongTinChuyenDiGoiY() {
		log.info("TC_07_Step_1: kiểm tra hiển thị title chuyến đi gợi ý");
		...
		log.info("TC_07_Step_2: kiể tra hiển thị thời gian khởi hành và điểm đi");
		...
		log.info("TC_07_Step_3: kiểm tra điểm tới trong gợi ý");
		String to = vehicalTicket.getDynamicDayStart("com.VCB:id/tvTo");
		verifyEquals(from, VehicalData.DATA_ORDER_TICKET.DEPARTURE);

		log.info("TC_07_Step_4: click back");
		vehicalTicket.clickToDynamicIconChangePlacek("com.VCB:id/ivTitleLeft");
	}

	@Test
	public void TC_08_KiemTraLuuThongTinChuyenDiGoiY() {
		...
		log.info("TC_08_Step_2: Chọn và nhập điểm đến");
		vehicalTicket.clickToDynamicButtonLinkOrLinkText(VehicalData.DATA_ORDER_TICKET.TO_INPUT);
		...
		log.info("TC_08_Step_3: click button tìm kiếm chuyến đi");
		vehicalTicket.clickToDynamicButton("Tìm kiếm chuyến đi");

		log.info("TC_08_Step_4: click back");
		vehicalTicket.clickToDynamicIconChangePlacek("com.VCB:id/ivTitleLeft");

		log.info("TC_08_Step_5: kiể tra hiển thị thời gian khởi hành và điểm đi");
		String suggest_from = vehicalTicket.getDynamicDayStart("com.VCB:id/tvFrom");
		String from = suggest_from.substring(12);
		verifyEquals(from, VehicalData.DATA_ORDER_TICKET.DESTINATION);

		log.info("TC_08_Step_6: kiểm tra điểm tới trong gợi ý");
		String to = vehicalTicket.getDynamicDayStart("com.VCB:id/tvTo");
