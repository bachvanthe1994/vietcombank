...
public class VehicalTicket_Validate_Part1 extends Base {
	...
	public void TC_03_KiemTraManHinhTimKiemChuyenDiKhachHangSuDungLanSau() {
		...
		verifyTrue(vehicalTicket.isDynamicMessageAndLabelTextDisplayed(driver, VehicalData.DATA_ORDER_TICKET.SUGGEST_TRIP));
	...
	public void TC_11_KiemTraSuaDiemDi() {
		...
		vehicalTicket.inputToDynamicInputBoxIDandIndex(VehicalData.DATA_ORDER_TICKET.DESTINATION, "com.VCB:id/linPickUp");
