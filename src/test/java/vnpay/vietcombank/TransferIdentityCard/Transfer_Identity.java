...
public class Transfer_Identity extends Base {
    ...
    @Test
    public void TC_03_ChuyenTienQuaCMTNguoiNhanTraPhiEURXacNhanMatKhau() {
	...
	log.info("TC_07_Step_17: kiem tra so CMT");
	verifyEquals(trasferPage.getDynamicTextInTransactionDetail(driver, "Số"), TransferIdentity_Data.textDataInputForm.IDENTITY_NUMBER);
	...
	log.info("TC_07_Step_29: kiem tra so tien chuyen di o man hinh xac thuc thanh cong");
	verifyEquals(transferMoneyLongToStringFormat, moneyTransferLongToStringFormat);
    ...
    @Test
    public void TC_09_ChuyenTienQuaCMTNguoiNhaTraPhiUSDXacNhanOTP() {
	...
	log.info("TC_09_Step_17: kiem tra so CMT");
	verifyEquals(trasferPage.getDynamicTextInTransactionDetail(driver, "Số"), TransferIdentity_Data.textDataInputForm.IDENTITY_NUMBER);
    ...
    @Test
    public void TC_11_ChuyenTienQuaCMTNguoiChuyenTraPhiUSDXacNhanOTP() {
	...
	log.info("TC_11_Step_17: kiem tra so CMT");
	verifyEquals(trasferPage.getDynamicTextInTransactionDetail(driver, "Số"), TransferIdentity_Data.textDataInputForm.IDENTITY_NUMBER);
