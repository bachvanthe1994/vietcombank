...
public class TransferIdentity_Validate extends Base {
	...
	verifyTrue(trasferPage.isDynamicTextInInputBoxDisPlayed(driver, "Tên người hưởng"));
	...
	verifyTrue(trasferPage.isDynamicTextInInputBoxDisPlayed(driver, beneficiaryInput));
	...
	verifyTrue(trasferPage.isDynamicTextInInputBoxDisPlayed(driver, "Giấy tờ tùy thân"));
	...
	String identify = trasferPage.getTextInDynamicPopup(driver, "com.VCB:id/tvContent");
	verifyTrue(trasferPage.isDynamicTextInInputBoxDisPlayed(driver, identify));
	...
	trasferPage.inputToDynamicInputBox(driver, TransferIdentity_Data.textDataInputForm.MAX_LENGTH_20_NUM, "Số");
	...
	trasferPage.inputToDynamicInputBox(driver, TransferIdentity_Data.textDataInputForm.MAX_LENGTH_21_NUM, "Số");
	...
	trasferPage.inputToDynamicInputBox(driver, TransferIdentity_Data.textDataInputForm.MAX_LENGTH_16_NUM, TransferIdentity_Data.textDataInputForm.MAX_LENGTH_8_NUM);
	...
	trasferPage.inputToDynamicInputBox(driver, TransferIdentity_Data.textDataInputForm.MAX_LENGTH_15_NUM, TransferIdentity_Data.textDataInputForm.MAX_LENGTH_16_NUM);
	...
	trasferPage.inputToDynamicInputBox(driver, TransferIdentity_Data.textDataInputForm.MAX_LENGTH_9_NUM, TransferIdentity_Data.textDataInputForm.MAX_LENGTH_15_NUM);
	...
	verifyTrue(trasferPage.isDynamicTextInInputBoxDisPlayed(driver, "Nơi cấp"));
	...
	verifyTrue(trasferPage.isDynamicTextInInputBoxDisPlayed(driver, "Cục CSĐKQL cư trú và DLQG về dân cư"));
    ...
    @Test
    public void TC_17_KiemTraLoaiKiTuNhap() {
	log.info("TC_17_STEP_0: chon chuyển tiền nhận bằng CMT");
	trasferPage.clickToDynamicButtonLinkOrLinkText(driver, "Chuyển tiền nhận bằng CMT");

	log.info("TC_17_STEP_1: nhap ten nguoi thu huong gom ki tu so");
	trasferPage.inputToDynamicInputBox(driver, TransferIdentity_Data.textDataInputForm.PASSPORT_NUMBER, "Tên người hưởng");

	log.info("TC_17_STEP_2: kiem ta hien thi ten nguoi thu huong vua nhap");
	verifyEquals(trasferPage.getDynamicTextInInputBoxByHeader(driver, "Thông tin người hưởng", "1"), TransferIdentity_Data.textDataInputForm.PASSPORT_NUMBER);

	log.info("TC_17_STEP_4: nhap ten nguoi thu huong gom ki tu dac biet");
	trasferPage.inputToDynamicInputBox(driver, TransferIdentity_Data.textDataInputForm.SPECIAL_CHARACTERS, TransferIdentity_Data.textDataInputForm.PASSPORT_NUMBER);

	log.info("TC_17_STEP_5: kiem tra hien thi ten nguoi thu huong vua nhap");
	verifyTrue(trasferPage.isDynamicMessageAndLabelTextDisplayed(driver, "Tên người hưởng"));

	log.info("TC_17_STEP_7: nhap ten nguoi thu huong gom ki tu co dau");
	trasferPage.inputToDynamicInputBox(driver, TransferIdentity_Data.textCheckElement.PAGE_CONFIRM, "Tên người hưởng");

	log.info("TC_17_STEP_8: kiem tra hien thi ten nguoi thu huong vua nhap");
	trasferPage.isDynamicMessageAndLabelTextDisplayed(driver, "Xac nhan thong tin");

	log.info("TC_17_STEP_10: kiem tra max length = 100");
	trasferPage.inputToDynamicInputBox(driver, TransferIdentity_Data.textDataInputForm.MAX_LENGTH_100, "Xac nhan thong tin");

	log.info("TC_17_STEP_11: kiem tra hien thi ten nguoi thu huong vua nhap");
	trasferPage.isDynamicMessageAndLabelTextDisplayed(driver, TransferIdentity_Data.textDataInputForm.MAX_LENGTH_100);

	log.info("TC_17_STEP_13: kiem tra max length = 101");
	trasferPage.inputToDynamicInputBox(driver, TransferIdentity_Data.textDataInputForm.MAX_LENGTH_101, "Xac nhan thong tin");

	log.info("TC_17_STEP_14: kiem tra hien thi ten nguoi thu huong vua nhap");
	trasferPage.isDynamicMessageAndLabelTextDisplayed(driver, TransferIdentity_Data.textDataInputForm.MAX_LENGTH_100);

	log.info("TC_17_Step_16 : Click  nut Back");
	trasferPage.clickToDynamicBackIcon(driver, "Chuyển tiền cho người nhận tại quầy");
