...
public class TransferIdentity_Validate extends Base {
	...
	public void TC_02_NhapTenNguoiThuHuong() {
		...
		trasferPage.inputToDynamicInputBoxUsedValidate(TransferIdentity_Data.textDataInputForm.USER_NAME, "Tên người hưởng");
	...
	public void TC_06_KiemTraHienThiGiayToTuyThan() {
		...
		verifyEquals(trasferPage.getTextInDynamicIdentifition("0", "com.VCB:id/tvContent"), "Chứng minh nhân dân");

		log.info("TC_06_STEP_3:kiem tra vi tri thu nhat hien thi trong danh sach giay to ");
		verifyEquals(trasferPage.getTextInDynamicIdentifition("1", "com.VCB:id/tvContent"), "Hộ chiếu");

		log.info("TC_06_STEP_4:kiem tra vi tri thu nhat hien thi trong danh sach giay to ");
		verifyEquals(trasferPage.getTextInDynamicIdentifition("2", "com.VCB:id/tvContent"), "CMT Quân đội");

		log.info("TC_06_STEP_5:kiem tra vi tri thu nhat hien thi trong danh sach giay to ");
		verifyEquals(trasferPage.getTextInDynamicIdentifition("3", "com.VCB:id/tvContent"), "Thẻ căn cước công dân");
	...
	public void TC_08_KiemTraNhapSo() {
		...
		trasferPage.inputToDynamicInputBoxUsedValidate(TransferIdentity_Data.textDataInputForm.IDENTITY_NUMBER, "Số");
	...
	public void TC_9_KiemTraMaxLengthSo() {
		...
		trasferPage.inputToDynamicInputBoxUsedValidate(TransferIdentity_Data.textDataInputForm.MAX_LENGTH_20_NUM, "Số");
		...
		trasferPage.inputToDynamicInputBoxUsedValidate(TransferIdentity_Data.textDataInputForm.MAX_LENGTH_21_NUM, "Số");
	...
	public void TC_10_KiemTraSoCMT() {
		...
		trasferPage.inputToDynamicInputBoxUsedValidate(TransferIdentity_Data.textDataInputForm.MAX_LENGTH_8_NUM, "Số");
		...
		String confirmMaxlength = trasferPage.getTextDynamicPopupTransfers(TransferIdentity_Data.textDataInputForm.CONFIRM_IDENTITY);
		...
		trasferPage.inputToDynamicInputBoxUsedValidate(TransferIdentity_Data.textDataInputForm.MAX_LENGTH_16_NUM, TransferIdentity_Data.textDataInputForm.MAX_LENGTH_8_NUM);

		log.info("TC_10_STEP_8: click tiếp tục");
		trasferPage.clickToDynamicButton(driver, "Tiếp tục");

		log.info("TC_10_STEP_9: kiem tra thong bao trong popup");
		String confirmMaxlength15 = trasferPage.getTextDynamicPopupTransfers(TransferIdentity_Data.textDataInputForm.CONFIRM_IDENTITY);
		...
		trasferPage.inputToDynamicInputBoxUsedValidate(TransferIdentity_Data.textDataInputForm.MAX_LENGTH_15_NUM, TransferIdentity_Data.textDataInputForm.MAX_LENGTH_16_NUM);

		log.info("TC_10_STEP_12: click tiếp tục");
		trasferPage.clickToDynamicButton(driver, "Tiếp tục");

		log.info("TC_10_STEP_13: kiem tra thong bao trong popup");
		String confirm = trasferPage.getTextDynamicPopupTransfers("Quý khách vui lòng chọn ngày cấp");
		...
		trasferPage.inputToDynamicInputBoxUsedValidate(TransferIdentity_Data.textDataInputForm.MAX_LENGTH_9_NUM, TransferIdentity_Data.textDataInputForm.MAX_LENGTH_15_NUM);

		log.info("TC_10_STEP_16: click tiếp tục");
		trasferPage.clickToDynamicButton(driver, "Tiếp tục");

		log.info("TC_10_STEP_17: kiem tra thong bao trong popup");
		String confirm1 = trasferPage.getTextDynamicPopupTransfers("Quý khách vui lòng chọn ngày cấp");
	...
	public void TC_03_KiemTraLoaiKiTuNhap() {
		...
		trasferPage.inputToDynamicInputBoxUsedValidate(TransferIdentity_Data.textDataInputForm.PASSPORT_NUMBER, "Tên người hưởng");
		...
		trasferPage.inputToDynamicInputBoxUsedValidate(TransferIdentity_Data.textDataInputForm.SPECIAL_CHARACTERS, TransferIdentity_Data.textDataInputForm.PASSPORT_NUMBER);
		...
		trasferPage.inputToDynamicInputBoxUsedValidate(TransferIdentity_Data.textCheckElement.PAGE_CONFIRM, "Tên người hưởng");
		...
		trasferPage.inputToDynamicInputBoxUsedValidate(TransferIdentity_Data.textDataInputForm.MAX_LENGTH_100, "Xac nhan thong tin");
		...
		log.info("TC_03_STEP_13: kiem tra max leninputToDynamicInputBoxUsedValidategth = 101");
//		trasferPage.(TransferIdentity_Data.textDataInputForm.MAX_LENGTH_101, "Xac nhan thong tin");
