...
public class TransferIdentityCard_Limit extends Base {
	...
	public void beforeClass(String deviceType, String deviceName, String udid, String url, String appActivities, String appPackage, String appName, String phone, String pass, String opt, String username, String passWeb) throws IOException, InterruptedException, GeneralSecurityException {
		...
		loginWeb.setupAssignServicesLimit(driverWeb, textCheckElement.PAGE_TRANSFER, inputInfo, textCheckElement.PACKAGE_NAME);
	...
	@Parameters({ "pass" })
	@Test
	public void TC_03_SoTienGiaoVuotQuaHanMucToiDaTrenNgayCuaDichVu(String pass) throws InterruptedException {
		loginWeb.setupAssignServicesLimit_Total_Day(driverWeb, textCheckElement.PAGE_TRANSFER, inputInfo, textCheckElement.PACKAGE_NAME);
		...
		log.info("TC_03_STEP_11: chon tiep tuc");
		loginWeb.resetAssignServicesLimit(driverWeb, textCheckElement.PAGE_TRANSFER, textCheckElement.PACKAGE_NAME);
	...
	public void TC_04_SoTienGiaoVuotQuaHanMucToiDaTrenNgayCuaNhomDichVu() throws InterruptedException {
		...
		trasferPage.inputToDynamicInputBox(driver, Integer.parseInt(inputInfo.totalLimit) + 1 + "", textCheckElement.MONEY);
		trasferPage.clickToTextID(driver, "com.VCB:id/tvTitle");

		log.info("TC_04_Step_10: noi dung");
		trasferPage.inputToDynamicInputBoxContent(driver, textDataInputForm.CONTENT_TRANSFER, "3");
