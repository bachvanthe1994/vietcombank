...
public class TransferIdentity_flow extends Base {
	...
	public void TC_01_ChuyenTienVNDChoNguoNhanTaiQuayBangCMTXacThucBangMKNguoiChuyenTraPhi(String pass) {
		...
		trasferPage.clickToDynamicButtonLinkOrLinkText(driver, Account_Data.Valid_Account.DEFAULT_ACCOUNT3);
		...
		String getFee = transReport.getMoneyByAccount(driver, "Số tiền phí");
	...
	public void TC_02_BaoCaoChuyenTienVNDChoNguoNhanTaiQuayBangCMTXacThucBangMK() {
		...
		transReport.clickToDynamicButtonLinkOrLinkText(driver, Valid_Account.DEFAULT_ACCOUNT3);
		...
		verifyEquals(transReport.getDynamicTextInTransactionDetail(driver, "Tài khoản/thẻ trích nợ"), Valid_Account.DEFAULT_ACCOUNT3);
	...
	public void TC_04_BaoCaoChuyenTienUSDChoNguoNhanTaiQuayBangCMTXacThucBangMKNguoiNhanTraPhi() {
		...
		verifyEquals(transReport.getDynamicTextDetailByIDOrPopup(driver, "com.VCB:id/tvMoney"), ("- " + TransferIdentity_Data.textCheckElement.AMOUNT_USD + " USD"));
		...
		verifyEquals(getMoneyTransfer[0], TransferIdentity_Data.textCheckElement.AMOUNT_USD);
	...
	public void TC_07_ChuyenTienEURChoNguoNhanTaiQuayBangCMTXacThucBangOTPNguoiNhanTraPhi(String otp) {
		...
		log.info("TC_07_STEP_9: nhap so tien");
		trasferPage.inputToDynamicInputBox(driver, TransferIdentity_Data.textCheckElement.AMOUNT_USD, "Số tiền");
		trasferPage.clickToTextID(driver, "com.VCB:id/tvTitle");
	...
	public void TC_08_BaoCaoChuyenTienEURChoNguoNhanTaiQuayBangCMTXacThucBangOTPNguoiNhanTraPhi() {
		...
		verifyEquals(transReport.getDynamicTextDetailByIDOrPopup(driver, "com.VCB:id/tvMoney"), ("- " + TransferIdentity_Data.textCheckElement.AMOUNT_USD + " EUR"));
