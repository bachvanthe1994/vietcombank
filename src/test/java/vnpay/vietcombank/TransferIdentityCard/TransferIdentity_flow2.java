...
public class TransferIdentity_flow2 extends Base {
	...
	public void TC_16_BaoCaoChuyenTienEURChoNguoNhanTaiQuayBangHCXacThucBangOTPNguoiNhanTraPhi() {
		...
		verifyEquals(transReport.getDynamicTextInTransactionDetail(driver, ReportTitle.ACCOUNT_CARD), Valid_Account.EUR_ACCOUNT);
	...
	public void TC_18_BaoCaoChuyenTienVNDChoNguoNhanTaiQuayBangCMTQDXacThucBangMKNguoiNhanTraPhi() {
		...
		verifyEquals(transReport.getDynamicTextInTransactionDetail(driver, ReportTitle.ACCOUNT_CARD), Valid_Account.DEFAULT_ACCOUNT3);
	...
	public void TC_20_BaoCaoChuyenTienUSDChoNguoNhanTaiQuayBangCMTQDXacThucBangMKNguoiNhanTraPhi() {
		...
		verifyEquals(transReport.getDynamicTextInTransactionDetail(driver, ReportTitle.ACCOUNT_CARD), Valid_Account.USD_ACCOUNT);
