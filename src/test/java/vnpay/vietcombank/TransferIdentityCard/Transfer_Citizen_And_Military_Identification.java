...
public class Transfer_Citizen_And_Military_Identification extends Base {
	...
	public void TC_01_ChuyenTienQuaCCCDNguoiChuyenTraPhiVNDXacNhanMatKhau() {
		...
		String moneyAuthen = trasferPage.getDynamicAmountLabelConvertVNDToLong("Mật khẩu đăng nhập");
	...
	public void TC_04_ChuyenTienQuaCCCDNguoiChuyenTraPhiVNDRXacNhanOTP() {
		...
		String moneyAuthen = trasferPage.getDynamicAmountLabelConvertVNDToLong("SMS OTP");
