...
public class Auto_Saving_Flow extends Base {
	...
	public void TC_02_TietKiemTuDong_TaiKhoanNguon_VND_OTP_BaoCaoGiaoDich() {
		...
		log.info("TC_02_Step_13: An nut back ve man hinh bao cao giao dich");
		transactionReport.clickToDynamicBottomMenu(driver, "com.VCB:id/ivTitleLeft");
		
		log.info("TC_02_Step_14: An nut back ve man hinh menu");
		transactionReport.clickToDynamicBottomMenu(driver, "com.VCB:id/ivTitleLeft");
		home = PageFactoryManager.getHomePageObject(driver);
		
		log.info("TC_02_Step_15: Mo tab Home");
	...
	public void TC_03_HuyTietKiemTuDong_TaiKhoanNguon_VND() {
		...
		verifyEquals(autoSaving.getDynamicTextDetailByIDOrPopup(driver, "com.VCB:id/tvTaiKhoanNguon"), "Tài khoản nguồn/"+Auto_Saving_Data.ORIGIN_ACCOUNT.ACCOUNT_VND);
	...
	public void TC_05_TietKiemTuDong_TaiKhoanNguon_USD_OTP(String otp) {
		...
		log.info("TC_05_Step_02: Chon tai khoan nguon EUR");
		autoSaving.clickToTextViewCombobox(driver, "com.VCB:id/tvContent");
	...
	public void TC_07_HuyTietKiemTuDong_TaiKhoanNguon_USD_OTP() {
		...
		verifyEquals(autoSaving.getDynamicTextDetailByIDOrPopup(driver, "com.VCB:id/tvTaiKhoanNguon"), "Tài khoản nguồn/"+Auto_Saving_Data.ORIGIN_ACCOUNT.ACCOUNT_USD);
