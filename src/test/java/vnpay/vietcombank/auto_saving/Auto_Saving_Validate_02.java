...
public class Auto_Saving_Validate_02 extends Base {
	...
	private String sourceAccountMoney, savingAccount, term, savingAccountMoney, startDate, endDate, exchangeRate, sourceAccount;
	...
	public void TC_17_TietKiemTuDong_GiaoDichThanhCong(String pass) {
		...
		autoSaving.clickToDynamicImageViewByID(driver, "com.VCB:id/ivHome");
