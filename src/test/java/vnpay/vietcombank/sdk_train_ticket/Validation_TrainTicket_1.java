...
public class Validation_TrainTicket_1 extends Base {
	...
	public void TC_08_NhapToiDaKyTuTruongGaKhoiHanh() {
		...
		trainTicket.inputToDynamicTextPoint(TrainTicket_Data.inputText.POINT_MAX_INVALID, "com.VCB:id/edtTextPickUp");

		log.info("TC_08_Verify text nhap vao toi da");
		verifyEquals(trainTicket.getTextMaxLength("com.VCB:id/edtTextPickUp"), TrainTicket_Data.inputText.POINT_MAX_INVALID.substring(0, 200));
	...
	public void TC_09_NhapKyTuDacBietVaKyTuKhacTruongGaKhoiHanh() {
		...
		trainTicket.inputToDynamicTextPoint(TrainTicket_Data.inputText.POINT_SPECIAL_INVALID, "com.VCB:id/edtTextPickUp");

		log.info("TC_09_Verify lay gia tri text rong");
		verifyEquals(trainTicket.getDynamicInputPoint("com.VCB:id/edtTextPickUp"), TrainTicket_Data.textDefault.TITLE_START);

		log.info("TC_09_Nhap text ky tu so tu 0 den 9");
		trainTicket.inputToDynamicTextPoint(TrainTicket_Data.inputText.POINT_NUMBER_VALID, "com.VCB:id/edtTextPickUp");

		log.info("TC_09_Verify lay gia tri ga khoi hanh vua nhap");
		verifyEquals(trainTicket.getDynamicInputPoint("com.VCB:id/edtTextPickUp"), TrainTicket_Data.inputText.POINT_NUMBER_VALID);

		log.info("TC_09_Nhap text ky tu chu thuong va chu hoa");
		trainTicket.inputToDynamicTextPoint(TrainTicket_Data.inputText.POINT_CHAR_VALID, "com.VCB:id/edtTextPickUp");

		log.info("TC_09_Verify lay gia tri ga khoi hanh vua nhap");
		verifyEquals(trainTicket.getDynamicInputPoint("com.VCB:id/edtTextPickUp"), TrainTicket_Data.inputText.POINT_CHAR_VALID);

		log.info("TC_09_Nhap text ky tu tieng viet co dau");
		trainTicket.inputToDynamicTextPoint(TrainTicket_Data.inputText.POINT_VIETNAM_VALID, "com.VCB:id/edtTextPickUp");

		log.info("TC_09_Verify lay gia tri ga khoi hanh vua nhap");
		verifyEquals(trainTicket.getDynamicInputPoint("com.VCB:id/edtTextPickUp"), TrainTicket_Data.inputText.POINT_VIETNAM_VALID);
	}

	@Test
	public void TC_10_NhapKyTuTimKiemGanDungGaKhoiHanh() {
		log.info("TC_10_Nhap ky tu vao o Search");
		trainTicket.inputToDynamicTextPoint(TrainTicket_Data.inputText.POINT_SERACH_THE_SAME, "com.VCB:id/edtTextPickUp");
	...
	public void TC_11_NhapGaKhoiHanhHopLe() {
		...
		trainTicket.inputToDynamicTextPoint(TrainTicket_Data.inputText.POINT_START_END_VALID, "com.VCB:id/edtTextPickUp");

		log.info("TC_11_Verify lay gia tri ga khoi hanh vua nhap");
		verifyEquals(trainTicket.getDynamicInputPoint("com.VCB:id/edtTextPickUp"), TrainTicket_Data.inputText.POINT_START_END_VALID);
	...
	public void TC_14_KiemTraSuaGaKhoiHanh() {
		...
		verifyEquals(trainTicket.getDynamicInputPoint("com.VCB:id/edtTextPickUp"), TrainTicket_Data.inputText.POINT_EDIT_SEARCH);
	}
	...
	public void TC_16_CheckHienThiMacDinhTextGaDen() {
		...
		verifyEquals(trainTicket.getDynamicInputPoint("com.VCB:id/edtTextArrival"), "Ga đến");
	}
	...
	public void TC_18_NhapToiDaKyTuTruongGaden() {
		...
		trainTicket.inputToDynamicTextPoint(TrainTicket_Data.inputText.POINT_MAX_INVALID, "com.VCB:id/edtTextArrival");

		log.info("TC_18_Verify text nhap vao toi da");
		verifyEquals(trainTicket.getTextMaxLength("com.VCB:id/edtTextArrival"), TrainTicket_Data.inputText.POINT_MAX_INVALID.substring(0, 208));
	}

	@Test
	public void TC_19_NhapKyTuDacBietVaKyTuKhacTruongGaDen() {
		log.info("TC_19_Nhap text ky tu dac biet");
		trainTicket.inputToDynamicTextPoint(TrainTicket_Data.inputText.POINT_SPECIAL_INVALID, "com.VCB:id/edtTextArrival");

		log.info("TC_19_Verify lay gia tri text rong");
		verifyEquals(trainTicket.getDynamicInputPoint("com.VCB:id/edtTextArrival"), TrainTicket_Data.textDefault.TITLE_END);

		log.info("TC_19_Nhap text ky tu so tu 0 den 9");
		trainTicket.inputToDynamicTextPoint(TrainTicket_Data.inputText.POINT_NUMBER_VALID, "com.VCB:id/edtTextArrival");

		log.info("TC_19_Verify lay gia tri ga den vua nhap");
		verifyEquals(trainTicket.getDynamicInputPoint("com.VCB:id/edtTextArrival"), TrainTicket_Data.inputText.POINT_NUMBER_VALID);

		log.info("TC_19_Nhap text ky tu chu thuong va chu hoa");
		trainTicket.inputToDynamicTextPoint(TrainTicket_Data.inputText.POINT_CHAR_VALID, "com.VCB:id/edtTextArrival");

		log.info("TC_19_Verify lay gia tri ga den vua nhap");
		verifyEquals(trainTicket.getDynamicInputPoint("com.VCB:id/edtTextArrival"), TrainTicket_Data.inputText.POINT_CHAR_VALID);

		log.info("TC_019_Nhap text ky tu tieng viet co dau");
		trainTicket.inputToDynamicTextPoint(TrainTicket_Data.inputText.POINT_VIETNAM_VALID, "com.VCB:id/edtTextArrival");

		log.info("TC_19_Verify lay gia tri ga den vua nhap");
		verifyEquals(trainTicket.getDynamicInputPoint("com.VCB:id/edtTextArrival"), TrainTicket_Data.inputText.POINT_VIETNAM_VALID);
	}

	@Test
	public void TC_20_NhapKyTimKiemGanDungGaDen() {
		log.info("TC_20_Nhap ky tu vao o Search");
		trainTicket.inputToDynamicTextPoint(TrainTicket_Data.inputText.POINT_SERACH_THE_SAME, "com.VCB:id/edtTextArrival");
	...
	public void TC_21_NhapGaDenHopLe() {
		...
		trainTicket.inputToDynamicTextPoint(TrainTicket_Data.inputText.POINT_START_END_VALID, "com.VCB:id/edtTextArrival");

		log.info("TC_21_Verify lay gia tri ga den vua nhap");
		verifyEquals(trainTicket.getDynamicInputPoint("com.VCB:id/edtTextArrival"), TrainTicket_Data.inputText.POINT_START_END_VALID);
	}
	...
	public void TC_24_KiemTraEditGaDen() {
		...
		verifyEquals(trainTicket.getDynamicInputPoint("com.VCB:id/edtTextArrival"), TrainTicket_Data.inputText.POINT_EDIT_SEARCH_END);
	}
	...
	public void TC_25_TimKiemGaDenKhongTonTai() {
		...
		trainTicket.clickDynamicImageResourceID("com.VCB:id/vtWarning");
		verifyEquals(trainTicket.getDynamicTextInPopUp("com.VCB:id/vtWarning"), "Không có dữ liệu hợp lệ");
	}
