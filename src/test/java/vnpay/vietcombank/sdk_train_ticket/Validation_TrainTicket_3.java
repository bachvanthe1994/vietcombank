...
//	@Test
	public void TC_01_KiemTraQuyDinhSoLuongKhachToiDa() {
		...
		log.info("TC_21_Verify so luong Sinh vien = 2");
		verifyEquals(trainTicket.getTextCustomerNumber("Sinh viên", "com.VCB:id/tvQuantity"), "2");

		log.info("TC_21_Verify so luong tre em = 1");
		verifyEquals(trainTicket.getTextCustomerNumber("Trẻ em", "com.VCB:id/tvQuantity"), "1");

		log.info("TC_21_Verify so luong nguoi lon = 1");
		verifyEquals(trainTicket.getTextCustomerNumber("Người lớn", "com.VCB:id/tvQuantity"), "1");

		log.info("TC_21_Da add du 4 hanh khach, hanh khach thu 5 la Nguoi cao tuoi se khong duoc add vao danh sach, verify so luong nguoi cao tuoi =0");
...
//	@Test
	...
	public void TC_03_KiemTraChonSoLuongKhachHangThanhCong() {
		...
		log.info("TC_21_Verify so luong hanh khach da chon man hinh dat ve tau");
...
@Test
	public void TC_08_KiemTraChon1LoaiGheThanhCong() {
		...
		log.info("TC_17_Click chon ghe la ngoi cung");
		trainTicket.clickToDynamicButtonLinkOrLinkText("Ngồi cứng");

		log.info("TC_21_Click button xong");
		trainTicket.clickToDynamicButtonLinkOrLinkText("Xong");

		log.info("TC_21_Verify ghe ngoi cung duoc chon hien thi trong phan loai cho");
...
@Test
	public void TC_09_KiemTraChonLonHon1LoaiGhe() {
		...
		log.info("TC_17_Click chon ghe la ngoi mềm");
	...
	public void TC_10_KiemTraThaoTacTimKiemThanhCong() {
		...
		log.info("TC_21_Verify hien thi man hinh danh sach chieu di khi tim kiem ve tau co ket qua");
	...
	public void TC_11_KiemTraThaoTacTimKiemKhongThanhCong() {
		...
		log.info("TC_17_Bo chon ghe la ngoi cung");
		trainTicket.clickToDynamicButtonLinkOrLinkText("Ngồi cứng");

		log.info("TC_17_Bo chon ghe la ngoi mềm");
		trainTicket.clickToDynamicButtonLinkOrLinkText("Ngồi mềm");
		...
		log.info("TC_21_Verify message khong tim kiem duoc ket qua");
