...
public class Validation_TrainTicket_4 extends Base {
	...
	public void TC_02_KiemTraNhanSapXepTheoGioChay() {
		...
		System.out.print(listSuggestIncrase);
		...
		System.out.print(listSuggestDecrase);

	}

	@Test
	public void TC_03_KiemTraNhanSapXepTheoGioKhoiHanh() {
		log.info("TC_21_Click tab gio chay");
		...
		System.out.print(listSuggestTime);
		log.info("TC_10_Verify gio chay sap xep theo thu tu tang dan");
	...
	public void TC_04_KiemTraKetHopLonHon1TieuChiSapXep() {
		log.info("TC_10_Lay danh sach thoi gian den");
		List<String> timeEnd = trainTicket.getListOfSuggestedMoneyOrListText("com.VCB:id/tv_thoi_gian_den");

		log.info("TC_10_Verify thoi gian den khong duoc sap xep theo thu tu tang dan");
		verifyFailure(trainTicket.orderSortIncraseFormat(timeEnd));

		List<String> listSuggestTime = trainTicket.getListOfSuggestedMoneyOrListText("com.VCB:id/tv_thoi_di");

		log.info("TC_10_Verify chi co thoi gian di duoc sap xep theo thu tu tang dan");
		verifyTrue(trainTicket.orderSortIncraseFormat(listSuggestTime));
	}
	...
	public void TC_06_KiemTraThaoTacChonMotChuyenDi() {
		...
		log.info("TC_12_Check hien thi button tiep tuc chon chieu ve");
	...
	public void TC_07_KiemTraNhanNutSua() {
		...
		log.info("TC_12_verify title sua thong tin");
		...
		log.info("TC_01_Hien thi button chuyen doi");
