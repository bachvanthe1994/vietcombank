...
public class Mobile_Topup_Validate_04 extends Base {
	...
	public void TC_01_XacThucGiaoDichBangSMSOTP(String phone) {
		...
		verifyEquals(mobileTopup.getDynamicTextDetailByIDOrPopup(driver, "com.VCB:id/lblMessage"), 
				UIs.MOBILE_TOPUP_CONFIRM_SMS_OTP_TRANSACTION_MESSAGE+ " " + phone.substring(0,3) + "*****" + phone.substring(8,10));
