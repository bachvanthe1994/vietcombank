...
public class Mobile_Topup_Validate_02 extends Base {
	...
	@Test
	public void TC_01_KiemTraMacDinhHienThiSoDienThoaiDuocNap() {
		...
		verifyEquals(mobileTopup.getTextInEditTextFieldByID(driver, "com.VCB:id/mobile"), "0335059860");
	...
	public void TC_02_KiemTraBoTrongSoDienThoaiMacDinh() {
		...
		verifyEquals(mobileTopup.getDynamicAmountLabel(driver, "Số điện thoại được nạp"), "0335059860");
	...
	public void TC_03_KiemTraGioiHanKiTu() {
		...
		log.info("TC_03_Step_02: Nhap hon 10 chu so vào o So dien thoai mac dinh");
		mobileTopup.inputIntoEditTextByID(driver, "123456789012345", "com.VCB:id/mobile");
		
		log.info("TC_03_Step_03: Xac nhan chi hien thi duy nhat 10 chu so dau tien o trong o + hien thi dau 'x'");
	...
	public void TC_04_NhanIconX() {
		...
		log.info("TC_04_Step_01: Nhap Icon X");
		mobileTopup.clickToDynamicImageButtonByID(driver, "com.VCB:id/ivDelete");
		
		log.info("TC_04_Step_02: Xac nhan o textbox rong");
	...
	public void TC_05_NhapSoDienThoaiNhoHon10KiTu() {
		...
		log.info("TC_05_Step_01: Nhap nho hon 10 chu so vào o So dien thoai mac dinh");
		mobileTopup.inputIntoEditTextByID(driver, "012345678", "com.VCB:id/mobile");
	
		log.info("TC_05_Step_02: An nut 'Tiep tuc'");
		mobileTopup.clickToDynamicAcceptButton(driver, "com.VCB:id/btn_submit");
	...
	public void TC_08_SoTienGiaoDichLonHonSoDuTKNguon() {
		...
		mobileTopup.inputIntoEditTextByID(driver, "0335059860", "com.VCB:id/mobile");
	
		log.info("TC_08_Step_02: Click vao menh gia 500,000");
		mobileTopup.clickToDynamicButtonLinkOrLinkText(driver, UIs.LIST_UNIT_VALUE[5]);
		
		log.info("TC_08_Step_03: An nut 'Tiep tuc'");
		mobileTopup.clickToDynamicAcceptButton(driver, "com.VCB:id/btn_submit");
	...
	public void TC_09_KhoiTaoGiaoDichHopLe() {
		...
		log.info("TC_09_Step_01: Nhap so dien thoai hop le vao So dien thoai mac dinh");
		mobileTopup.inputIntoEditTextByID(driver, "0335059860", "com.VCB:id/mobile");
	
		log.info("TC_09_Step_02: Click vao menh gia 30,000");
