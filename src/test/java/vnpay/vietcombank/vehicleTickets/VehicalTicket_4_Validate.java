...
//    @Test
	...
	log.info("TC_13_Step_1: Chọn ngày hiện tai");
	vehicalTicket.clickToDynamicText(driver, tomorrow_string);
...
//    @Test
	...
	vehicalTicket.clickToDynamicButton(driver, "Tìm kiếm chuyến đi");

	log.info("TC_13_Step_1: click back");
	vehicalTicket.clickToDynamicButtonBack(driver, "Danh sách chuyến xe");
	...
	log.info("TC_13_Step_1: chọn ngày lớn hon ngày mai");
	vehicalTicket.clickToDynamicText(driver, date_string);
