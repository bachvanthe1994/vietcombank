...
public class VehicalTicket_2_Validate extends Base {
	...
	vehicalTicket.isDynamicIconBackDisplayed(driver, VehicalData.Data_ORDER_TICKET.ORDER_TICKET);
	...
	vehicalTicket.isDynamicIconChangePlaceDisplayed(driver, "com.VCB:id/ivround");
	...
	String today = vehicalTicket.getDynamicDayStart(driver, "com.VCB:id/tvHomnay");
	verifyEquals(today, VehicalData.Data_ORDER_TICKET.TODAY);

	log.info("TC_02_Step_9: kiểm tra hiển thị ngày mai");
	String tomorrow = vehicalTicket.getDynamicDayStart(driver, "com.VCB:id/tvNgayMai");
    ...
    @Test
    public void TC_03_KiemTraManHinhTimKiemChuyenDi() {
	...
	String suggest_from = vehicalTicket.getDynamicDayStart(driver, "com.VCB:id/tvFrom");
	...
	String to = vehicalTicket.getDynamicDayStart(driver, "com.VCB:id/tvTo");
	verifyEquals(from, VehicalData.Data_ORDER_TICKET.DEPARTURE);
    }
	...
	vehicalTicket.clickToDynamicButtonBack(driver, "Đặt vé xe");
	...
	String choise_from = vehicalTicket.getDynamicDayStart(driver, "com.VCB:id/tvTextPickUp");
	...
	String noti_fromt = vehicalTicket.getDynamicDayStart(driver, "com.VCB:id/tvTitle");
	...
	vehicalTicket.inputToDynamicInputBox(driver, VehicalData.Data_ORDER_TICKET.LENGTH_201, VehicalData.Data_ORDER_TICKET.FROMT_INPUT);

	log.info("TC_07_Step_2: kiểm tra max lenght 200");
	String lenght_201 = vehicalTicket.getDynamicEditText(driver, "com.VCB:id/edtTextPickUp");
	...
	String data_invalid = vehicalTicket.getDynamicEditText(driver, "com.VCB:id/edtTextPickUp");
	...
	String data_valid = vehicalTicket.getDynamicEditText(driver, "com.VCB:id/edtTextPickUp");
	verifyEquals(data_valid, VehicalData.Data_ORDER_TICKET.FROMT_INPUT);
	...
	String fromt = vehicalTicket.getDynamicEditText(driver, "com.VCB:id/edtTextPickUp");
	verifyEquals(fromt, VehicalData.Data_ORDER_TICKET.DEPARTURE);
    }

    @Test
    public void TC_10_KiemTraTimKiemTuongDoi() {
	log.info("TC_10_Step_1: nhập và chọn điểm đi");
	vehicalTicket.inputToDynamicInputBoxIDandIndex(driver, VehicalData.Data_ORDER_TICKET.CONTENT_DEPARTURE, "com.VCB:id/linPickUp");
	...
	vehicalTicket.inputToDynamicInputBoxIDandIndex(driver, VehicalData.Data_ORDER_TICKET.DESTINATION, "com.VCB:id/linPickUp");
	...
	String sugget_fromt = vehicalTicket.getDynamicDayStart(driver, "com.VCB:id/tvTen");
	verifyTrue(sugget_fromt.contains(VehicalData.Data_ORDER_TICKET.DEPARTURE));
    }
	...
	String choise_from = vehicalTicket.getDynamicDayStart(driver, "com.VCB:id/tvTextArrival");
	...
	log.info("TC_07_Step_2: kiểm tra max lenght 200");
	String lenght_201 = vehicalTicket.getDynamicEditText(driver, "com.VCB:id/edtTextArrival");
	verifyEquals(lenght_201, VehicalData.Data_ORDER_TICKET.LENGTH_200);
    }
