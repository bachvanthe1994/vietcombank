...
public class TransferOutSideVCB_Limit extends Base {
	...
	private String higherGroup,higherPackage,destinationAccount,lowerMin,higherMax;
	...
	@Test 
	public void TC_01_ChuyenTienToiTaiKhoanKhac_LonHonNhomDichVu(String username,String passWeb) {
		...
		verifyEquals(transferMoneyOutSide.getTextDynamicFollowImage(driver, "com.VCB:id/ivTitle"), MESSEGE_ERROR.HIGHER_MAX_A_TRANSACTION+addCommasToLong(inputPackageGroupInfo.maxTran)+MESSEGE_ERROR.DETAIL_A_DAY_GROUP_MESSAGE);
	...
	public void TC_02_ChuyenTienToiTaiKhoanKhac_LonHonGoiDichVu() {
		...
		verifyEquals(transferMoneyOutSide.getTextDynamicFollowImage(driver, "com.VCB:id/ivTitle"), MESSEGE_ERROR.HIGHER_MAX_A_TRANSACTION+addCommasToLong(inputPackageGroupInfo.totalLimit)+MESSEGE_ERROR.DETAIL_A_DAY_PACKAGE_MESSAGE);
	...
	@Test
	public void TC_03_ChuyenTienToiTaiKhoanKhac_NhoHonHanMucToiThieu_1_LanGiaoDich() {

		log.info("TC_01_6_Nhap so tien");
		transferMoneyOutSide.inputToDynamicInputBoxByHeader(driver, lowerMin, TitleOutVCB.TRANSACTION_INFOMATION, "1");
	...
	@Test
	public void TC_04_ChuyenTienToiTaiKhoanKhac_CaoHonHanMucToiDa_1_LanGiaoDich() {
	...
	@Parameters({"otp","pass"})
	@Test
	public void TC_05_ChuyenTienToiTaiKhoanKhac_CaoHonMucToiDa_TrongNgay(String otpNo,String password) {
