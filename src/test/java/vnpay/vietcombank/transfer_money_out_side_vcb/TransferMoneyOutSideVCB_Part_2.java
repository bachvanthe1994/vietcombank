...
public class TransferMoneyOutSideVCB_Part_2 extends Base {
	...
	TransferOutSideVCB_Info info6 = new TransferOutSideVCB_Info(Account_Data.Valid_Account.EUR_ACCOUNT, "01825909301", "Do Minh Duc", "NHTMCP Tien Phong", "10", TitleOutVCB.TRANSACTION_FEE_SENDE, "test", TitleOutVCB.PASSWORD_TITLE);
	TransferOutSideVCB_Info info7 = new TransferOutSideVCB_Info(Account_Data.Valid_Account.EUR_ACCOUNT, "01825909301", "Do Minh Duc", "NHTMCP Tien Phong", "10", "Phí giao dịch người nhận trả", "test", TitleOutVCB.PASSWORD_TITLE);

	TransferOutSideVCB_Info info8 = new TransferOutSideVCB_Info(Account_Data.Valid_Account.USD_ACCOUNT, "01825909301", "Do Minh Duc", "NHTMCP Tien Phong", "10", TitleOutVCB.TRANSACTION_FEE_SENDE, "test", "SMS OTP");
	TransferOutSideVCB_Info info9 = new TransferOutSideVCB_Info(Account_Data.Valid_Account.USD_ACCOUNT, "01825909301", "Do Minh Duc", "NHTMCP Tien Phong", "10", "Phí giao dịch người nhận trả", "test", TitleOutVCB.PASSWORD_TITLE);
	...
	TransferOutSideVCB_Info info11 = new TransferOutSideVCB_Info(Account_Data.Valid_Account.USD_ACCOUNT, "01825909301", "Do Minh Duc", "NHTMCP Tien Phong", "10", TitleOutVCB.TRANSACTION_FEE_SENDE, "test", TitleOutVCB.PASSWORD_TITLE);
	...
	public void TC_13_ChuyenTienLienNganHangCoPhiGiaoDichNguoiChuyenTraNgoaiTe_EUR_XacThucBangMatKhau() {
		...
		transferMoneyOutSide.inputToDynamicInputBox(driver, info6.destinationAccount, TitleOutVCB.ACCOUT_TO);
		...
		verifyEquals(transferMoneyOutSide.getDynamicTextInTransactionDetail(driver, TitleOutVCB.DESTINATION_ACCOUNT), info6.destinationAccount);
	...
	public void TC_14_ChuyenTienLienNganHangCoPhiGiaoDichNguoiChuyenTraNgoaiTe_EUR_XacThucBangMatKhau_BaoCao() {
		...
		verifyEquals(transReport.getDynamicTextInTransactionDetail(driver, ReportTitle.DESTINATION_ACCOUNT_CARD), info6.destinationAccount);
	...
	public void TC_15_ChuyenTienLienNganHangCoPhiGiaoDichNguoiNhanTraNgoaiTe_EUR_XacThucBangMatKhau() {
		...
		transferMoneyOutSide.inputToDynamicInputBox(driver, info7.destinationAccount, TitleOutVCB.ACCOUT_TO);
		...
		verifyEquals(transferMoneyOutSide.getDynamicTextInTransactionDetail(driver, TitleOutVCB.DESTINATION_ACCOUNT), info7.destinationAccount);
	...
	public void TC_17_ChuyenTienLienNganHang_USD_CoPhiGiaoDichNguoiChuyenTraXacThucBangOTP() {
		...
		transferMoneyOutSide.inputToDynamicInputBox(driver, info8.destinationAccount, TitleOutVCB.ACCOUT_TO);
		...
		verifyEquals(transferMoneyOutSide.getDynamicTextInTransactionDetail(driver, TitleOutVCB.DESTINATION_ACCOUNT), info8.destinationAccount);
	...
	public void TC_19_ChuyenTienLienNganHangCoPhiGiaoDichNguoiNhanTraNgoaiTe_USD_XacThucBangMatKhau() {
		...
		transferMoneyOutSide.inputToDynamicInputBox(driver, info9.destinationAccount, TitleOutVCB.ACCOUT_TO);
		...
		verifyEquals(transferMoneyOutSide.getDynamicTextInTransactionDetail(driver, TitleOutVCB.DESTINATION_ACCOUNT), info9.destinationAccount);
	...
	public void TC_21_ChuyenTienLienNganHang_USD_CoPhiGiaoDichNguoiNhanTraXacThucBangOTP() {
		...
		transferMoneyOutSide.inputToDynamicInputBox(driver, info10.destinationAccount, TitleOutVCB.ACCOUT_TO);
		...
		verifyEquals(transferMoneyOutSide.getDynamicTextInTransactionDetail(driver, TitleOutVCB.DESTINATION_ACCOUNT), info10.destinationAccount);
	...
	public void TC_23_ChuyenTienLienNganHangCoPhiGiaoDichNguoiChuyenTraNgoaiTe_USD_XacThucBangMatKhau() {
		...
		transferMoneyOutSide.inputToDynamicInputBox(driver, info11.destinationAccount, TitleOutVCB.ACCOUT_TO);
		...
		verifyEquals(transferMoneyOutSide.getDynamicTextInTransactionDetail(driver, TitleOutVCB.DESTINATION_ACCOUNT), info11.destinationAccount);
