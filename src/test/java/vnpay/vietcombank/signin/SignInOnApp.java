...
public class SignInOnApp extends Base {
	...
	public void TC_01_ManHinhDangNhap() {
		...
		verifyTrue(login.isDynamicMessageAndLabelTextDisplayed(driver, "Chào mừng Quý khách đến với ứng dụng" + "\n" + "VCB-Mobile B@nking của Vietcombank"));
		...
		verifyTrue(login.isDynamicButtonDisplayed(driver, "Tiếp tục"));
	...
	public void TC_03_NhapThongTinIB() {
		...
		verifyTrue(login.isDynamicMessageAndLabelTextDisplayed(driver, "Quý khách vui lòng nhập tên đăng" + "\n" + "nhập và mật khẩu VCB-iB@nking"));
	}
