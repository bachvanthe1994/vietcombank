...
public class Water_Bills_Flow extends Base {
	...
	private String sourceAccountMoney, customerID, moneyBill, transactionDate, transactionID, waterDaNang, otpSmart, newOtp;
	...
	public void TC_01_ThanhToanTienNuoc_OTP(String otp) {
		...
		waterBill.clickToDynamicButtonLinkOrLinkText(driver, Tittle_Text.SMS_OTP);
		...
		waterBill.inputToDynamicOtp(driver, otp, Tittle_Text.CONTINUE_BUTTON);
	...
	public void TC_03_ThanhToanTienNuoc_MK(String pass) {
		...
		waterBill.scrollDownToText(driver, Tittle_Text.CHOICE_METHOD_VERIFY);
		waterBill.clickToTextViewByLinearLayoutID(driver, "com.VCB:id/llptxt");
		waterBill.clickToDynamicButtonLinkOrLinkText(driver, Tittle_Text.LOGIN_PASSWORD);
	...
	@Test
	public void TC_05_ThanhToanTienNuoc_Smart_OTP(String otp) {
		...
		log.info("TC_05_Step_03: Chon nha cung cap");
		waterBill.clickToTextViewByLinearLayoutID(driver, "com.VCB:id/wrap_tv");
		waterBill.clickToDynamicButtonLinkOrLinkText(driver, waterDaNang);
		...
		log.info("TC_05_Step_11: Nhap ki tu vao o nhap Smart OTP");
	...
	@Test
	public void TC_06_ThanhToanTienNuoc_Smart_OTP_BaoCaoGiaoDich() {
