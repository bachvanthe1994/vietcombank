...
//	@Test
	public void TC_01_DangKyDichVu_HoaDonTienDien_XacThucOTP(String otp) {
		...
		verifyEquals(vcbAutoDebit.getDynamicTextByLabel(driver, "Nhà cung cấp"), VCBAuto_Debit_Data.TEXT.EVN_HA_NOI);
	...
	public void TC_04_DangKyDichVu_HoaDonTienNuoc_XacThucOTP(String otp) {
		...
		verifyEquals(vcbAutoDebit.getDynamicTextByLabel(driver, "Nhà cung cấp"), VCBAuto_Debit_Data.TEXT.WATER_DA_NANG);
	...
	public void TC_07_DangKyDichVu_HoaDonVNPT_XacThucOTP(String otp) {
		...
		home = PageFactoryManager.getHomePageObject(driver);
		home.scrollDownToText(driver, "Nạp tiền điện tử");
		log.info("TC_07_Step_01: Click vao VCB-Auto Debit");
		home.clickToDynamicButtonLinkOrLinkText(driver, "VCB-Auto Debit");
		...
		verifyEquals(vcbAutoDebit.getDynamicTextByLabel(driver, "Dịch vụ"), VCBAuto_Debit_Data.TEXT.VNPT_BILL_TEXT);

		log.info("TC_07_Step_12: Hien thi nha cung cap");
		verifyEquals(vcbAutoDebit.getDynamicTextByLabel(driver, "Nhà cung cấp"), VCBAuto_Debit_Data.TEXT.VNPT_KIEN_GIANG);

		log.info("TC_07_Step_13: Hien thi ma khach hang");
		verifyEquals(vcbAutoDebit.getDynamicTextByLabel(driver, "Mã khách hàng"), VCBAuto_Debit_Data.TEXT.VNPT_CUSTOMER);
...
//		address = vcbAutoDebit.getDynamicTextByLabel(driver, "Địa chỉ");
	...
	public void TC_08_ThayDoiThongTin_HoaDonVNPT_XacThucOTP(String otp) {
		...
		log.info("TC_08_Step_01: Click vao VCB-Auto Debit");
		home.clickToDynamicButtonLinkOrLinkText(driver, "VCB-Auto Debit");
		...
		verifyEquals(vcbAutoDebit.getDynamicTextByLabel(driver, "Loại dịch vụ"), VCBAuto_Debit_Data.TEXT.VNPT_BILL_TEXT);
...
//		verifyEquals(vcbAutoDebit.getDynamicTextByLabel(driver, "Địa chỉ"), address);
		...
		verifyEquals(vcbAutoDebit.getDynamicTextByLabel(driver, "Nhà cung cấp"), VCBAuto_Debit_Data.TEXT.VNPT_CUSTOMER);

		log.info("TC_08_Step_29: Hien thi ma khach hang");
		verifyEquals(vcbAutoDebit.getDynamicTextByLabel(driver, "Mã khách hàng"), VCBAuto_Debit_Data.TEXT.VNPT_KIEN_GIANG);
	...
	public void TC_09_HuyDangKy_VNPT_XacThucOTP() {
		...
		log.info("TC_09_Step_01: Click vao VCB-Auto Debit");
		home.clickToDynamicButtonLinkOrLinkText(driver, "VCB-Auto Debit");
