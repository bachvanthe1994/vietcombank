...
public class SetupContact_Data {
	...
	public static class Contact {
		public static final String CARD_FAST_TRANSACTION = "Chuyển tiền nhanh qua số thẻ";
		public static final String CARD_ACCOUNT_TRANSACTION = "Chuyển tiền nhanh qua số tài khoản";
