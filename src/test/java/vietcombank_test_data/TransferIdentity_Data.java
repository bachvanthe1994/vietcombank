...
public class TransferIdentity_Data {
	public class textCheckElement {
		...
		public static final String TRANSFER_TEXT = "Chuyển khoản";
	...
	public static class textDataInputForm {
		...
		public static final String TRANSFER_LAST = " VND/1 lần, chi tiết xem tại https://www.vietcombank.com.vn hoặc liên hệ Hotline của Vietcombank để được trợ giúp.";
		public static final String MAX_TRANSFER_TOP = "Chuyển tiền không thành công. Số tiền giao dịch lớn hơn hạn mức ";
		public static final String DAY_MAX_TRANSFER_LAST = " VND/1 ngày, chi tiết xem tại https://www.vietcombank.com.vn hoặc liên hệ Hotline của Vietcombank để được trợ giúp.";
		public static final String GROUP_MAX_TRANSFER_LAST = " VND/1 ngày của nhóm dịch vụ, chi tiết xem tại https://www.vietcombank.com.vn hoặc liên hệ Hotline của Vietcombank để được trợ giúp.";
		public static final String PACKAGE_MAX_TRANSFER_LAST = " VND/1 ngày của gói dịch vụ, chi tiết xem tại https://www.vietcombank.com.vn hoặc liên hệ Hotline của Vietcombank để được trợ giúp.";
